...
resource "aws_ecs_task_definition" "meal_plan_finalizer_task" {
  family = "dev_meal_plan_finalizer"
...
resource "aws_ecs_service" "meal_plan_finalizer" {
  name                               = "meal_plan_finalizer"
  task_definition                    = aws_ecs_task_definition.meal_plan_finalizer_task.arn
