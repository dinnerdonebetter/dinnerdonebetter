...
# ENTRYPOINT [ "go", "test", "-parallel", "1", "-v", "-failfast", "github.com/prixfixeco/api_server/tests/integration", "-run", "TestIntegration/TestHouseholds_UsersHaveBackupHouseholdCreatedForThemWhenRemovedFromLastHousehold" ]
