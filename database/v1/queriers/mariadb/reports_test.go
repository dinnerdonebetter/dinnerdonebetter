...
func TestMariaDB_buildGetReportQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := m.buildGetReportQuery(exampleReportID, exampleUserID)
...
func TestMariaDB_GetReport(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := m.GetReport(context.Background(), expected.ID, expectedUserID)
...
func TestMariaDB_buildGetReportCountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := m.buildGetReportCountQuery(models.DefaultQueryFilter(), exampleUserID)
		assert.Equal(t, expectedQuery, actualQuery)
		assert.Len(t, args, expectedArgCount)
		assert.Equal(t, exampleUserID, args[0].(uint64))
	})
...
func TestMariaDB_GetReportCount(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualCount, err := m.GetReportCount(context.Background(), models.DefaultQueryFilter(), expectedUserID)
		assert.NoError(t, err)
...
func TestMariaDB_buildGetAllReportsCountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery := m.buildGetAllReportsCountQuery()
		assert.Equal(t, expectedQuery, actualQuery)
	})
}

func TestMariaDB_GetAllReportsCount(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualCount, err := m.GetAllReportsCount(context.Background())
		assert.NoError(t, err)
		assert.Equal(t, expectedCount, actualCount)
...
func TestMariaDB_buildGetReportsQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := m.buildGetReportsQuery(models.DefaultQueryFilter(), exampleUserID)
...
func TestMariaDB_GetReports(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := m.GetReports(context.Background(), models.DefaultQueryFilter(), expectedUserID)
...
func TestMariaDB_GetAllReportsForUser(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := m.GetAllReportsForUser(context.Background(), expectedUserID)
...
func TestMariaDB_buildCreateReportQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 3
		expectedQuery := "INSERT INTO reports (report_type,concern,belongs_to,created_on) VALUES (?,?,?,UNIX_TIMESTAMP())"
		actualQuery, args := m.buildCreateReportQuery(expected)
...
func TestMariaDB_CreateReport(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedCreationQuery := "INSERT INTO reports (report_type,concern,belongs_to,created_on) VALUES (?,?,?,UNIX_TIMESTAMP())"
		...
		actual, err := m.CreateReport(context.Background(), expectedInput)
		assert.NoError(t, err)
		assert.Equal(t, expected, actual)
...
func TestMariaDB_buildUpdateReportQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 4
		expectedQuery := "UPDATE reports SET report_type = ?, concern = ?, updated_on = UNIX_TIMESTAMP() WHERE belongs_to = ? AND id = ?"
		actualQuery, args := m.buildUpdateReportQuery(expected)
...
func TestMariaDB_UpdateReport(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		err := m.UpdateReport(context.Background(), expected)
		assert.NoError(t, err)
...
func TestMariaDB_buildArchiveReportQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 2
		expectedQuery := "UPDATE reports SET updated_on = UNIX_TIMESTAMP(), archived_on = UNIX_TIMESTAMP() WHERE archived_on IS NULL AND belongs_to = ? AND id = ?"
		actualQuery, args := m.buildArchiveReportQuery(expected.ID, expected.BelongsTo)
...
func TestMariaDB_ArchiveReport(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		err := m.ArchiveReport(context.Background(), expected.ID, expectedUserID)
		assert.NoError(t, err)
	...
	T.Run("with error writing to database", func(t *testing.T) {
		...
		err := m.ArchiveReport(context.Background(), example.ID, expectedUserID)
		assert.Error(t, err)
