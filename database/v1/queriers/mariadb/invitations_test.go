...
func TestMariaDB_buildGetInvitationQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := m.buildGetInvitationQuery(exampleInvitationID, exampleUserID)
...
func TestMariaDB_GetInvitation(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := m.GetInvitation(context.Background(), expected.ID, expectedUserID)
...
func TestMariaDB_buildGetInvitationCountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := m.buildGetInvitationCountQuery(models.DefaultQueryFilter(), exampleUserID)
		assert.Equal(t, expectedQuery, actualQuery)
		assert.Len(t, args, expectedArgCount)
		assert.Equal(t, exampleUserID, args[0].(uint64))
	})
...
func TestMariaDB_GetInvitationCount(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualCount, err := m.GetInvitationCount(context.Background(), models.DefaultQueryFilter(), expectedUserID)
		assert.NoError(t, err)
...
func TestMariaDB_buildGetAllInvitationsCountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery := m.buildGetAllInvitationsCountQuery()
		assert.Equal(t, expectedQuery, actualQuery)
	})
}

func TestMariaDB_GetAllInvitationsCount(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualCount, err := m.GetAllInvitationsCount(context.Background())
		assert.NoError(t, err)
		assert.Equal(t, expectedCount, actualCount)
...
func TestMariaDB_buildGetInvitationsQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := m.buildGetInvitationsQuery(models.DefaultQueryFilter(), exampleUserID)
...
func TestMariaDB_GetInvitations(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := m.GetInvitations(context.Background(), models.DefaultQueryFilter(), expectedUserID)
...
func TestMariaDB_GetAllInvitationsForUser(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := m.GetAllInvitationsForUser(context.Background(), expectedUserID)
...
func TestMariaDB_buildCreateInvitationQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 3
		expectedQuery := "INSERT INTO invitations (code,consumed,belongs_to,created_on) VALUES (?,?,?,UNIX_TIMESTAMP())"
		actualQuery, args := m.buildCreateInvitationQuery(expected)
...
func TestMariaDB_CreateInvitation(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedCreationQuery := "INSERT INTO invitations (code,consumed,belongs_to,created_on) VALUES (?,?,?,UNIX_TIMESTAMP())"
		...
		actual, err := m.CreateInvitation(context.Background(), expectedInput)
		assert.NoError(t, err)
		assert.Equal(t, expected, actual)
...
func TestMariaDB_buildUpdateInvitationQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 4
		expectedQuery := "UPDATE invitations SET code = ?, consumed = ?, updated_on = UNIX_TIMESTAMP() WHERE belongs_to = ? AND id = ?"
		actualQuery, args := m.buildUpdateInvitationQuery(expected)
...
func TestMariaDB_UpdateInvitation(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		err := m.UpdateInvitation(context.Background(), expected)
		assert.NoError(t, err)
...
func TestMariaDB_buildArchiveInvitationQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 2
		expectedQuery := "UPDATE invitations SET updated_on = UNIX_TIMESTAMP(), archived_on = UNIX_TIMESTAMP() WHERE archived_on IS NULL AND belongs_to = ? AND id = ?"
		actualQuery, args := m.buildArchiveInvitationQuery(expected.ID, expected.BelongsTo)
...
func TestMariaDB_ArchiveInvitation(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		err := m.ArchiveInvitation(context.Background(), expected.ID, expectedUserID)
		assert.NoError(t, err)
	...
	T.Run("with error writing to database", func(t *testing.T) {
		...
		err := m.ArchiveInvitation(context.Background(), example.ID, expectedUserID)
		assert.Error(t, err)
