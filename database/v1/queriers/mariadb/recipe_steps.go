...
func (m *MariaDB) buildGetRecipeStepQuery(recipeStepID, userID uint64) (query string, args []interface{}) {
	var err error
...
// GetRecipeStep fetches a recipe step from the mariadb database
func (m *MariaDB) GetRecipeStep(ctx context.Context, recipeStepID, userID uint64) (*models.RecipeStep, error) {
	query, args := m.buildGetRecipeStepQuery(recipeStepID, userID)
...
func (m *MariaDB) buildGetRecipeStepCountQuery(filter *models.QueryFilter, userID uint64) (query string, args []interface{}) {
	var err error
...
func (m *MariaDB) GetRecipeStepCount(ctx context.Context, filter *models.QueryFilter, userID uint64) (count uint64, err error) {
	query, args := m.buildGetRecipeStepCountQuery(filter, userID)
...
func (m *MariaDB) buildGetAllRecipeStepsCountQuery() string {
	allRecipeStepsCountQueryBuilder.Do(func() {
		var err error
		allRecipeStepsCountQuery, _, err = m.sqlBuilder.
			Select(CountQuery).
			From(recipeStepsTableName).
...
func (m *MariaDB) GetAllRecipeStepsCount(ctx context.Context) (count uint64, err error) {
	err = m.db.QueryRowContext(ctx, m.buildGetAllRecipeStepsCountQuery()).Scan(&count)
	return count, err
}
...
func (m *MariaDB) buildGetRecipeStepsQuery(filter *models.QueryFilter, userID uint64) (query string, args []interface{}) {
	var err error
	builder := m.sqlBuilder.
		Select(recipeStepsTableColumns...).
		From(recipeStepsTableName).
...
func (m *MariaDB) GetRecipeSteps(ctx context.Context, filter *models.QueryFilter, userID uint64) (*models.RecipeStepList, error) {
	query, args := m.buildGetRecipeStepsQuery(filter, userID)
	...
	list, err := scanRecipeSteps(m.logger, rows)
	if err != nil {
		return nil, fmt.Errorf("scanning response from database: %w", err)
	}

	count, err := m.GetRecipeStepCount(ctx, filter, userID)
	if err != nil {
...
func (m *MariaDB) GetAllRecipeStepsForUser(ctx context.Context, userID uint64) ([]models.RecipeStep, error) {
	query, args := m.buildGetRecipeStepsQuery(nil, userID)
...
func (m *MariaDB) buildCreateRecipeStepQuery(input *models.RecipeStep) (query string, args []interface{}) {
	var err error
	query, args, err = m.sqlBuilder.
...
func (m *MariaDB) buildRecipeStepCreationTimeQuery(recipeStepID uint64) (query string, args []interface{}) {
	var err error
...
func (m *MariaDB) CreateRecipeStep(ctx context.Context, input *models.RecipeStepCreationInput) (*models.RecipeStep, error) {
	x := &models.RecipeStep{
		Index:                     input.Index,
	...
	query, args := m.buildCreateRecipeStepQuery(x)
	...
	if idErr == nil {
		...
		query, args := m.buildRecipeStepCreationTimeQuery(x.ID)
...
func (m *MariaDB) buildUpdateRecipeStepQuery(input *models.RecipeStep) (query string, args []interface{}) {
	var err error
	query, args, err = m.sqlBuilder.
...
func (m *MariaDB) UpdateRecipeStep(ctx context.Context, input *models.RecipeStep) error {
	query, args := m.buildUpdateRecipeStepQuery(input)
...
func (m *MariaDB) buildArchiveRecipeStepQuery(recipeStepID, userID uint64) (query string, args []interface{}) {
	var err error
	query, args, err = m.sqlBuilder.
		Update(recipeStepsTableName).
		Set("updated_on", squirrel.Expr(CurrentUnixTimeQuery)).
...
func (m *MariaDB) ArchiveRecipeStep(ctx context.Context, recipeStepID, userID uint64) error {
	query, args := m.buildArchiveRecipeStepQuery(recipeStepID, userID)
	_, err := m.db.ExecContext(ctx, query, args...)
	return err
}
