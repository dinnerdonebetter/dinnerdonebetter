...
func TestSqlite_buildGetIngredientQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := s.buildGetIngredientQuery(exampleIngredientID, exampleUserID)
...
func TestSqlite_GetIngredient(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := s.GetIngredient(context.Background(), expected.ID, expectedUserID)
...
func TestSqlite_buildGetIngredientCountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := s.buildGetIngredientCountQuery(models.DefaultQueryFilter(), exampleUserID)
		assert.Equal(t, expectedQuery, actualQuery)
		assert.Len(t, args, expectedArgCount)
		assert.Equal(t, exampleUserID, args[0].(uint64))
	})
...
func TestSqlite_GetIngredientCount(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualCount, err := s.GetIngredientCount(context.Background(), models.DefaultQueryFilter(), expectedUserID)
		assert.NoError(t, err)
...
func TestSqlite_buildGetAllIngredientsCountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery := s.buildGetAllIngredientsCountQuery()
		assert.Equal(t, expectedQuery, actualQuery)
	})
}

func TestSqlite_GetAllIngredientsCount(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualCount, err := s.GetAllIngredientsCount(context.Background())
		assert.NoError(t, err)
		assert.Equal(t, expectedCount, actualCount)
...
func TestSqlite_buildGetIngredientsQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := s.buildGetIngredientsQuery(models.DefaultQueryFilter(), exampleUserID)
...
func TestSqlite_GetIngredients(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := s.GetIngredients(context.Background(), models.DefaultQueryFilter(), expectedUserID)
...
func TestSqlite_GetAllIngredientsForUser(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := s.GetAllIngredientsForUser(context.Background(), expectedUserID)
...
func TestSqlite_buildCreateIngredientQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 19
		expectedQuery := "INSERT INTO ingredients (name,variant,description,warning,contains_egg,contains_dairy,contains_peanut,contains_tree_nut,contains_soy,contains_wheat,contains_shellfish,contains_sesame,contains_fish,contains_gluten,animal_flesh,animal_derived,considered_staple,icon,belongs_to) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
		actualQuery, args := s.buildCreateIngredientQuery(expected)
...
func TestSqlite_CreateIngredient(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := s.CreateIngredient(context.Background(), expectedInput)
		assert.NoError(t, err)
		assert.Equal(t, expected, actual)
...
func TestSqlite_buildUpdateIngredientQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 20
		expectedQuery := "UPDATE ingredients SET name = ?, variant = ?, description = ?, warning = ?, contains_egg = ?, contains_dairy = ?, contains_peanut = ?, contains_tree_nut = ?, contains_soy = ?, contains_wheat = ?, contains_shellfish = ?, contains_sesame = ?, contains_fish = ?, contains_gluten = ?, animal_flesh = ?, animal_derived = ?, considered_staple = ?, icon = ?, updated_on = (strftime('%s','now')) WHERE belongs_to = ? AND id = ?"
		actualQuery, args := s.buildUpdateIngredientQuery(expected)
...
func TestSqlite_UpdateIngredient(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		err := s.UpdateIngredient(context.Background(), expected)
		assert.NoError(t, err)
...
func TestSqlite_buildArchiveIngredientQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 2
		expectedQuery := "UPDATE ingredients SET updated_on = (strftime('%s','now')), archived_on = (strftime('%s','now')) WHERE archived_on IS NULL AND belongs_to = ? AND id = ?"
		actualQuery, args := s.buildArchiveIngredientQuery(expected.ID, expected.BelongsTo)
...
func TestSqlite_ArchiveIngredient(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		err := s.ArchiveIngredient(context.Background(), expected.ID, expectedUserID)
		assert.NoError(t, err)
	...
	T.Run("with error writing to database", func(t *testing.T) {
		...
		err := s.ArchiveIngredient(context.Background(), example.ID, expectedUserID)
		assert.Error(t, err)
