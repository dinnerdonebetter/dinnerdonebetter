...
func TestSqlite_buildGetIterationMediaQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := s.buildGetIterationMediaQuery(exampleIterationMediaID, exampleUserID)
...
func TestSqlite_GetIterationMedia(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := s.GetIterationMedia(context.Background(), expected.ID, expectedUserID)
...
func TestSqlite_buildGetIterationMediaCountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := s.buildGetIterationMediaCountQuery(models.DefaultQueryFilter(), exampleUserID)
		assert.Equal(t, expectedQuery, actualQuery)
		assert.Len(t, args, expectedArgCount)
		assert.Equal(t, exampleUserID, args[0].(uint64))
	})
...
func TestSqlite_GetIterationMediaCount(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualCount, err := s.GetIterationMediaCount(context.Background(), models.DefaultQueryFilter(), expectedUserID)
		assert.NoError(t, err)
...
func TestSqlite_buildGetAllIterationMediasCountQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery := s.buildGetAllIterationMediasCountQuery()
		assert.Equal(t, expectedQuery, actualQuery)
	})
}

func TestSqlite_GetAllIterationMediasCount(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualCount, err := s.GetAllIterationMediasCount(context.Background())
		assert.NoError(t, err)
		assert.Equal(t, expectedCount, actualCount)
...
func TestSqlite_buildGetIterationMediasQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actualQuery, args := s.buildGetIterationMediasQuery(models.DefaultQueryFilter(), exampleUserID)
...
func TestSqlite_GetIterationMedias(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := s.GetIterationMedias(context.Background(), models.DefaultQueryFilter(), expectedUserID)
...
func TestSqlite_GetAllIterationMediasForUser(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		actual, err := s.GetAllIterationMediasForUser(context.Background(), expectedUserID)
...
func TestSqlite_buildCreateIterationMediaQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 5
		expectedQuery := "INSERT INTO iteration_medias (path,mimetype,recipe_iteration_id,recipe_step_id,belongs_to) VALUES (?,?,?,?,?)"
		actualQuery, args := s.buildCreateIterationMediaQuery(expected)
...
func TestSqlite_CreateIterationMedia(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedCreationQuery := "INSERT INTO iteration_medias (path,mimetype,recipe_iteration_id,recipe_step_id,belongs_to) VALUES (?,?,?,?,?)"
		...
		actual, err := s.CreateIterationMedia(context.Background(), expectedInput)
		assert.NoError(t, err)
		assert.Equal(t, expected, actual)
...
func TestSqlite_buildUpdateIterationMediaQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 6
		expectedQuery := "UPDATE iteration_medias SET path = ?, mimetype = ?, recipe_iteration_id = ?, recipe_step_id = ?, updated_on = (strftime('%s','now')) WHERE belongs_to = ? AND id = ?"
		actualQuery, args := s.buildUpdateIterationMediaQuery(expected)
...
func TestSqlite_UpdateIterationMedia(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		err := s.UpdateIterationMedia(context.Background(), expected)
		assert.NoError(t, err)
...
func TestSqlite_buildArchiveIterationMediaQuery(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedArgCount := 2
		expectedQuery := "UPDATE iteration_medias SET updated_on = (strftime('%s','now')), archived_on = (strftime('%s','now')) WHERE archived_on IS NULL AND belongs_to = ? AND id = ?"
		actualQuery, args := s.buildArchiveIterationMediaQuery(expected.ID, expected.BelongsTo)
...
func TestSqlite_ArchiveIterationMedia(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		err := s.ArchiveIterationMedia(context.Background(), expected.ID, expectedUserID)
		assert.NoError(t, err)
	...
	T.Run("with error writing to database", func(t *testing.T) {
		...
		err := s.ArchiveIterationMedia(context.Background(), example.ID, expectedUserID)
		assert.Error(t, err)
