...
func TestPermissions(T *testing.T) {
	...
	T.Run("household admin", func(t *testing.T) {
		...
		assert.True(t, permissionChecker.HasPermission(CreateAPIClientsPermission))
		assert.True(t, permissionChecker.HasPermission(ReadAPIClientsPermission))
		assert.True(t, permissionChecker.HasPermission(ArchiveAPIClientsPermission))
		...
		assert.False(t, permissionChecker.HasPermission(CreateValidMeasurementConversionsPermission))
		assert.True(t, permissionChecker.HasPermission(ReadValidMeasurementConversionsPermission))
		assert.False(t, permissionChecker.HasPermission(UpdateValidMeasurementConversionsPermission))
		assert.False(t, permissionChecker.HasPermission(ArchiveValidMeasurementConversionsPermission))
		...
		assert.True(t, permissionChecker.HasPermission(CreateRecipeStepConditionsPermission))
		assert.True(t, permissionChecker.HasPermission(ReadRecipeStepConditionsPermission))
		assert.True(t, permissionChecker.HasPermission(SearchRecipeStepConditionsPermission))
		assert.True(t, permissionChecker.HasPermission(UpdateRecipeStepConditionsPermission))
		assert.True(t, permissionChecker.HasPermission(ArchiveRecipeStepConditionsPermission))
