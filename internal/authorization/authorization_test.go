...
func TestAuthorizations(T *testing.T) {
	...
	T.Run("household member", func(t *testing.T) {
		...
		assert.True(t, CanCreateMealPlans(householdMemberRoleName))
		assert.True(t, CanSeeMealPlans(householdMemberRoleName))
		assert.True(t, CanUpdateMealPlans(householdMemberRoleName))
		assert.True(t, CanDeleteMealPlans(householdMemberRoleName))
		assert.True(t, CanCreateMealPlanOptions(householdMemberRoleName))
		assert.True(t, CanSeeMealPlanOptions(householdMemberRoleName))
		assert.True(t, CanUpdateMealPlanOptions(householdMemberRoleName))
		assert.True(t, CanDeleteMealPlanOptions(householdMemberRoleName))
