...
type (
	...
	ServicesConfig struct {
		...
		Websockets                      websocketsservice.Config                      `json:"websockets,omitempty"                      toml:"websockets,omitempty"`
		...
		Auth                            authservice.Config                            `json:"auth,omitempty"                            toml:"recipes,omitempty"`
	}
)
