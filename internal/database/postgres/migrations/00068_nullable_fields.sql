...
ALTER TABLE recipe_step_ingredients ALTER COLUMN minimum_quantity_value DROP DEFAULT;
ALTER TABLE recipe_step_ingredients ALTER COLUMN minimum_quantity_value DROP NOT NULL;
