...
ALTER TABLE recipe_steps ADD COLUMN "is_starch" BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE recipe_steps ADD COLUMN "is_protein" BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE recipe_steps ADD COLUMN "is_grain" BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE recipe_steps ADD COLUMN "is_fruit" BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE recipe_steps ADD COLUMN "is_salt" BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE recipe_steps ADD COLUMN "is_fat" BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE recipe_steps ADD COLUMN "is_acid" BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE recipe_steps ADD COLUMN "is_heat" BOOLEAN NOT NULL DEFAULT FALSE;
