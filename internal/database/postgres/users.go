...
//go:embed queries/users/users_get_by_id.sql
var getUserByIDQuery string

//go:embed queries/users/users_get_with_verified_two_factor.sql
...
//go:embed queries/users/users_exists_with_status.sql
...
//go:embed queries/users/users_get_by_username.sql
...
//go:embed queries/users/users_get_admin_by_username.sql
...
//go:embed queries/users/users_get_by_email.sql
...
//go:embed queries/users/users_search_by_username.sql
...
//go:embed queries/users/users_create.sql
var userCreationQuery string

//go:embed queries/users/users_create_household_memberships_for_new_user.sql
...
//go:embed queries/users/users_update.sql
...
/* #nosec G101 */
//go:embed queries/users/users_update_password.sql
...
/* #nosec G101 */
//go:embed queries/users/users_update_two_factor_secret.sql
...
/* #nosec G101 */
//go:embed queries/users/users_mark_two_factor_secret_as_verified.sql
...
//go:embed queries/users/users_archive.sql
var archiveUserQuery string

//go:embed queries/users/users_archive_memberships.sql
