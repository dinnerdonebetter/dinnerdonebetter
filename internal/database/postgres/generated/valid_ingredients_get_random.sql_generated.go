...
// versions:
//   sqlc v1.15.0
// source: valid_ingredients_get_random.sql
...
const GetRandomValidIngredient = `-- name: GetRandomValidIngredient :exec
SELECT
...
func (q *Queries) GetRandomValidIngredient(ctx context.Context) error {
	_, err := q.exec(ctx, q.getRandomValidIngredientStmt, GetRandomValidIngredient)
	return err
}
