...
type Querier interface {
	...
	CheckUserIngredientPreferenceExistence(ctx context.Context, db DBTX, id string) (bool, error)
	...
	GetValidVesselsNeedingIndexing(ctx context.Context, db DBTX) ([]*GetValidVesselsNeedingIndexingRow, error)
	...
	SearchForValidVessels(ctx context.Context, db DBTX, name string) ([]*SearchForValidVesselsRow, error)
