...
type Querier interface {
	...
	GetOAuth2ClientByClientID(ctx context.Context, db DBTX, id string) (*Oauth2Clients, error)
	...
	GetValidIngredientGroupMembers(ctx context.Context, db DBTX, groupID string) ([]*GetValidIngredientGroupMembersRow, error)
