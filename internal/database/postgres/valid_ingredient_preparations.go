...
//go:embed queries/valid_ingredients_preparations_exists.sql
...
//go:embed queries/valid_ingredients_preparations_get_one.sql
...
//go:embed queries/valid_ingredients_preparations_create.sql
...
//go:embed queries/valid_ingredients_preparations_update.sql
...
//go:embed queries/valid_ingredients_preparations_archive.sql
