SELECT
	...
	(recipe_step_products.minimum_quantity_value::double precision / 100::double precision),
	(recipe_step_products.maximum_quantity_value::double precision / 100::double precision),
	...
	(recipe_step_products.minimum_storage_temperature_in_celsius::double precision / 100::double precision),
	(recipe_step_products.maximum_storage_temperature_in_celsius::double precision / 100::double precision),
