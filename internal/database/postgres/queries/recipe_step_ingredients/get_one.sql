SELECT
    ...
    (recipe_step_ingredients.minimum_quantity_value::double precision / 100::double precision),
    (recipe_step_ingredients.maximum_quantity_value::double precision / 100::double precision),
