SELECT
    ...
    (recipe_prep_tasks.minimum_storage_temperature_in_celsius::double precision / 100::double precision),
    (recipe_prep_tasks.maximum_storage_temperature_in_celsius::double precision / 100::double precision),
