...
//go:embed queries/household_user_memberships/household_user_memberships_get_for_user.sql
...
//go:embed queries/household_user_memberships/household_user_memberships_get_default_household_id_for_user.sql
...
//go:embed queries/household_user_memberships/household_user_memberships_mark_as_user_default.sql
...
//go:embed queries/household_user_memberships/household_user_memberships_user_is_member.sql
...
//go:embed queries/household_user_memberships/household_user_memberships_modify_user_permissions.sql
...
//go:embed queries/household_user_memberships/household_user_memberships_transfer_ownership.sql
var transferHouseholdOwnershipQuery string

//go:embed queries/household_user_memberships/household_user_memberships_transfer_membership.sql
...
//go:embed queries/household_user_memberships/household_user_memberships_add_user_to_household.sql
...
//go:embed queries/household_user_memberships/household_user_memberships_remove_user_from_household.sql
