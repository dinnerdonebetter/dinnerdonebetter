...
func (q *Querier) GetValidVessel(ctx context.Context, validVesselID string) (*types.ValidVessel, error) {
	...
	validVessel := &types.ValidVessel{
		...
		ID:                             result.ID,
		WidthInMillimeters:             float32FromNullString(result.WidthInMillimeters),
		LengthInMillimeters:            float32FromNullString(result.LengthInMillimeters),
		HeightInMillimeters:            float32FromNullString(result.HeightInMillimeters),
		Capacity:                       float32FromString(result.Capacity),
...
func (q *Querier) CreateValidVessel(ctx context.Context, input *types.ValidVesselDatabaseCreationInput) (*types.ValidVessel, error) {
	...
	if err := q.generatedQuerier.CreateValidVessel(ctx, q.db, &generated.CreateValidVesselParams{
		...
		Name:                           input.Name,
		Capacity:                       stringFromFloat32(input.Capacity),
		CapacityUnit:                   nullStringFromStringPointer(input.CapacityUnitID),
		WidthInMillimeters:             nullStringFromFloat32(input.WidthInMillimeters),
		LengthInMillimeters:            nullStringFromFloat32(input.LengthInMillimeters),
		HeightInMillimeters:            nullStringFromFloat32(input.HeightInMillimeters),
...
func (q *Querier) UpdateValidVessel(ctx context.Context, updated *types.ValidVessel) error {
	...
	if _, err := q.generatedQuerier.UpdateValidVessel(ctx, q.db, &generated.UpdateValidVesselParams{
		...
		Capacity:                       stringFromFloat32(updated.Capacity),
		CapacityUnit:                   nullStringFromString(updated.CapacityUnit.ID),
		WidthInMillimeters:             nullStringFromFloat32(updated.WidthInMillimeters),
		LengthInMillimeters:            nullStringFromFloat32(updated.LengthInMillimeters),
		HeightInMillimeters:            nullStringFromFloat32(updated.HeightInMillimeters),
