...
// BuildGetValidPreparationsQuery builds a SQL query selecting valid preparations that adhere to a given QueryFilter and belong to a given household,
...
// BuildGetValidPreparationsWithIDsQuery builds a SQL query selecting valid preparations that belong to a given household,
...
// BuildArchiveValidPreparationQuery returns a SQL query which marks a given valid preparation belonging to a given household as archived.
