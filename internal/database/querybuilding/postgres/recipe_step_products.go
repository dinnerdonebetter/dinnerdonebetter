...
// BuildGetRecipeStepProductsQuery builds a SQL query selecting recipe step products that adhere to a given QueryFilter and belong to a given household,
...
// BuildGetRecipeStepProductsWithIDsQuery builds a SQL query selecting recipe step products that belong to a given household,
...
// BuildArchiveRecipeStepProductQuery returns a SQL query which marks a given recipe step product belonging to a given household as archived.
