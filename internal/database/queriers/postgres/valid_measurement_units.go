...
const validMeasurementUnitSearchQuery = "SELECT valid_measurement_units.id, valid_measurement_units.name, valid_measurement_units.description, valid_measurement_units.warning, valid_measurement_units.contains_egg, valid_measurement_units.contains_dairy, valid_measurement_units.contains_peanut, valid_measurement_units.contains_tree_nut, valid_measurement_units.contains_soy, valid_measurement_units.contains_wheat, valid_measurement_units.contains_shellfish, valid_measurement_units.contains_sesame, valid_measurement_units.contains_fish, valid_measurement_units.contains_gluten, valid_measurement_units.animal_flesh, valid_measurement_units.volumetric, valid_measurement_units.is_liquid, valid_measurement_units.icon_path, valid_measurement_units.created_on, valid_measurement_units.last_updated_on, valid_measurement_units.archived_on FROM valid_measurement_units WHERE valid_measurement_units.name ILIKE $1 AND valid_measurement_units.archived_on IS NULL LIMIT 50"
...
const validMeasurementUnitCreationQuery = "INSERT INTO valid_measurement_units (id,name,description,volumetric,icon_path) VALUES ($1,$2,$3,$4)"
