...
func TestRecipeStepsService_CreateHandler(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		exampleCreationInput := fakes.BuildFakeRecipeStepCreationInput()
		...
		recipeStepDataManager.On(
			...
			mock.IsType(&types.RecipeStepCreationInput{}),
		...
		helper.service.recipeStepCounter = unitCounter

		helper.service.CreateHandler(helper.res, helper.req)

		assert.Equal(t, http.StatusCreated, helper.res.Code)

		mock.AssertExpectationsForObjects(t, recipeStepDataManager, unitCounter)
	})
...
func TestRecipeStepsService_UpdateHandler(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		exampleCreationInput := fakes.BuildFakeRecipeStepUpdateInput()
		jsonBytes := helper.service.encoderDecoder.MustEncode(helper.ctx, exampleCreationInput)
	...
	T.Run("with invalid input", func(t *testing.T) {
		...
		exampleCreationInput := &types.RecipeStepUpdateInput{}
		jsonBytes := helper.service.encoderDecoder.MustEncode(helper.ctx, exampleCreationInput)
...
func TestHouseholdsService_AuditEntryHandler(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		recipeStepDataManager := &mocktypes.RecipeStepDataManager{}
		recipeStepDataManager.On(
			"GetAuditLogEntriesForRecipeStep",
			testutils.ContextMatcher,
			helper.exampleRecipeStep.ID,
