...
func TestInvitationsService_CreateHandler(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		exampleCreationInput := fakes.BuildFakeInvitationCreationInput()
		...
		invitationDataManager.On(
			"CreateInvitation",
			testutils.ContextMatcher,
			mock.IsType(&types.InvitationCreationInput{}),
			helper.exampleUser.ID,
		).Return(helper.exampleInvitation, nil)
		...
		helper.service.invitationCounter = unitCounter

		helper.service.CreateHandler(helper.res, helper.req)

		assert.Equal(t, http.StatusCreated, helper.res.Code)

		mock.AssertExpectationsForObjects(t, invitationDataManager, unitCounter)
	})
...
func TestInvitationsService_ReadHandler(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		mock.AssertExpectationsForObjects(t, invitationDataManager, encoderDecoder)
	})
	...
	T.Run("with no such invitation in the database", func(t *testing.T) {
		t.Parallel()
		...
		invitationDataManager.On(
			...
			testutils.ContextMatcher,
			helper.exampleInvitation.ID,
		).Return((*types.Invitation)(nil), sql.ErrNoRows)
		helper.service.invitationDataManager = invitationDataManager
...
func TestInvitationsService_ListHandler(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		encoderDecoder.On(
			...
			testutils.ContextMatcher,
			testutils.HTTPResponseWriterMatcher,
			mock.IsType(&types.InvitationList{}),
		).Return()
		helper.service.encoderDecoder = encoderDecoder
	...
	T.Run("with no rows returned", func(t *testing.T) {
		...
		invitationDataManager.On(
			...
			testutils.ContextMatcher,
			mock.IsType(&types.QueryFilter{}),
		).Return((*types.InvitationList)(nil), sql.ErrNoRows)
		helper.service.invitationDataManager = invitationDataManager
	...
	T.Run("with error retrieving invitations from database", func(t *testing.T) {
		t.Parallel()
...
func TestInvitationsService_UpdateHandler(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		exampleCreationInput := fakes.BuildFakeInvitationUpdateInput()
		jsonBytes := helper.service.encoderDecoder.MustEncode(helper.ctx, exampleCreationInput)
	...
	T.Run("with invalid input", func(t *testing.T) {
		...
		exampleCreationInput := &types.InvitationUpdateInput{}
		jsonBytes := helper.service.encoderDecoder.MustEncode(helper.ctx, exampleCreationInput)
	...
	T.Run("with no such invitation", func(t *testing.T) {
		t.Parallel()
	...
	T.Run("with error retrieving invitation from database", func(t *testing.T) {
		t.Parallel()
...
func TestAccountsService_AuditEntryHandler(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		invitationDataManager := &mocktypes.InvitationDataManager{}
		invitationDataManager.On(
			"GetAuditLogEntriesForInvitation",
			testutils.ContextMatcher,
			helper.exampleInvitation.ID,
