...
func checkRecipeStepEquality(t *testing.T, expected, actual *types.RecipeStep) {
	...
	assert.Equal(t, expected.MinTemperatureInCelsius, actual.MinTemperatureInCelsius, "expected MinTemperatureInCelsius for recipe step %s to be %v, but it was %v", expected.ID, expected.MinTemperatureInCelsius, actual.MinTemperatureInCelsius)
...
func convertRecipeStepToRecipeStepUpdateInput(x *types.RecipeStep) *types.RecipeStepUpdateRequestInput {
	return &types.RecipeStepUpdateRequestInput{
		...
		TemperatureInCelsius:      x.MinTemperatureInCelsius,
		Notes:                     &x.Notes,
	}
}
