...
func checkRecipeStepEquality(t *testing.T, expected, actual *types.RecipeStep) {
	...
	assert.Equal(t, expected.TimeScaleFactor, actual.TimeScaleFactor, "expected TimeScaleFactor for recipe step %s to be %v, but it was %v", expected.ID, expected.TimeScaleFactor, actual.TimeScaleFactor)
