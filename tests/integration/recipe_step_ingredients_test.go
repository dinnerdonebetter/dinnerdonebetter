...
func checkRecipeStepIngredientEquality(t *testing.T, expected, actual *types.RecipeStepIngredient) {
	...
	assert.Equal(t, expected.QuantityScaleFactor, actual.QuantityScaleFactor, "expected QuantityScaleFactor for recipe step ingredient %s to be %v, but it was %v", expected.ID, expected.QuantityScaleFactor, actual.QuantityScaleFactor)
