...
func checkRecipeStepProductEquality(t *testing.T, expected, actual *types.RecipeStepProduct) {
	...
	assert.Equal(t, expected.QuantityScaleFactor, actual.QuantityScaleFactor, "expected QuantityScaleFactor for recipe step product %s to be %v, but it was %v", expected.ID, expected.QuantityScaleFactor, actual.QuantityScaleFactor)
