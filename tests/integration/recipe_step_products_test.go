...
func checkRecipeStepProductEquality(t *testing.T, expected, actual *types.RecipeStepProduct) {
	...
	assert.Equal(t, expected.QuantityType, actual.QuantityType, "expected ValidMeasurementID for recipe step product %s to be %v, but it was %v", expected.ID, expected.QuantityType, actual.QuantityType)
