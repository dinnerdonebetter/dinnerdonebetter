...
export class RecipeStepCompletionConditionForExistingRecipeCreationRequestInput implements IRecipeStepCompletionConditionForExistingRecipeCreationRequestInput {
   belongsToRecipeStep: string;
 ingredientStateID: string;
 ingredients: RecipeStepCompletionConditionIngredientForExistingRecipeCreationRequestInput;
 notes: string;
...
constructor(input: Partial<RecipeStepCompletionConditionForExistingRecipeCreationRequestInput> = {}) {
 ...
 this.ingredients = input.ingredients = new RecipeStepCompletionConditionIngredientForExistingRecipeCreationRequestInput();
