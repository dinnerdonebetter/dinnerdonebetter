...
async acceptHouseholdInvitation(
  ...
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < HouseholdInvitation  >  >(`/api/v1/household_invitations/${householdInvitationID}/accept`, input);
...
async archiveHouseholdInstrumentOwnership(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < HouseholdInstrumentOwnership  >  >(`/api/v1/households/instruments/${householdInstrumentOwnershipID}`, {});
...
async archiveMealPlanEvent(
  mealPlanID: string,
	mealPlanEventID: string,
	): Promise<  APIResponse <  MealPlanEvent >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < MealPlanEvent  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}`, {});
...
async archiveMealPlanGroceryListItem(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < MealPlanGroceryListItem  >  >(`/api/v1/meal_plans/${mealPlanID}/grocery_list_items/${mealPlanGroceryListItemID}`, {});
...
async archiveMealPlanOption(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < MealPlanOption  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/options/${mealPlanOptionID}`, {});
...
async archiveMealPlanOptionVote(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < MealPlanOptionVote  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/options/${mealPlanOptionID}/votes/${mealPlanOptionVoteID}`, {});
...
async archiveOAuth2Client(
  oauth2ClientID: string,
	): Promise<  APIResponse <  OAuth2Client >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < OAuth2Client  >  >(`/api/v1/oauth2_clients/${oauth2ClientID}`, {});
...
async archiveRecipePrepTask(
  recipeID: string,
	recipePrepTaskID: string,
	): Promise<  APIResponse <  RecipePrepTask >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < RecipePrepTask  >  >(`/api/v1/recipes/${recipeID}/prep_tasks/${recipePrepTaskID}`, {});
...
async archiveRecipeRating(
  recipeID: string,
	recipeRatingID: string,
	): Promise<  APIResponse <  RecipeRating >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < RecipeRating  >  >(`/api/v1/recipes/${recipeID}/ratings/${recipeRatingID}`, {});
...
async archiveRecipeStep(
  recipeID: string,
	recipeStepID: string,
	): Promise<  APIResponse <  RecipeStep >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < RecipeStep  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}`, {});
...
async archiveRecipeStepCompletionCondition(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < RecipeStepCompletionCondition  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/completion_conditions/${recipeStepCompletionConditionID}`, {});
...
async archiveRecipeStepIngredient(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < RecipeStepIngredient  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/ingredients/${recipeStepIngredientID}`, {});
...
async archiveRecipeStepInstrument(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < RecipeStepInstrument  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/instruments/${recipeStepInstrumentID}`, {});
...
async archiveRecipeStepProduct(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < RecipeStepProduct  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/products/${recipeStepProductID}`, {});
...
async archiveRecipeStepVessel(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < RecipeStepVessel  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/vessels/${recipeStepVesselID}`, {});
...
async archiveServiceSetting(
  serviceSettingID: string,
	): Promise<  APIResponse <  ServiceSetting >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ServiceSetting  >  >(`/api/v1/settings/${serviceSettingID}`, {});
...
async archiveServiceSettingConfiguration(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ServiceSettingConfiguration  >  >(`/api/v1/settings/configurations/${serviceSettingConfigurationID}`, {});
...
async archiveUserIngredientPreference(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < UserIngredientPreference  >  >(`/api/v1/user_ingredient_preferences/${userIngredientPreferenceID}`, {});
...
async archiveUserMembership(
  householdID: string,
	userID: string,
	): Promise<  APIResponse <  HouseholdUserMembership >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < HouseholdUserMembership  >  >(`/api/v1/households/${householdID}/members/${userID}`, {});
...
async archiveValidIngredient(
  validIngredientID: string,
	): Promise<  APIResponse <  ValidIngredient >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidIngredient  >  >(`/api/v1/valid_ingredients/${validIngredientID}`, {});
...
async archiveValidIngredientGroup(
  validIngredientGroupID: string,
	): Promise<  APIResponse <  ValidIngredientGroup >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidIngredientGroup  >  >(`/api/v1/valid_ingredient_groups/${validIngredientGroupID}`, {});
...
async archiveValidIngredientMeasurementUnit(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidIngredientMeasurementUnit  >  >(`/api/v1/valid_ingredient_measurement_units/${validIngredientMeasurementUnitID}`, {});
...
async archiveValidIngredientPreparation(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidIngredientPreparation  >  >(`/api/v1/valid_ingredient_preparations/${validIngredientPreparationID}`, {});
...
async archiveValidIngredientState(
  validIngredientStateID: string,
	): Promise<  APIResponse <  ValidIngredientState >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidIngredientState  >  >(`/api/v1/valid_ingredient_states/${validIngredientStateID}`, {});
...
async archiveValidIngredientStateIngredient(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidIngredientStateIngredient  >  >(`/api/v1/valid_ingredient_state_ingredients/${validIngredientStateIngredientID}`, {});
...
async archiveValidInstrument(
  validInstrumentID: string,
	): Promise<  APIResponse <  ValidInstrument >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidInstrument  >  >(`/api/v1/valid_instruments/${validInstrumentID}`, {});
...
async archiveValidMeasurementUnit(
  validMeasurementUnitID: string,
	): Promise<  APIResponse <  ValidMeasurementUnit >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidMeasurementUnit  >  >(`/api/v1/valid_measurement_units/${validMeasurementUnitID}`, {});
...
async archiveValidMeasurementUnitConversion(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidMeasurementUnitConversion  >  >(`/api/v1/valid_measurement_conversions/${validMeasurementUnitConversionID}`, {});
...
async archiveValidPreparation(
  validPreparationID: string,
	): Promise<  APIResponse <  ValidPreparation >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidPreparation  >  >(`/api/v1/valid_preparations/${validPreparationID}`, {});
...
async archiveValidPreparationInstrument(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidPreparationInstrument  >  >(`/api/v1/valid_preparation_instruments/${validPreparationVesselID}`, {});
...
async archiveValidPreparationVessel(
  validPreparationVesselID: string,
	): Promise<  APIResponse <  ValidPreparationVessel >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < ValidPreparationVessel  >  >(`/api/v1/valid_preparation_vessels/${validPreparationVesselID}`, {});
...
async archiveWebhookTriggerEvent(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.delete< APIResponse < WebhookTriggerEvent  >  >(`/api/v1/webhooks/${webhookID}/trigger_events/${webhookTriggerEventID}`, {});
...
async cancelHouseholdInvitation(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < HouseholdInvitation  >  >(`/api/v1/household_invitations/${householdInvitationID}/cancel`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async checkPermissions(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < UserPermissionsResponse  >  >(`/api/v1/users/permissions/check`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createHouseholdInstrumentOwnership(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < HouseholdInstrumentOwnership  >  >(`/api/v1/households/instruments`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createHouseholdInvitation(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < HouseholdInvitation  >  >(`/api/v1/households/${householdID}/invite`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createMealPlanEvent(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < MealPlanEvent  >  >(`/api/v1/meal_plans/${mealPlanID}/events`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createMealPlanGroceryListItem(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < MealPlanGroceryListItem  >  >(`/api/v1/meal_plans/${mealPlanID}/grocery_list_items`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createMealPlanOption(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < MealPlanOption  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/options`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createMealPlanOptionVote(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < Array<MealPlanOptionVote>  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/vote`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createMealPlanTask(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < MealPlanTask  >  >(`/api/v1/meal_plans/${mealPlanID}/tasks`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createOAuth2Client(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < OAuth2ClientCreationResponse  >  >(`/api/v1/oauth2_clients`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createRecipePrepTask(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < RecipePrepTask  >  >(`/api/v1/recipes/${recipeID}/prep_tasks`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createRecipeStepCompletionCondition(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < RecipeStepCompletionCondition  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/completion_conditions`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createRecipeStepIngredient(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < RecipeStepIngredient  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/ingredients`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createRecipeStepInstrument(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < RecipeStepInstrument  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/instruments`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createRecipeStepProduct(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < RecipeStepProduct  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/products`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createRecipeStepVessel(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < RecipeStepVessel  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/vessels`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createServiceSettingConfiguration(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ServiceSettingConfiguration  >  >(`/api/v1/settings/configurations`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createValidIngredientGroup(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ValidIngredientGroup  >  >(`/api/v1/valid_ingredient_groups`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createValidIngredientMeasurementUnit(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ValidIngredientMeasurementUnit  >  >(`/api/v1/valid_ingredient_measurement_units`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createValidIngredientPreparation(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ValidIngredientPreparation  >  >(`/api/v1/valid_ingredient_preparations`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createValidIngredientState(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ValidIngredientState  >  >(`/api/v1/valid_ingredient_states`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createValidIngredientStateIngredient(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ValidIngredientStateIngredient  >  >(`/api/v1/valid_ingredient_state_ingredients`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createValidMeasurementUnit(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ValidMeasurementUnit  >  >(`/api/v1/valid_measurement_units`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createValidMeasurementUnitConversion(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ValidMeasurementUnitConversion  >  >(`/api/v1/valid_measurement_conversions`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createValidPreparationInstrument(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ValidPreparationInstrument  >  >(`/api/v1/valid_preparation_instruments`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createValidPreparationVessel(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < ValidPreparationVessel  >  >(`/api/v1/valid_preparation_vessels`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async createWebhookTriggerEvent(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < WebhookTriggerEvent  >  >(`/api/v1/webhooks/${webhookID}/trigger_events`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async finalizeMealPlan(
  mealPlanID: string,
  
): Promise<  APIResponse <   FinalizeMealPlansResponse >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < FinalizeMealPlansResponse  >  >(`/api/v1/meal_plans/${mealPlanID}/finalize`);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async getAuditLogEntryByID(
  auditLogEntryID: string,
	): Promise<  APIResponse <  AuditLogEntry >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < AuditLogEntry  >  >(`/api/v1/audit_log_entries/${auditLogEntryID}`, {});
...
async getHouseholdInstrumentOwnership(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < HouseholdInstrumentOwnership  >  >(`/api/v1/households/instruments/${householdInstrumentOwnershipID}`, {});
...
async getHouseholdInstrumentOwnerships(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<HouseholdInstrumentOwnership>  >  >(`/api/v1/households/instruments`, {
...
async getHouseholdInvitation(
  householdInvitationID: string,
	): Promise<  APIResponse <  HouseholdInvitation >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < HouseholdInvitation  >  >(`/api/v1/household_invitations/${householdInvitationID}`, {});
...
async getHouseholdInvitationByID(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < HouseholdInvitation  >  >(`/api/v1/households/${householdID}/invitations/${householdInvitationID}`, {});
...
async getMealPlanEvent(
  mealPlanID: string,
	mealPlanEventID: string,
	): Promise<  APIResponse <  MealPlanEvent >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < MealPlanEvent  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<MealPlanEvent>  >  >(`/api/v1/meal_plans/${mealPlanID}/events`, {
      params: filter.asRecord(),
    });
...
async getMealPlanGroceryListItem(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < MealPlanGroceryListItem  >  >(`/api/v1/meal_plans/${mealPlanID}/grocery_list_items/${mealPlanGroceryListItemID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<MealPlanGroceryListItem>  >  >(`/api/v1/meal_plans/${mealPlanID}/grocery_list_items`, {
      params: filter.asRecord(),
    });
...
async getMealPlanOption(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < MealPlanOption  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/options/${mealPlanOptionID}`, {});
...
async getMealPlanOptionVote(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < MealPlanOptionVote  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/options/${mealPlanOptionID}/votes/${mealPlanOptionVoteID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<MealPlanOptionVote>  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/options/${mealPlanOptionID}/votes`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<MealPlanOption>  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/options`, {
      params: filter.asRecord(),
    });
...
async getMealPlanTask(
  mealPlanID: string,
	mealPlanTaskID: string,
	): Promise<  APIResponse <  MealPlanTask >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < MealPlanTask  >  >(`/api/v1/meal_plans/${mealPlanID}/tasks/${mealPlanTaskID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<MealPlanTask>  >  >(`/api/v1/meal_plans/${mealPlanID}/tasks`, {
      params: filter.asRecord(),
    });
...
async getMermaidDiagramForRecipe(
  recipeID: string,
...
async getRandomValidIngredient(
  ): Promise<  APIResponse <  ValidIngredient >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
...
async getRandomValidInstrument(
  ): Promise<  APIResponse <  ValidInstrument >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
...
async getRandomValidPreparation(
  ): Promise<  APIResponse <  ValidPreparation >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
...
async getReceivedHouseholdInvitations(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<HouseholdInvitation>  >  >(`/api/v1/household_invitations/received`, {
      params: filter.asRecord(),
    });
...
async getRecipeMealPlanTasks(
  recipeID: string,
	): Promise<  APIResponse <  RecipePrepTaskStep >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < RecipePrepTaskStep  >  >(`/api/v1/recipes/${recipeID}/prep_steps`, {});
...
async getRecipePrepTask(
  recipeID: string,
	recipePrepTaskID: string,
	): Promise<  APIResponse <  RecipePrepTask >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < RecipePrepTask  >  >(`/api/v1/recipes/${recipeID}/prep_tasks/${recipePrepTaskID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<RecipePrepTask>  >  >(`/api/v1/recipes/${recipeID}/prep_tasks`, {
      params: filter.asRecord(),
    });
...
async getRecipeRating(
  recipeID: string,
	recipeRatingID: string,
	): Promise<  APIResponse <  RecipeRating >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < RecipeRating  >  >(`/api/v1/recipes/${recipeID}/ratings/${recipeRatingID}`, {});
...
async getRecipeStep(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < RecipeStep  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}`, {});
...
async getRecipeStepCompletionCondition(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < RecipeStepCompletionCondition  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/completion_conditions/${recipeStepCompletionConditionID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<RecipeStepCompletionCondition>  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/completion_conditions`, {
      params: filter.asRecord(),
    });
...
async getRecipeStepIngredient(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < RecipeStepIngredient  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/ingredients/${recipeStepIngredientID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<RecipeStepIngredient>  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/ingredients`, {
      params: filter.asRecord(),
    });
...
async getRecipeStepInstrument(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < RecipeStepInstrument  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/instruments/${recipeStepInstrumentID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<RecipeStepInstrument>  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/instruments`, {
      params: filter.asRecord(),
    });
...
async getRecipeStepProduct(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < RecipeStepProduct  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/products/${recipeStepProductID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<RecipeStepProduct>  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/products`, {
      params: filter.asRecord(),
    });
...
async getRecipeStepVessel(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < RecipeStepVessel  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/vessels/${recipeStepVesselID}`, {});
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<RecipeStepVessel>  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/vessels`, {
      params: filter.asRecord(),
    });
...
async getSentHouseholdInvitations(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<HouseholdInvitation>  >  >(`/api/v1/household_invitations/sent`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ServiceSettingConfiguration>  >  >(`/api/v1/settings/configurations/user/${serviceSettingConfigurationName}`, {
      params: filter.asRecord(),
    });
...
async getServiceSettingConfigurationsForHousehold(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ServiceSettingConfiguration>  >  >(`/api/v1/settings/configurations/household`, {
      params: filter.asRecord(),
    });
...
async getServiceSettingConfigurationsForUser(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ServiceSettingConfiguration>  >  >(`/api/v1/settings/configurations/user`, {
      params: filter.asRecord(),
    });
...
async getUserIngredientPreferences(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<UserIngredientPreference>  >  >(`/api/v1/user_ingredient_preferences`, {
      params: filter.asRecord(),
    });
...
async getUserNotification(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < UserNotification  >  >(`/api/v1/user_notifications/${userNotificationID}`, {});
...
async getValidIngredient(
  validIngredientID: string,
	): Promise<  APIResponse <  ValidIngredient >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidIngredient  >  >(`/api/v1/valid_ingredients/${validIngredientID}`, {});
...
async getValidIngredientGroup(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidIngredientGroup  >  >(`/api/v1/valid_ingredient_groups/${validIngredientGroupID}`, {});
...
async getValidIngredientGroups(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientGroup>  >  >(`/api/v1/valid_ingredient_groups`, {
      params: filter.asRecord(),
    });
...
async getValidIngredientMeasurementUnit(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidIngredientMeasurementUnit  >  >(`/api/v1/valid_ingredient_measurement_units/${validIngredientMeasurementUnitID}`, {});
...
async getValidIngredientMeasurementUnits(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientMeasurementUnit>  >  >(`/api/v1/valid_ingredient_measurement_units`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientMeasurementUnit>  >  >(`/api/v1/valid_ingredient_measurement_units/by_ingredient/${validIngredientID}`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientMeasurementUnit>  >  >(`/api/v1/valid_ingredient_measurement_units/by_measurement_unit/${validMeasurementUnitID}`, {
      params: filter.asRecord(),
    });
...
async getValidIngredientPreparation(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidIngredientPreparation  >  >(`/api/v1/valid_ingredient_preparations/${validIngredientPreparationID}`, {});
...
async getValidIngredientPreparations(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientPreparation>  >  >(`/api/v1/valid_ingredient_preparations`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientPreparation>  >  >(`/api/v1/valid_ingredient_preparations/by_ingredient/${validIngredientID}`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientPreparation>  >  >(`/api/v1/valid_ingredient_preparations/by_preparation/${validPreparationID}`, {
      params: filter.asRecord(),
    });
...
async getValidIngredientState(
  validIngredientStateID: string,
	): Promise<  APIResponse <  ValidIngredientState >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidIngredientState  >  >(`/api/v1/valid_ingredient_states/${validIngredientStateID}`, {});
...
async getValidIngredientStateIngredient(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidIngredientStateIngredient  >  >(`/api/v1/valid_ingredient_state_ingredients/${validIngredientStateIngredientID}`, {});
...
async getValidIngredientStateIngredients(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientStateIngredient>  >  >(`/api/v1/valid_ingredient_state_ingredients`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientStateIngredient>  >  >(`/api/v1/valid_ingredient_state_ingredients/by_ingredient/${validIngredientID}`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientStateIngredient>  >  >(`/api/v1/valid_ingredient_state_ingredients/by_ingredient_state/${validIngredientStateID}`, {
      params: filter.asRecord(),
    });
...
async getValidIngredientStates(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientState>  >  >(`/api/v1/valid_ingredient_states`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredient>  >  >(`/api/v1/valid_ingredients/by_preparation/${validPreparationID}`, {
      params: filter.asRecord(),
    });
...
async getValidInstrument(
  validInstrumentID: string,
	): Promise<  APIResponse <  ValidInstrument >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidInstrument  >  >(`/api/v1/valid_instruments/${validInstrumentID}`, {});
...
async getValidMeasurementUnit(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidMeasurementUnit  >  >(`/api/v1/valid_measurement_units/${validMeasurementUnitID}`, {});
...
async getValidMeasurementUnitConversion(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidMeasurementUnitConversion  >  >(`/api/v1/valid_measurement_conversions/${validMeasurementUnitConversionID}`, {});
...
async getValidMeasurementUnits(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidMeasurementUnit>  >  >(`/api/v1/valid_measurement_units`, {
      params: filter.asRecord(),
    });
...
async getValidPreparation(
  validPreparationID: string,
	): Promise<  APIResponse <  ValidPreparation >    >   {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidPreparation  >  >(`/api/v1/valid_preparations/${validPreparationID}`, {});
...
async getValidPreparationInstrument(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidPreparationInstrument  >  >(`/api/v1/valid_preparation_instruments/${validPreparationVesselID}`, {});
...
async getValidPreparationInstruments(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidPreparationInstrument>  >  >(`/api/v1/valid_preparation_instruments`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidPreparationInstrument>  >  >(`/api/v1/valid_preparation_instruments/by_instrument/${validInstrumentID}`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidPreparationInstrument>  >  >(`/api/v1/valid_preparation_instruments/by_preparation/${validPreparationID}`, {
      params: filter.asRecord(),
    });
...
async getValidPreparationVessel(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < ValidPreparationVessel  >  >(`/api/v1/valid_preparation_vessels/${validPreparationVesselID}`, {});
...
async getValidPreparationVessels(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidPreparationVessel>  >  >(`/api/v1/valid_preparation_vessels`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidPreparationVessel>  >  >(`/api/v1/valid_preparation_vessels/by_preparation/${validPreparationID}`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidPreparationVessel>  >  >(`/api/v1/valid_preparation_vessels/by_vessel/${ValidVesselID}`, {
      params: filter.asRecord(),
    });
...
async loginForJWT(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < JWTResponse  >  >(`/users/login/jwt`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async refreshTOTPSecret(
  
  input: TOTPSecretRefreshInput,
): Promise<  APIResponse <   TOTPSecretRefreshResponse >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < TOTPSecretRefreshResponse  >  >(`/api/v1/users/totp_secret/new`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async runFinalizeMealPlanWorker(
  
  input: FinalizeMealPlansRequest,
): Promise<  APIResponse <   FinalizeMealPlansResponse >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < FinalizeMealPlansResponse  >  >(`/api/v1/workers/finalize_meal_plans`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async runMealPlanGroceryListInitializerWorker(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < InitializeMealPlanGroceryListResponse  >  >(`/api/v1/workers/meal_plan_grocery_list_init`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async runMealPlanTaskCreatorWorker(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < CreateMealPlanTasksResponse  >  >(`/api/v1/workers/meal_plan_tasks`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientGroup>  >  >(`/api/v1/valid_ingredient_groups/search`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidIngredientState>  >  >(`/api/v1/valid_ingredient_states/search`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidMeasurementUnit>  >  >(`/api/v1/valid_measurement_units/search`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidPreparation>  >  >(`/api/v1/valid_preparations/search`, {
      params: filter.asRecord(),
    });
...
filter: QueryFilter = QueryFilter.Default(),
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.get< APIResponse < Array<ValidMeasurementUnit>  >  >(`/api/v1/valid_measurement_units/by_ingredient/${validIngredientID}`, {
      params: filter.asRecord(),
    });
...
async transferHouseholdOwnership(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.post<APIResponse < Household  >  >(`/api/v1/households/${householdID}/transfer`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateHouseholdInstrumentOwnership(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < HouseholdInstrumentOwnership  >  >(`/api/v1/households/instruments/${householdInstrumentOwnershipID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateHouseholdMemberPermissions(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.patch<APIResponse < UserPermissionsResponse  >  >(`/api/v1/households/${householdID}/members/${userID}/permissions`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateMealPlanEvent(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < MealPlanEvent  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateMealPlanGroceryListItem(
  mealPlanID: string,mealPlanGroceryListItemID: string,
  input: MealPlanGroceryListItemUpdateRequestInput,
): Promise<  APIResponse <   MealPlanGroceryListItem >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < MealPlanGroceryListItem  >  >(`/api/v1/meal_plans/${mealPlanID}/grocery_list_items/${mealPlanGroceryListItemID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateMealPlanOption(
  mealPlanID: string,mealPlanEventID: string,mealPlanOptionID: string,
  input: MealPlanOptionUpdateRequestInput,
): Promise<  APIResponse <   MealPlanOption >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < MealPlanOption  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/options/${mealPlanOptionID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateMealPlanOptionVote(
  mealPlanID: string,mealPlanEventID: string,mealPlanOptionID: string,mealPlanOptionVoteID: string,
  input: MealPlanOptionVoteUpdateRequestInput,
): Promise<  APIResponse <   MealPlanOptionVote >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < MealPlanOptionVote  >  >(`/api/v1/meal_plans/${mealPlanID}/events/${mealPlanEventID}/options/${mealPlanOptionID}/votes/${mealPlanOptionVoteID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateMealPlanTaskStatus(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.patch<APIResponse < MealPlanTask  >  >(`/api/v1/meal_plans/${mealPlanID}/tasks/${mealPlanTaskID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
): Promise<  AxiosResponse<  APIResponse <   PasswordResetResponse >    >  >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
...
async updateRecipePrepTask(
  recipeID: string,recipePrepTaskID: string,
  input: RecipePrepTaskUpdateRequestInput,
): Promise<  APIResponse <   RecipePrepTask >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < RecipePrepTask  >  >(`/api/v1/recipes/${recipeID}/prep_tasks/${recipePrepTaskID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateRecipeRating(
  recipeID: string,recipeRatingID: string,
  input: RecipeRatingUpdateRequestInput,
): Promise<  APIResponse <   RecipeRating >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < RecipeRating  >  >(`/api/v1/recipes/${recipeID}/ratings/${recipeRatingID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateRecipeStep(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < RecipeStep  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateRecipeStepCompletionCondition(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < RecipeStepCompletionCondition  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/completion_conditions/${recipeStepCompletionConditionID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateRecipeStepIngredient(
  recipeID: string,recipeStepID: string,recipeStepIngredientID: string,
  input: RecipeStepIngredientUpdateRequestInput,
): Promise<  APIResponse <   RecipeStepIngredient >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < RecipeStepIngredient  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/ingredients/${recipeStepIngredientID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateRecipeStepInstrument(
  recipeID: string,recipeStepID: string,recipeStepInstrumentID: string,
  input: RecipeStepInstrumentUpdateRequestInput,
): Promise<  APIResponse <   RecipeStepInstrument >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < RecipeStepInstrument  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/instruments/${recipeStepInstrumentID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateRecipeStepProduct(
  recipeID: string,recipeStepID: string,recipeStepProductID: string,
  input: RecipeStepProductUpdateRequestInput,
): Promise<  APIResponse <   RecipeStepProduct >    >  {
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < RecipeStepProduct  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/products/${recipeStepProductID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateRecipeStepVessel(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < RecipeStepVessel  >  >(`/api/v1/recipes/${recipeID}/steps/${recipeStepID}/vessels/${recipeStepVesselID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateServiceSettingConfiguration(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ServiceSettingConfiguration  >  >(`/api/v1/settings/configurations/${serviceSettingConfigurationID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateUserIngredientPreference(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < UserIngredientPreference  >  >(`/api/v1/user_ingredient_preferences/${userIngredientPreferenceID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateUserNotification(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.patch<APIResponse < UserNotification  >  >(`/api/v1/user_notifications/${userNotificationID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidIngredient(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidIngredient  >  >(`/api/v1/valid_ingredients/${validIngredientID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidIngredientGroup(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidIngredientGroup  >  >(`/api/v1/valid_ingredient_groups/${validIngredientGroupID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidIngredientMeasurementUnit(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidIngredientMeasurementUnit  >  >(`/api/v1/valid_ingredient_measurement_units/${validIngredientMeasurementUnitID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidIngredientPreparation(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidIngredientPreparation  >  >(`/api/v1/valid_ingredient_preparations/${validIngredientPreparationID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidIngredientState(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidIngredientState  >  >(`/api/v1/valid_ingredient_states/${validIngredientStateID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidIngredientStateIngredient(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidIngredientStateIngredient  >  >(`/api/v1/valid_ingredient_state_ingredients/${validIngredientStateIngredientID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidInstrument(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidInstrument  >  >(`/api/v1/valid_instruments/${validInstrumentID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidMeasurementUnit(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidMeasurementUnit  >  >(`/api/v1/valid_measurement_units/${validMeasurementUnitID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidMeasurementUnitConversion(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidMeasurementUnitConversion  >  >(`/api/v1/valid_measurement_conversions/${validMeasurementUnitConversionID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidPreparation(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidPreparation  >  >(`/api/v1/valid_preparations/${validPreparationID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidPreparationInstrument(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidPreparationInstrument  >  >(`/api/v1/valid_preparation_instruments/${validPreparationVesselID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
...
async updateValidPreparationVessel(
  ...
  let self = this;
  return new Promise(async function (resolve, reject) {
    const response = await self.client.put<APIResponse < ValidPreparationVessel  >  >(`/api/v1/valid_preparation_vessels/${validPreparationVesselID}`, input);
	    if (response.data.error) {
	      reject(new Error(response.data.error.message));
	    }
