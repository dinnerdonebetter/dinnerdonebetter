...
export class MockGetValidIngredientStateIngredientsByIngredientStateResponseConfig extends ResponseConfig<
...
export const mockGetValidIngredientStateIngredientsByIngredientStates = (
  resCfg: MockGetValidIngredientStateIngredientsByIngredientStateResponseConfig,
) => {
  return (page: Page) =>
    page.route(
