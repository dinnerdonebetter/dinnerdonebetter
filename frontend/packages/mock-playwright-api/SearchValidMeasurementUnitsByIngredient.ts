...
export class MockSearchValidMeasurementUnitsByIngredientResponseConfig extends ResponseConfig<QueryFilteredResult<ValidMeasurementUnit>> {
		   q: string;
...
export const mockSearchValidMeasurementUnitsByIngredients = (resCfg: MockSearchValidMeasurementUnitsByIngredientResponseConfig) => {
  return (page: Page) =>
    page.route(
