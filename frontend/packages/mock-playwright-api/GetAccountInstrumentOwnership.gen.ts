...
export class MockGetAccountInstrumentOwnershipResponseConfig extends ResponseConfig<AccountInstrumentOwnership> {
...
export const mockGetAccountInstrumentOwnership = (resCfg: MockGetAccountInstrumentOwnershipResponseConfig) => {
  return (page: Page) =>
    page.route(
