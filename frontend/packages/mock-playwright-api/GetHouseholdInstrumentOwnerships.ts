...
import { HouseholdInstrumentOwnership,
...
export class MockGetHouseholdInstrumentOwnershipsResponseConfig extends ResponseConfig<QueryFilteredResult<HouseholdInstrumentOwnership>> {
