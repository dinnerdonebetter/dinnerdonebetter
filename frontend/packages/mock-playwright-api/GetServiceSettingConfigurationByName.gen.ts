...
export class MockGetServiceSettingConfigurationByNameResponseConfig extends ResponseConfig<
...
export const mockGetServiceSettingConfigurationByNames = (
  resCfg: MockGetServiceSettingConfigurationByNameResponseConfig,
) => {
  return (page: Page) =>
    page.route(
