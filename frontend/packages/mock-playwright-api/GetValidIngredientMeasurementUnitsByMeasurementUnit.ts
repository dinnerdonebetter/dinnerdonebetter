...
export class MockGetValidIngredientMeasurementUnitsByMeasurementUnitResponseConfig extends ResponseConfig<QueryFilteredResult<ValidIngredientMeasurementUnit>> {
...
export const mockGetValidIngredientMeasurementUnitsByMeasurementUnits = (resCfg: MockGetValidIngredientMeasurementUnitsByMeasurementUnitResponseConfig) => {
  return (page: Page) =>
    page.route(
