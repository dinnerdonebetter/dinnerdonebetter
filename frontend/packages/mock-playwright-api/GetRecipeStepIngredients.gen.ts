...
import { RecipeStepIngredient, QueryFilteredResult } from '@dinnerdonebetter/models';

import { assertClient, assertMethod, ResponseConfig } from './helpers';

export class MockGetRecipeStepIngredientsResponseConfig extends ResponseConfig<
  QueryFilteredResult<RecipeStepIngredient>
> {
  recipeID: string;
  recipeStepID: string;
