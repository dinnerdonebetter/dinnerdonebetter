...
export class MockGetRecipeStepIngredientResponseConfig extends ResponseConfig<RecipeStepIngredient> {
		   recipeID: string;
		 recipeStepID: string;
...
export const mockGetRecipeStepIngredient = (resCfg: MockGetRecipeStepIngredientResponseConfig) => {
  return (page: Page) =>
    page.route(
