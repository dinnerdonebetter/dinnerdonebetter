...
export class MockGetValidPreparationInstrumentsByInstrumentResponseConfig extends ResponseConfig<
...
export const mockGetValidPreparationInstrumentsByInstruments = (
  resCfg: MockGetValidPreparationInstrumentsByInstrumentResponseConfig,
) => {
  return (page: Page) =>
    page.route(
