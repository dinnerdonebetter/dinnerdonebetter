...
export class MockGetValidIngredientMeasurementUnitsByIngredientResponseConfig extends ResponseConfig<
...
export const mockGetValidIngredientMeasurementUnitsByIngredients = (
  resCfg: MockGetValidIngredientMeasurementUnitsByIngredientResponseConfig,
) => {
  return (page: Page) =>
    page.route(
