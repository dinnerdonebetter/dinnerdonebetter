...
export class MockGetMealPlanTaskResponseConfig extends ResponseConfig<MealPlanTask> {
		   mealPlanID: string;
...
export const mockGetMealPlanTask = (resCfg: MockGetMealPlanTaskResponseConfig) => {
  return (page: Page) =>
    page.route(
