...
export const ALL_MEAL_COMPONENT_TYPE: string[] = [
   'main',  'side',  'appetizer',  'beverage',  'dessert',  'soup',  'salad',  'amuse-bouche',  'unspecified', 
];
type MealComponentTypeTuple = typeof ALL_MEAL_COMPONENT_TYPE;
export type MealComponentType = MealComponentTypeTuple[number];


export const ALL_MEAL_PLAN_TASK_STATUS: string[] = [
   'unfinished',  'postponed',  'ignored',  'canceled',  'finished', 
];
...
export const ALL_VALID_INGREDIENT_STATE_ATTRIBUTE_TYPE: string[] = [
   'texture',  'consistency',  'temperature',  'color',  'appearance',  'odor',  'taste',  'sound',  'other', 
];
...
export const ALL_VALID_MEAL_PLAN_ELECTION_METHOD: string[] = [
   'schulze',  'instant-runoff', 
];
...
export const ALL_VALID_MEAL_PLAN_GROCERY_LIST_ITEM_STATUS: string[] = [
   'unknown',  'already owned',  'needs',  'unavailable',  'acquired', 
];
...
export const ALL_VALID_MEAL_PLAN_STATUS: string[] = [
   'awaiting_votes',  'finalized', 
];
...
export const ALL_VALID_RECIPE_STEP_PRODUCT_TYPE: string[] = [
   'ingredient',  'instrument',  'vessel', 
];
...
export const ALL_VALID_VESSEL_SHAPE_TYPE: string[] = [
   'hemisphere',  'rectangle',  'cone',  'pyramid',  'cylinder',  'sphere',  'cube',  'other', 
];
