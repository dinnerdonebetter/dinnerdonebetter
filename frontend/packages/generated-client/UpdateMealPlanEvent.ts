...
import { MealPlanEvent, APIResponse, MealPlanEventUpdateRequestInput } from '@dinnerdonebetter/models';
...
export async function updateMealPlanEvent(
  ...
  return new Promise(async function (resolve, reject) {
    const response = await client.put<APIResponse<MealPlanEvent>>(
