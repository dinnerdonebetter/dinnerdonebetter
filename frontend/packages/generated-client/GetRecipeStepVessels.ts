...
import { RecipeStepVessel, QueryFilter, QueryFilteredResult, APIResponse } from '@dinnerdonebetter/models';
...
export async function getRecipeStepVessels(
  ...
  return new Promise(async function (resolve, reject) {
    const response = await client.get<APIResponse<Array<RecipeStepVessel>>>(
