...
import { UserNotification, APIResponse, UserNotificationUpdateRequestInput } from '@dinnerdonebetter/models';
...
export async function updateUserNotification(
  ...
  return new Promise(async function (resolve, reject) {
    const response = await client.patch<APIResponse<UserNotification>>(
