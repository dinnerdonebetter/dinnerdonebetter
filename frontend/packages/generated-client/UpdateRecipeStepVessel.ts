...
import { RecipeStepVessel, APIResponse, RecipeStepVesselUpdateRequestInput } from '@dinnerdonebetter/models';
...
export async function updateRecipeStepVessel(
  ...
  return new Promise(async function (resolve, reject) {
    const response = await client.put<APIResponse<RecipeStepVessel>>(
