...
import { MealPlanOptionVote, QueryFilter, QueryFilteredResult, APIResponse } from '@dinnerdonebetter/models';
...
export async function getMealPlanOptionVotes(
  ...
  return new Promise(async function (resolve, reject) {
    const response = await client.get<APIResponse<Array<MealPlanOptionVote>>>(
