...
import { MealPlanOption, APIResponse, MealPlanOptionCreationRequestInput } from '@dinnerdonebetter/models';
...
export async function createMealPlanOption(
  ...
  return new Promise(async function (resolve, reject) {
    const response = await client.post<APIResponse<MealPlanOption>>(
