...
export class DinnerDoneBetterAPIClient {
  ...
  async createMealPlanOptionVote(
    ...
    let self = this;
    return new Promise(async function (resolve, reject) {
      const response = await self.client.post<APIResponse<MealPlanOptionVote>>(
  ...
  async createUserIngredientPreference(
    ...
    let self = this;
    return new Promise(async function (resolve, reject) {
      const response = await self.client.post<APIResponse<UserIngredientPreference>>(
  ...
  async verifyUserEmailAddress(input: EmailAddressVerificationRequestInput): Promise<APIResponse<User>> {
    let self = this;
    return new Promise(async function (resolve, reject) {
      const response = await self.client.post<APIResponse<User>>(`/api/v1/users/email_address_verification`, input);
      if (response.data.error) {
        reject(new Error(response.data.error.message));
      }
