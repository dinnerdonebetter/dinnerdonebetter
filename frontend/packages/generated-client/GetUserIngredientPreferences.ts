...
import { UserIngredientPreference, QueryFilter, QueryFilteredResult, APIResponse } from '@dinnerdonebetter/models';
...
export async function getUserIngredientPreferences(
  ...
  return new Promise(async function (resolve, reject) {
    const response = await client.get<APIResponse<Array<UserIngredientPreference>>>(
