...
import { WebhookTriggerEvent, APIResponse, WebhookTriggerEventCreationRequestInput } from '@dinnerdonebetter/models';
...
export async function createWebhookTriggerEvent(
  ...
  return new Promise(async function (resolve, reject) {
    const response = await client.post<APIResponse<WebhookTriggerEvent>>(
