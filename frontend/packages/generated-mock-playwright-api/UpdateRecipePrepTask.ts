...
export class MockUpdateRecipePrepTaskResponseConfig extends ResponseConfig<RecipePrepTask> {
  recipeID: string;
...
export const mockUpdateRecipePrepTask = (resCfg: MockUpdateRecipePrepTaskResponseConfig) => {
  return (page: Page) =>
    page.route(
