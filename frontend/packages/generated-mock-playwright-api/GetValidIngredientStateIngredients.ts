...
export class MockGetValidIngredientStateIngredientsResponseConfig extends ResponseConfig<
...
export const mockGetValidIngredientStateIngredientss = (
  resCfg: MockGetValidIngredientStateIngredientsResponseConfig,
) => {
  return (page: Page) =>
    page.route(
