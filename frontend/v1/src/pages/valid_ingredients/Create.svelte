<script>
  ...
  function createValidIngredient() {
    fetch("http://localhost/api/v1/valid_ingredients/", {
      method: "POST",
...
<form
  id="validIngredientForm"
  on:submit|preventDefault={createValidIngredient}
  ...
  <Link to="/valid_ingredients">valid ingredients list</Link>
</form>
