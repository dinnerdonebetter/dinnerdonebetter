<script>
  ...
  function createIterationMedia() {
    fetch("http://localhost/api/v1/iteration_medias/", {
      method: "POST",
...
<form
  id="iterationMediaForm"
  on:submit|preventDefault={createIterationMedia}
  ...
  <Link to="/iteration_medias">iteration medias list</Link>
</form>
