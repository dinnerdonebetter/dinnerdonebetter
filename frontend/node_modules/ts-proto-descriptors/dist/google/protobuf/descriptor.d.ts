...
export declare const FileDescriptorSet: {
    ...
    getExtension<T_1>(message: FileDescriptorSet, extension: Extension<T_1>): T_1 | undefined;
...
export declare const FeatureSet: {
    ...
    getExtension<T_1>(message: FeatureSet, extension: Extension<T_1>): T_1 | undefined;
...
export declare const FeatureSet_VisibilityFeature: {
    encode(message: FeatureSet_VisibilityFeature, writer?: BinaryWriter): BinaryWriter;
...
export declare const SourceCodeInfo: {
    ...
    getExtension<T_1>(message: SourceCodeInfo, extension: Extension<T_1>): T_1 | undefined;
