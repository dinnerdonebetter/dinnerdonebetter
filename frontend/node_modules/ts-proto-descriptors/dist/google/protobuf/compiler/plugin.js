...
(function (CodeGeneratorResponse_Feature) {
    ...
    CodeGeneratorResponse_Feature[CodeGeneratorResponse_Feature["FEATURE_SUPPORTS_EDITIONS"] = 2] = "FEATURE_SUPPORTS_EDITIONS";
    ...
    fromJSON(object) {
        return {
            ...
            sourceFileDescriptors: globalThis.Array.isArray(object?.sourceFileDescriptors)
                ? object.sourceFileDescriptors.map((e) => descriptor_1.FileDescriptorProto.fromJSON(e))
                : [],
