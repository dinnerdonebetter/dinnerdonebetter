...
function generateEncoder(ctx, typeName) {
    ...
    if (name == "Timestamp") {
        const TimestampValue = (0, utils_1.impProto)(ctx.options, "google/protobuf/timestamp", (0, utils_1.wrapTypeName)(ctx.options, name));
        ...
        if (ctx.options.useDate === options_1.DateOption.DATE ||
            ...
            ctx.options.useDate === options_1.DateOption.TEMPORAL) {
    ...
    if (name == "Struct" || name == "Value") {
        const StructType = (0, utils_1.impProto)(ctx.options, "google/protobuf/struct", (0, utils_1.wrapTypeName)(ctx.options, name));
        return (0, ts_poet_1.code) `${StructType}.encode(${StructType}.wrap(value)).finish()`;
    }
    if (name == "ListValue") {
        const ListValueType = (0, utils_1.impProto)(ctx.options, "google/protobuf/struct", (0, utils_1.wrapTypeName)(ctx.options, name));
        return (0, ts_poet_1.code) `${ListValueType}.encode({values: value ?? []}).finish()`;
    }
    const TypeValue = (0, utils_1.impProto)(ctx.options, "google/protobuf/wrappers", (0, utils_1.wrapTypeName)(ctx.options, name));
    switch (name) {
        case "StringValue":
...
function generateDecoder(ctx, typeName) {
    ...
    let TypeValue;
    if (name == "Timestamp") {
        TypeValue = (0, utils_1.impProto)(ctx.options, "google/protobuf/timestamp", (0, utils_1.wrapTypeName)(ctx.options, name));
    ...
    if (name == "Struct" || name == "ListValue" || name == "Value") {
        TypeValue = (0, utils_1.impProto)(ctx.options, "google/protobuf/struct", (0, utils_1.wrapTypeName)(ctx.options, name));
        return (0, ts_poet_1.code) `${TypeValue}.unwrap(${TypeValue}.decode(value))`;
    }
    TypeValue = (0, utils_1.impProto)(ctx.options, "google/protobuf/wrappers", (0, utils_1.wrapTypeName)(ctx.options, name));
