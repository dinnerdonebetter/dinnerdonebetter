...
import { UploadRequest, UploadMetadata } from '$lib/generated/uploaded_media/uploaded_media';
...
export async function loginForToken(request: LoginForTokenRequest): Promise<LoginForTokenResponse> {
  const client = getAuthClient();
  return promisifyUnary<LoginForTokenRequest, LoginForTokenResponse>(client.loginForToken.bind(client))(
    request,
    emptyMetadata,
  );
}
...
export async function verifyEmailAddress(request: VerifyEmailAddressRequest): Promise<VerifyEmailAddressResponse> {
  const client = getAuthClient();
  return promisifyUnary<VerifyEmailAddressRequest, VerifyEmailAddressResponse>(client.verifyEmailAddress.bind(client))(
    request,
    emptyMetadata,
  );
}

export async function beginPasskeyRegistration(oauth2Token: string): Promise<BeginPasskeyRegistrationResponse> {
  const client = getAuthClient();
...
export async function beginPasskeyAuthentication(
  ...
  const client = getAuthClient();
  return promisifyUnary<BeginPasskeyAuthenticationRequest, BeginPasskeyAuthenticationResponse>(
    client.beginPasskeyAuthentication.bind(client),
  )(request, emptyMetadata);
}
...
export async function getSelf(oauth2Token: string): Promise<GetSelfResponse> {
  const client = getAuthClient();
  return promisifyUnary<GetSelfRequest, GetSelfResponse>(client.getSelf.bind(client))({}, authMetadata(oauth2Token));
}

export async function getActiveAccount(oauth2Token: string): Promise<GetActiveAccountResponse> {
  const client = getAuthClient();
  return promisifyUnary<GetActiveAccountRequest, GetActiveAccountResponse>(client.getActiveAccount.bind(client))(
    {},
    authMetadata(oauth2Token),
  );
}

export async function listPasskeys(oauth2Token: string): Promise<ListPasskeysResponse> {
  const client = getAuthClient();
  return promisifyUnary<ListPasskeysRequest, ListPasskeysResponse>(client.listPasskeys.bind(client))(
    {},
    authMetadata(oauth2Token),
  );
}
...
export async function archivePasskey(
  ...
  const client = getAuthClient();
  return promisifyUnary<ArchivePasskeyRequest, ArchivePasskeyResponse>(client.archivePasskey.bind(client))(
    request,
    authMetadata(oauth2Token),
  );
}
...
export async function getAccountsForUser(
  ...
  return promisifyUnary<GetAccountsForUserRequest, GetAccountsForUserResponse>(client.getAccountsForUser.bind(client))(
    request,
    authMetadata(oauth2Token),
  );
}
...
export async function getSentAccountInvitations(
  ...
  const client = getIdentityClient();
  return promisifyUnary<GetSentAccountInvitationsRequest, GetSentAccountInvitationsResponse>(
    client.getSentAccountInvitations.bind(client),
  )(request, authMetadata(oauth2Token));
}
...
export async function createAccountInvitation(
  ...
  const client = getIdentityClient();
  return promisifyUnary<CreateAccountInvitationRequest, CreateAccountInvitationResponse>(
    client.createAccountInvitation.bind(client),
  )(request, authMetadata(oauth2Token));
}
...
export async function cancelAccountInvitation(
  ...
  const client = getIdentityClient();
  return promisifyUnary<CancelAccountInvitationRequest, CancelAccountInvitationResponse>(
    client.cancelAccountInvitation.bind(client),
  )(request, authMetadata(oauth2Token));
}
...
export async function updateAccountMemberPermissions(
  ...
  const client = getIdentityClient();
  return promisifyUnary<UpdateAccountMemberPermissionsRequest, UpdateAccountMemberPermissionsResponse>(
...
export async function updateAccount(
  ...
  const client = getIdentityClient();
  return promisifyUnary<UpdateAccountRequest, UpdateAccountResponse>(client.updateAccount.bind(client))(
    request,
    authMetadata(oauth2Token),
  );
}
...
export async function updateUserUsername(
  ...
  const client = getIdentityClient();
  return promisifyUnary<UpdateUserUsernameRequest, UpdateUserUsernameResponse>(client.updateUserUsername.bind(client))(
    request,
    authMetadata(oauth2Token),
  );
}
...
export async function updateUserDetails(
  ...
  const client = getIdentityClient();
  return promisifyUnary<UpdateUserDetailsRequest, UpdateUserDetailsResponse>(client.updateUserDetails.bind(client))(
    request,
    authMetadata(oauth2Token),
  );
}
...
export async function getServiceSettings(
  ...
  return promisifyUnary<GetServiceSettingsRequest, GetServiceSettingsResponse>(client.getServiceSettings.bind(client))(
    request,
    authMetadata(oauth2Token),
  );
}
...
export async function getServiceSettingConfigurationsForUser(
  ...
  const client = getSettingsClient();
  return promisifyUnary<GetServiceSettingConfigurationsForUserRequest, GetServiceSettingConfigurationsForUserResponse>(
...
export async function createServiceSettingConfiguration(
  ...
  const client = getSettingsClient();
  return promisifyUnary<CreateServiceSettingConfigurationRequest, CreateServiceSettingConfigurationResponse>(
...
export async function updateServiceSettingConfiguration(
  ...
  const client = getSettingsClient();
  return promisifyUnary<UpdateServiceSettingConfigurationRequest, UpdateServiceSettingConfigurationResponse>(
...
export async function searchValidIngredientsByPreparation(
  ...
  const client = getMealplanningClient();
  return promisifyUnary<SearchValidIngredientsByPreparationRequest, SearchValidIngredientsByPreparationResponse>(
...
export async function createRecipe(oauth2Token: string, request: CreateRecipeRequest): Promise<CreateRecipeResponse> {
  const client = getMealplanningClient();
  return promisifyUnary<CreateRecipeRequest, CreateRecipeResponse>(client.createRecipe.bind(client))(
    request,
    authMetadata(oauth2Token),
  );
}
...
export async function searchForRecipes(
  ...
  const client = getMealplanningClient();
  return promisifyUnary<SearchForRecipesRequest, SearchForRecipesResponse>(client.searchForRecipes.bind(client))(
    { ...request, filter: request.filter ?? defaultSearchFilter },
    authMetadata(oauth2Token),
  );
}
...
export async function trackEvent(event: string, properties: Record<string, string> = {}): Promise<void> {
  ...
  await promisifyUnary(client.trackEvent.bind(client))({ source: 'web', event, properties }, emptyMetadata);
}
...
export async function trackAnonymousEvent(
  ...
  const client = getAnalyticsClient();
  await promisifyUnary(client.trackAnonymousEvent.bind(client))(
