...
func TestV1Client_BuildGetRecipeStepProductRequest(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedID := uint64(1)
		actual, err := c.BuildGetRecipeStepProductRequest(ctx, expectedID)
...
func TestV1Client_GetRecipeStepProduct(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		ts := httptest.NewTLSServer(
			http.HandlerFunc(
				func(res http.ResponseWriter, req *http.Request) {
					...
					assert.Equal(t, req.URL.Path, fmt.Sprintf("/api/v1/recipe_step_products/%d", expected.ID), "expected and actual path don't match")
		...
		c := buildTestClient(t, ts)
		actual, err := c.GetRecipeStepProduct(ctx, expected.ID)
...
func TestV1Client_BuildGetRecipeStepProductsRequest(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		c := buildTestClient(t, ts)
		actual, err := c.BuildGetRecipeStepProductsRequest(ctx, nil)
...
func TestV1Client_GetRecipeStepProducts(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		ts := httptest.NewTLSServer(
			http.HandlerFunc(
				func(res http.ResponseWriter, req *http.Request) {
					assert.Equal(t, req.URL.Path, "/api/v1/recipe_step_products", "expected and actual path don't match")
					assert.Equal(t, req.Method, http.MethodGet)
					require.NoError(t, json.NewEncoder(res).Encode(expected))
				},
			),
		...
		c := buildTestClient(t, ts)
		actual, err := c.GetRecipeStepProducts(ctx, nil)
...
func TestV1Client_BuildCreateRecipeStepProductRequest(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		c := buildTestClient(t, ts)
		actual, err := c.BuildCreateRecipeStepProductRequest(ctx, exampleInput)
...
func TestV1Client_BuildUpdateRecipeStepProductRequest(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		ts := httptest.NewTLSServer(nil)
		c := buildTestClient(t, ts)
		actual, err := c.BuildUpdateRecipeStepProductRequest(ctx, exampleInput)
		...
		ts := httptest.NewTLSServer(
			http.HandlerFunc(
				func(res http.ResponseWriter, req *http.Request) {
					...
					assert.NoError(t, json.NewEncoder(res).Encode(&models.RecipeStepProduct{}))
				},
			),
		)

		err := buildTestClient(t, ts).UpdateRecipeStepProduct(ctx, expected)
		assert.NoError(t, err, "no error should be returned")
	})
}
...
func TestV1Client_BuildArchiveRecipeStepProductRequest(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		expectedID := uint64(1)
		c := buildTestClient(t, ts)
		actual, err := c.BuildArchiveRecipeStepProductRequest(ctx, expectedID)
...
func TestV1Client_ArchiveRecipeStepProduct(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		ts := httptest.NewTLSServer(
			http.HandlerFunc(
				func(res http.ResponseWriter, req *http.Request) {
					assert.Equal(t, req.URL.Path, fmt.Sprintf("/api/v1/recipe_step_products/%d", expected), "expected and actual path don't match")
		...
		err := buildTestClient(t, ts).ArchiveRecipeStepProduct(ctx, expected)
		assert.NoError(t, err, "no error should be returned")
	})
}
