...
const (
	// ValidPreparationInstrumentDataType indicates an event is related to a valid ingredient preparation.
	ValidPreparationInstrumentDataType dataType = "valid_preparation_instrument"

	// ValidPreparationInstrumentCreatedCustomerEventType indicates a valid ingredient preparation was created.
	ValidPreparationInstrumentCreatedCustomerEventType CustomerEventType = "valid_preparation_instrument_created"
	// ValidPreparationInstrumentUpdatedCustomerEventType indicates a valid ingredient preparation was updated.
	ValidPreparationInstrumentUpdatedCustomerEventType CustomerEventType = "valid_preparation_instrument_updated"
	// ValidPreparationInstrumentArchivedCustomerEventType indicates a valid ingredient preparation was archived.
...
type (
	// ValidPreparationInstrument represents a valid ingredient preparation.
	ValidPreparationInstrument struct {
		...
		ValidInstrumentID  string  `json:"validIngredientID"`
		ID                 string  `json:"id"`
		CreatedOn          uint64  `json:"createdOn"`
	}

	// ValidPreparationInstrumentList represents a list of valid ingredient preparations.
	...
	// ValidPreparationInstrumentCreationRequestInput represents what a user could set as input for creating valid ingredient preparations.
	...
	// ValidPreparationInstrumentDatabaseCreationInput represents what a user could set as input for creating valid ingredient preparations.
	...
	// ValidPreparationInstrumentUpdateRequestInput represents what a user could set as input for updating valid ingredient preparations.
	...
	// ValidPreparationInstrumentDataManager describes a structure capable of storing valid ingredient preparations permanently.
	...
	// ValidPreparationInstrumentDataService describes a structure capable of serving traffic related to valid ingredient preparations.
...
// Update merges an ValidPreparationInstrumentUpdateRequestInput with a valid ingredient preparation.
