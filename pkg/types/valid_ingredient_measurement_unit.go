...
const (
	// ValidIngredientMeasurementUnitDataType indicates an event is related to a valid ingredient measurement_unit.
	ValidIngredientMeasurementUnitDataType dataType = "valid_ingredient_measurement_unit"

	// ValidIngredientMeasurementUnitCreatedCustomerEventType indicates a valid ingredient measurement_unit was created.
	ValidIngredientMeasurementUnitCreatedCustomerEventType CustomerEventType = "valid_ingredient_measurement_unit_created"
	// ValidIngredientMeasurementUnitUpdatedCustomerEventType indicates a valid ingredient measurement_unit was updated.
	ValidIngredientMeasurementUnitUpdatedCustomerEventType CustomerEventType = "valid_ingredient_measurement_unit_updated"
	// ValidIngredientMeasurementUnitArchivedCustomerEventType indicates a valid ingredient measurement_unit was archived.
