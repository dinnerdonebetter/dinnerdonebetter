...
// GetTotalRecipeStepIngredientCount is a mock function.
func (m *RecipeStepIngredientDataManager) GetTotalRecipeStepIngredientCount(ctx context.Context) (uint64, error) {
	args := m.Called(ctx)
...
func (m *RecipeStepIngredientDataManager) GetRecipeStepIngredientsWithIDs(ctx context.Context, recipeStepID string, limit uint8, ids []string) ([]*types.RecipeStepIngredient, error) {
