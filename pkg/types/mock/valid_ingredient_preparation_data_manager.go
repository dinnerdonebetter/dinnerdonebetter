...
// GetTotalValidIngredientPreparationCount is a mock function.
func (m *ValidIngredientPreparationDataManager) GetTotalValidIngredientPreparationCount(ctx context.Context) (uint64, error) {
	args := m.Called(ctx)
