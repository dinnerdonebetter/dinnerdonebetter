...
func TestBuilder_BuildGetServiceSettingConfigurationRequest(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		spec := newRequestSpec(true, http.MethodGet, "", expectedPathFormat, exampleServiceSettingConfiguration.ID)

		actual, err := helper.builder.BuildGetServiceSettingConfigurationRequest(helper.ctx, exampleServiceSettingConfiguration.ID)
	...
	T.Run("with invalid service setting ID", func(t *testing.T) {
		...
		actual, err := helper.builder.BuildGetServiceSettingConfigurationRequest(helper.ctx, "")
		assert.Nil(t, actual)
		assert.Error(t, err)
	})
