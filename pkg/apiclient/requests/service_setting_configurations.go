...
// BuildGetServiceSettingConfigurationRequest builds an HTTP request for fetching a service setting.
func (b *Builder) BuildGetServiceSettingConfigurationRequest(ctx context.Context, serviceSettingConfigurationID string) (*http.Request, error) {
