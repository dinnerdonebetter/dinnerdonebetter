...
// GetServiceSettingConfiguration gets a service setting.
func (c *Client) GetServiceSettingConfiguration(ctx context.Context, serviceSettingConfigurationID string) (*types.ServiceSettingConfiguration, error) {
	...
	req, err := c.requestBuilder.BuildGetServiceSettingConfigurationRequest(ctx, serviceSettingConfigurationID)
	if err != nil {
