...
func TestBuilder_BuildGetRecipeStepInstrumentRequest(T *testing.T) {
	...
	const expectedPathFormat = "/api/v1/recipes/%s/recipe_steps/%s/recipe_step_instruments/%s"
...
func TestBuilder_BuildGetRecipeStepInstrumentsRequest(T *testing.T) {
	...
	const expectedPathFormat = "/api/v1/recipes/%s/recipe_steps/%s/recipe_step_instruments"
...
func TestBuilder_BuildCreateRecipeStepInstrumentRequest(T *testing.T) {
	...
	const expectedPath = "/api/v1/recipes/%s/recipe_steps/%s/recipe_step_instruments"
	...
	T.Run("standard", func(t *testing.T) {
		...
		actual, err := helper.builder.BuildCreateRecipeStepInstrumentRequest(helper.ctx, exampleRecipeID, exampleInput)
		assert.NoError(t, err)
	...
	T.Run("with invalid recipe ID", func(t *testing.T) {
		...
		actual, err := helper.builder.BuildCreateRecipeStepInstrumentRequest(helper.ctx, "", exampleInput)
		assert.Nil(t, actual)
		assert.Error(t, err)
	})
	...
	T.Run("with nil input", func(t *testing.T) {
		...
		actual, err := helper.builder.BuildCreateRecipeStepInstrumentRequest(helper.ctx, exampleRecipeID, nil)
		assert.Nil(t, actual)
		assert.Error(t, err)
	})
	...
	T.Run("with invalid input", func(t *testing.T) {
		...
		actual, err := helper.builder.BuildCreateRecipeStepInstrumentRequest(helper.ctx, exampleRecipeID, &types.RecipeStepInstrumentCreationRequestInput{})
		assert.Nil(t, actual)
		assert.Error(t, err)
	})
