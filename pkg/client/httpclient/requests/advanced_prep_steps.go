...
// BuildMarkAdvancedPrepStepAsCompleteRequest builds an HTTP request for archiving a meal plan.
func (b *Builder) BuildMarkAdvancedPrepStepAsCompleteRequest(ctx context.Context, advancedPrepStepID string) (*http.Request, error) {
	ctx, span := b.tracer.StartSpan(ctx)
	defer span.End()
