...
func (c *Client) GetRecipeStepInstrument(ctx context.Context, recipeID, recipeStepID, recipeStepInstrumentID string) (*types.RecipeStepInstrument, error) {
	...
	if err != nil {
		return nil, observability.PrepareError(err, logger, span, "building get recipe step instrument request")
	}

	var recipeStepInstrument *types.RecipeStepInstrument
	if err = c.fetchAndUnmarshal(ctx, req, &recipeStepInstrument); err != nil {
		return nil, observability.PrepareError(err, logger, span, "retrieving recipe step instrument")
	}
...
func (c *Client) GetRecipeStepInstruments(ctx context.Context, recipeID, recipeStepID string, filter *types.QueryFilter) (*types.RecipeStepInstrumentList, error) {
	...
	if err != nil {
		return nil, observability.PrepareError(err, logger, span, "building recipe step instruments list request")
	}

	var recipeStepInstruments *types.RecipeStepInstrumentList
	if err = c.fetchAndUnmarshal(ctx, req, &recipeStepInstruments); err != nil {
		return nil, observability.PrepareError(err, logger, span, "retrieving recipe step instruments")
	}
...
func (c *Client) UpdateRecipeStepInstrument(ctx context.Context, recipeID string, recipeStepInstrument *types.RecipeStepInstrument) error {
	...
	if err != nil {
		return observability.PrepareError(err, logger, span, "building update recipe step instrument request")
	}

	if err = c.fetchAndUnmarshal(ctx, req, &recipeStepInstrument); err != nil {
		return observability.PrepareError(err, logger, span, "updating recipe step instrument %s", recipeStepInstrument.ID)
	}
...
func (c *Client) ArchiveRecipeStepInstrument(ctx context.Context, recipeID, recipeStepID, recipeStepInstrumentID string) error {
	...
	if err != nil {
		return observability.PrepareError(err, logger, span, "building archive recipe step instrument request")
	}

	if err = c.fetchAndUnmarshal(ctx, req, nil); err != nil {
		return observability.PrepareError(err, logger, span, "archiving recipe step instrument %s", recipeStepInstrumentID)
	}
