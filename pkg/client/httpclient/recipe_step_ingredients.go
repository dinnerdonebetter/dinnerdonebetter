...
func (c *Client) GetRecipeStepIngredient(ctx context.Context, recipeID, recipeStepID, recipeStepIngredientID string) (*types.RecipeStepIngredient, error) {
	...
	if err != nil {
		return nil, observability.PrepareError(err, span, "building get recipe step ingredient request")
	}

	var recipeStepIngredient *types.RecipeStepIngredient
	if err = c.fetchAndUnmarshal(ctx, req, &recipeStepIngredient); err != nil {
		return nil, observability.PrepareError(err, span, "retrieving recipe step ingredient")
	}
...
func (c *Client) GetRecipeStepIngredients(ctx context.Context, recipeID, recipeStepID string, filter *types.QueryFilter) (*types.RecipeStepIngredientList, error) {
	...
	if err != nil {
		return nil, observability.PrepareError(err, span, "building recipe step ingredients list request")
	}

	var recipeStepIngredients *types.RecipeStepIngredientList
	if err = c.fetchAndUnmarshal(ctx, req, &recipeStepIngredients); err != nil {
		return nil, observability.PrepareError(err, span, "retrieving recipe step ingredients")
	}
...
func (c *Client) CreateRecipeStepIngredient(ctx context.Context, recipeID string, input *types.RecipeStepIngredientCreationRequestInput) (*types.RecipeStepIngredient, error) {
	...
	if err != nil {
		return nil, observability.PrepareError(err, span, "building create recipe step ingredient request")
	}

	var recipeStepIngredient *types.RecipeStepIngredient
	if err = c.fetchAndUnmarshal(ctx, req, &recipeStepIngredient); err != nil {
		return nil, observability.PrepareError(err, span, "creating recipe step ingredient")
	}
...
func (c *Client) UpdateRecipeStepIngredient(ctx context.Context, recipeID string, recipeStepIngredient *types.RecipeStepIngredient) error {
	...
	if err != nil {
		return observability.PrepareError(err, span, "building update recipe step ingredient request")
	}

	if err = c.fetchAndUnmarshal(ctx, req, &recipeStepIngredient); err != nil {
		return observability.PrepareError(err, span, "updating recipe step ingredient %s", recipeStepIngredient.ID)
	}
...
func (c *Client) ArchiveRecipeStepIngredient(ctx context.Context, recipeID, recipeStepID, recipeStepIngredientID string) error {
	...
	if err != nil {
		return observability.PrepareError(err, span, "building archive recipe step ingredient request")
	}

	if err = c.fetchAndUnmarshal(ctx, req, nil); err != nil {
		return observability.PrepareError(err, span, "archiving recipe step ingredient %s", recipeStepIngredientID)
	}
