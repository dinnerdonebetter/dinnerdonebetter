...
func (c *Client) GetValidMeasurementUnit(ctx context.Context, validMeasurementUnitID string) (*types.ValidMeasurementUnit, error) {
	...
	if err != nil {
		return nil, observability.PrepareError(err, logger, span, "building get valid measurement unit request")
	}

	var validMeasurementUnit *types.ValidMeasurementUnit
	if err = c.fetchAndUnmarshal(ctx, req, &validMeasurementUnit); err != nil {
		return nil, observability.PrepareError(err, logger, span, "retrieving valid measurement unit")
	}
...
func (c *Client) SearchValidMeasurementUnits(ctx context.Context, query string, limit uint8) ([]*types.ValidMeasurementUnit, error) {
	...
	if err != nil {
		return nil, observability.PrepareError(err, logger, span, "building search for valid measurement units request")
	}

	var validMeasurementUnits []*types.ValidMeasurementUnit
	if err = c.fetchAndUnmarshal(ctx, req, &validMeasurementUnits); err != nil {
		return nil, observability.PrepareError(err, logger, span, "retrieving valid measurement units")
	}
...
func (c *Client) GetValidMeasurementUnits(ctx context.Context, filter *types.QueryFilter) (*types.ValidMeasurementUnitList, error) {
	...
	if err != nil {
		return nil, observability.PrepareError(err, logger, span, "building valid measurement units list request")
	}
...
func (c *Client) CreateValidMeasurementUnit(ctx context.Context, input *types.ValidMeasurementUnitCreationRequestInput) (*types.ValidMeasurementUnit, error) {
	...
	if err != nil {
		return nil, observability.PrepareError(err, logger, span, "building create valid measurement unit request")
	}

	var validMeasurementUnit *types.ValidMeasurementUnit
	if err = c.fetchAndUnmarshal(ctx, req, &validMeasurementUnit); err != nil {
		return nil, observability.PrepareError(err, logger, span, "creating valid measurement unit")
	}
...
func (c *Client) UpdateValidMeasurementUnit(ctx context.Context, validMeasurementUnit *types.ValidMeasurementUnit) error {
	...
	if err != nil {
		return observability.PrepareError(err, logger, span, "building update valid measurement unit request")
	}

	if err = c.fetchAndUnmarshal(ctx, req, &validMeasurementUnit); err != nil {
		return observability.PrepareError(err, logger, span, "updating valid measurement unit %s", validMeasurementUnit.ID)
	}
...
func (c *Client) ArchiveValidMeasurementUnit(ctx context.Context, validMeasurementUnitID string) error {
	...
	if err != nil {
		return observability.PrepareError(err, logger, span, "building archive valid measurement unit request")
	}

	if err = c.fetchAndUnmarshal(ctx, req, nil); err != nil {
		return observability.PrepareError(err, logger, span, "archiving valid measurement unit %s", validMeasurementUnitID)
	}
