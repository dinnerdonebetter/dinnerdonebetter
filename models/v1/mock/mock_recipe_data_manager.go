...
func (m *RecipeDataManager) GetAllRecipes(ctx context.Context, results chan []models.Recipe) error {
...
func (m *RecipeDataManager) GetRecipesWithIDs(ctx context.Context, limit uint8, ids []uint64) ([]models.Recipe, error) {
