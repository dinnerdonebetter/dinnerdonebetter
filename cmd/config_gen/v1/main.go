...
func developmentConfig(path string) error {
	...
	cfg.Set(validIngredientSearchIndexPath, "/etc/prixfixe/valid_ingredients_index.bleve")
	cfg.Set(validPreparationSearchIndexPath, "/etc/prixfixe/valid_preparations_index.bleve")
