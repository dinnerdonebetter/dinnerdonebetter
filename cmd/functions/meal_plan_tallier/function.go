package mealplantallierfunction
...
func init() {
	...
	functions.CloudEvent("TallyMealPlan", TallyMealPlan)
}

// TallyMealPlan is our cloud function entrypoint.
func TallyMealPlan(ctx context.Context, _ event.Event) error {
	...
	mealPlanTallier := workers.ProvideMealPlanTallyingWorker(
		logger,
		dataManager,
	...
	if err = mealPlanTallier.TallyMealPlanVotes(ctx, nil); err != nil {
