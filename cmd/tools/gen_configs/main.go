...
var files = map[string]configFunc{
	...
	"environments/local/config_files/meal-plan-tallier-config.json":                  localDevelopmentWorkerConfig,
	"environments/local/config_files/meal-plan-tally-scheduler-config.json":          localDevelopmentWorkerConfig,
