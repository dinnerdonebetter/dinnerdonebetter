...
func buildTestService() *Service {
	return &Service{
		...
		recipeTagCounter:     &mockmetrics.UnitCounter{},
		...
		recipeTagIDFetcher:   func(req *http.Request) uint64 { return 0 },
...
func TestProvideRecipeTagsService(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		s, err := ProvideRecipeTagsService(
