...
// CreationInputMiddleware is a middleware for fetching, parsing, and attaching an ValidIngredientPreparationInput struct from a request.
func (s *Service) CreationInputMiddleware(next http.Handler) http.Handler {
	return http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
		x := new(models.ValidIngredientPreparationCreationInput)
...
// UpdateInputMiddleware is a middleware for fetching, parsing, and attaching an ValidIngredientPreparationInput struct from a request.
...
func (s *Service) UpdateInputMiddleware(next http.Handler) http.Handler {
	return http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
		x := new(models.ValidIngredientPreparationUpdateInput)
