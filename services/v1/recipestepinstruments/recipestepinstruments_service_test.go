...
func buildTestService() *Service {
	return &Service{
		...
		recipeStepInstrumentDatabase:  &mockmodels.RecipeStepInstrumentDataManager{},
...
func TestProvideRecipeStepInstrumentsService(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		idm := &mockmodels.RecipeStepInstrumentDataManager{}
		idm.On("GetAllRecipeStepInstrumentsCount", mock.Anything).Return(expectation, nil)
	...
	T.Run("with error fetching recipe step instrument count", func(t *testing.T) {
		expectation := uint64(123)
		uc := &mockmetrics.UnitCounter{}
		uc.On("IncrementBy", expectation).Return()
		...
		idm := &mockmodels.RecipeStepInstrumentDataManager{}
		idm.On("GetAllRecipeStepInstrumentsCount", mock.Anything).Return(expectation, errors.New("blah"))
