...
func buildTestService() *Service {
	return &Service{
		...
		recipeStepProductDatabase:  &mockmodels.RecipeStepProductDataManager{},
...
func TestProvideRecipeStepProductsService(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		idm := &mockmodels.RecipeStepProductDataManager{}
		idm.On("GetAllRecipeStepProductsCount", mock.Anything).Return(expectation, nil)

		s, err := ProvideRecipeStepProductsService(
			context.Background(),
	...
	T.Run("with error fetching recipe step product count", func(t *testing.T) {
		expectation := uint64(123)
		uc := &mockmetrics.UnitCounter{}
		uc.On("IncrementBy", expectation).Return()
		...
		idm := &mockmodels.RecipeStepProductDataManager{}
		idm.On("GetAllRecipeStepProductsCount", mock.Anything).Return(expectation, errors.New("blah"))
