...
// CreationInputMiddleware is a middleware for fetching, parsing, and attaching an ValidPreparationInput struct from a request.
func (s *Service) CreationInputMiddleware(next http.Handler) http.Handler {
	return http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
		x := new(models.ValidPreparationCreationInput)
...
// UpdateInputMiddleware is a middleware for fetching, parsing, and attaching an ValidPreparationInput struct from a request.
...
func (s *Service) UpdateInputMiddleware(next http.Handler) http.Handler {
	return http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
		x := new(models.ValidPreparationUpdateInput)
