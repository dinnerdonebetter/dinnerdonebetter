...
func TestRequiredPreparationInstrumentsService_ListHandler(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager.On("GetRequiredPreparationInstruments", mock.Anything, mock.AnythingOfType("*models.QueryFilter")).Return(exampleRequiredPreparationInstrumentList, nil)
	...
	T.Run("with no rows returned", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("GetRequiredPreparationInstruments", mock.Anything, mock.AnythingOfType("*models.QueryFilter")).Return((*models.RequiredPreparationInstrumentList)(nil), sql.ErrNoRows)
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
	...
	T.Run("with error fetching required preparation instruments from database", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("GetRequiredPreparationInstruments", mock.Anything, mock.AnythingOfType("*models.QueryFilter")).Return((*models.RequiredPreparationInstrumentList)(nil), errors.New("blah"))
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
...
func TestRequiredPreparationInstrumentsService_CreateHandler(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		mock.AssertExpectationsForObjects(t, requiredPreparationInstrumentDataManager, mc, r, ed)
	})
	...
	T.Run("with error creating required preparation instrument", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("CreateRequiredPreparationInstrument", mock.Anything, mock.AnythingOfType("*models.RequiredPreparationInstrumentCreationInput")).Return((*models.RequiredPreparationInstrument)(nil), errors.New("blah"))
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
...
func TestRequiredPreparationInstrumentsService_ExistenceHandler(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("RequiredPreparationInstrumentExists", mock.Anything, exampleRequiredPreparationInstrument.ID).Return(true, nil)
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
	...
	T.Run("with no such required preparation instrument in database", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("RequiredPreparationInstrumentExists", mock.Anything, exampleRequiredPreparationInstrument.ID).Return(false, sql.ErrNoRows)
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
	...
	T.Run("with error fetching required preparation instrument from database", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("RequiredPreparationInstrumentExists", mock.Anything, exampleRequiredPreparationInstrument.ID).Return(false, errors.New("blah"))
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
...
func TestRequiredPreparationInstrumentsService_ReadHandler(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("GetRequiredPreparationInstrument", mock.Anything, exampleRequiredPreparationInstrument.ID).Return(exampleRequiredPreparationInstrument, nil)
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
	...
	T.Run("with no such required preparation instrument in database", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("GetRequiredPreparationInstrument", mock.Anything, exampleRequiredPreparationInstrument.ID).Return((*models.RequiredPreparationInstrument)(nil), sql.ErrNoRows)
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
	...
	T.Run("with error fetching required preparation instrument from database", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("GetRequiredPreparationInstrument", mock.Anything, exampleRequiredPreparationInstrument.ID).Return((*models.RequiredPreparationInstrument)(nil), errors.New("blah"))
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
...
func TestRequiredPreparationInstrumentsService_ArchiveHandler(T *testing.T) {
	...
	T.Run("happy path", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("ArchiveRequiredPreparationInstrument", mock.Anything, exampleRequiredPreparationInstrument.ID).Return(nil)
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
		...
		mock.AssertExpectationsForObjects(t, requiredPreparationInstrumentDataManager, mc, r)
	})
	...
	T.Run("with no required preparation instrument in database", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("ArchiveRequiredPreparationInstrument", mock.Anything, exampleRequiredPreparationInstrument.ID).Return(sql.ErrNoRows)
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
	...
	T.Run("with error writing to database", func(t *testing.T) {
		...
		requiredPreparationInstrumentDataManager := &mockmodels.RequiredPreparationInstrumentDataManager{}
		requiredPreparationInstrumentDataManager.On("ArchiveRequiredPreparationInstrument", mock.Anything, exampleRequiredPreparationInstrument.ID).Return(errors.New("blah"))
		s.requiredPreparationInstrumentDataManager = requiredPreparationInstrumentDataManager
