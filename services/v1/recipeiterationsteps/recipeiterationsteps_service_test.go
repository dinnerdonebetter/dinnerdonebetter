...
func buildTestService() *Service {
	return &Service{
		...
		recipeIterationStepCounter:     &mockmetrics.UnitCounter{},
		...
		recipeIterationStepIDFetcher:   func(req *http.Request) uint64 { return 0 },
...
func TestProvideRecipeIterationStepsService(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		s, err := ProvideRecipeIterationStepsService(
