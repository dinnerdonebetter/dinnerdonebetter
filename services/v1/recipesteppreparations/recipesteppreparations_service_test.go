...
func buildTestService() *Service {
	return &Service{
		...
		recipeStepPreparationCounter:     &mockmetrics.UnitCounter{},
		...
		recipeStepPreparationIDFetcher:   func(req *http.Request) uint64 { return 0 },
...
func TestProvideRecipeStepPreparationsService(T *testing.T) {
	T.Parallel()
	...
	T.Run("happy path", func(t *testing.T) {
		...
		s, err := ProvideRecipeStepPreparationsService(
