...
func (s *Server) handleLoginSubmission(res http.ResponseWriter, req *http.Request) (gomponents.Node, error) {
...
func (s *Server) renderLoginPage(_ http.ResponseWriter, req *http.Request) (gomponents.Node, error) {
	ctx, span := s.tracer.StartSpan(req.Context())
	defer span.End()
...
func (s *Server) renderUsersPage(_ http.ResponseWriter, req *http.Request) (gomponents.Node, error) {
	ctx, span := s.tracer.StartSpan(req.Context())
	defer span.End()
...
func (s *Server) renderValidIngredientsPage(_ http.ResponseWriter, req *http.Request) (gomponents.Node, error) {
	ctx, span := s.tracer.StartSpan(req.Context())
	defer span.End()
...
func (s *Server) renderValidIngredientCreationForm(_ http.ResponseWriter, req *http.Request) (gomponents.Node, error) {
	ctx, span := s.tracer.StartSpan(req.Context())
	defer span.End()
...
func (s *Server) handleValidIngredientSubmission(res http.ResponseWriter, req *http.Request) (gomponents.Node, error) {
	ctx, span := s.tracer.StartSpan(req.Context())
	defer span.End()
