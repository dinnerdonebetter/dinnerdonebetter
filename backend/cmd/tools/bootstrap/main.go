...
func runBootstrap(
	...
	if _, err = client.WriteDB().ExecContext(ctx, "INSERT INTO user_role_assignments (id, user_id, role_id) VALUES ($1, $2, 'role_service_admin')", identifiers.New(), user.ID); err != nil {
