...
var routeInfoMap = map[string]routeDetails{
	...
	"DELETE /api/v1/data_privacy/destroy": {
		...
		OAuth2Scopes: []string{accountMember},
	},
	...
	"GET /api/v1/audit_log_entries/for_account": {
		ID:           "GetAuditLogEntriesForAccount",
		Description:  "Retrieves audit log entries for a account",
		ResponseType: []*types.AuditLogEntry{},
		ListRoute:    true,
		OAuth2Scopes: []string{accountAdmin},
	},
	...
	"GET /api/v1/account_invitations/received": {
		ID:           "GetReceivedAccountInvitations",
		Description:  "Fetches received account invitations",
		ResponseType: &types.AccountInvitation{},
		ListRoute:    true,
		OAuth2Scopes: []string{accountMember},
	},
	"GET /api/v1/account_invitations/sent": {
		ID:           "GetSentAccountInvitations",
		Description:  "Fetches sent account invitations",
		ResponseType: &types.AccountInvitation{},
		ListRoute:    true,
		OAuth2Scopes: []string{accountMember},
	},
	"GET /api/v1/account_invitations/{accountInvitationID}/": {
		ID:           "GetAccountInvitation",
		Description:  "Fetches account invitations for a given account",
		ResponseType: &types.AccountInvitation{},
		OAuth2Scopes: []string{accountMember},
	},
	"PUT /api/v1/account_invitations/{accountInvitationID}/accept": {
		ID:           "AcceptAccountInvitation",
		Description:  "Accepts a received account invitation",
		ResponseType: &types.AccountInvitation{},
		InputType:    &types.AccountInvitationUpdateRequestInput{},
		OAuth2Scopes: []string{accountMember},
	},
	"PUT /api/v1/account_invitations/{accountInvitationID}/cancel": {
		ID:           "CancelAccountInvitation",
		Description:  "Cancels a sent account invitation",
		ResponseType: &types.AccountInvitation{},
		InputType:    &types.AccountInvitationUpdateRequestInput{},
		OAuth2Scopes: []string{accountMember},
	},
	"PUT /api/v1/account_invitations/{accountInvitationID}/reject": {
		ID:           "RejectAccountInvitation",
		Description:  "Rejects a received account invitation",
		ResponseType: &types.AccountInvitation{},
		InputType:    &types.AccountInvitationUpdateRequestInput{},
		OAuth2Scopes: []string{accountMember},
	},
	...
	"POST /api/v1/accounts/": {
		...
		ResponseType: &types.Account{},
		InputType:    &types.AccountCreationRequestInput{},
		OAuth2Scopes: []string{accountMember},
	},
	"GET /api/v1/accounts/current": {
		ID:           "GetActiveAccount",
		Description:  "Fetches the currently active account",
		ResponseType: &types.Account{},
		OAuth2Scopes: []string{accountMember},
	},
	"POST /api/v1/accounts/instruments/": {
		ID:           "CreateAccountInstrumentOwnership",
		Description:  "Creates a account instrument ownership",
		ResponseType: &types.AccountInstrumentOwnership{},
		InputType:    &types.AccountInstrumentOwnershipCreationRequestInput{},
		OAuth2Scopes: []string{accountAdmin},
	},
	"GET /api/v1/accounts/instruments/": {
		ID:           "GetAccountInstrumentOwnerships",
		Description:  "creates a account instrument",
		ResponseType: &types.AccountInstrumentOwnership{},
		OAuth2Scopes: []string{accountMember},
		ListRoute:    true,
	},
	"GET /api/v1/accounts/instruments/{accountInstrumentOwnershipID}/": {
		ID:           "GetAccountInstrumentOwnership",
		Description:  "Fetches a account instrument ownership",
		ResponseType: &types.AccountInstrumentOwnership{},
		OAuth2Scopes: []string{accountMember},
	},
	"PUT /api/v1/accounts/instruments/{accountInstrumentOwnershipID}/": {
		ID:           "UpdateAccountInstrumentOwnership",
		Description:  "Updates a account instrument ownership",
		ResponseType: &types.AccountInstrumentOwnership{},
		InputType:    &types.AccountInstrumentOwnershipUpdateRequestInput{},
		OAuth2Scopes: []string{accountAdmin},
	},
	"DELETE /api/v1/accounts/instruments/{accountInstrumentOwnershipID}/": {
		ID:           "ArchiveAccountInstrumentOwnership",
		Description:  "Archives a account instrument ownership",
		ResponseType: &types.AccountInstrumentOwnership{},
		OAuth2Scopes: []string{accountAdmin},
	},
	"PUT /api/v1/accounts/{accountID}/": {
		...
		ResponseType: &types.Account{},
		InputType:    &types.AccountUpdateRequestInput{},
		OAuth2Scopes: []string{accountAdmin},
	},
	"DELETE /api/v1/accounts/{accountID}/": {
		ID:           "ArchiveAccount",
		Description:  "Archives a account",
		ResponseType: &types.Account{},
		OAuth2Scopes: []string{accountAdmin},
	},
	"GET /api/v1/accounts/{accountID}/": {
		ID:           "GetAccount",
		Description:  "Fetches a account",
		ResponseType: &types.Account{},
		OAuth2Scopes: []string{accountMember},
	},
	"POST /api/v1/accounts/{accountID}/default": {
		ID:           "SetDefaultAccount",
		Description:  "Updates the default account assigned at login",
		ResponseType: &types.Account{},
		OAuth2Scopes: []string{accountMember},
	},
	"GET /api/v1/accounts/{accountID}/invitations/{accountInvitationID}/": {
		ID:           "GetAccountInvitationByID",
		Description:  "Fetches a account invitation by its ID",
		ResponseType: &types.AccountInvitation{},
		OAuth2Scopes: []string{accountMember},
	},
	// these are duplicate routes lol
	"POST /api/v1/accounts/{accountID}/invite": {
		ID:           "CreateAccountInvitation",
		Description:  "Create a account invitation",
		ResponseType: &types.AccountInvitation{},
		InputType:    &types.AccountInvitationCreationRequestInput{},
		OAuth2Scopes: []string{accountAdmin},
	},
	"DELETE /api/v1/accounts/{accountID}/members/{userID}": {
		ID:           "ArchiveUserMembership",
		Description:  "Archive a account user membership",
		ResponseType: &types.AccountUserMembership{},
		OAuth2Scopes: []string{accountAdmin},
	},
	"PATCH /api/v1/accounts/{accountID}/members/{userID}/permissions": {
		ID:           "UpdateAccountMemberPermissions",
		Description:  "Update a account member's account permissions",
	...
	"POST /api/v1/accounts/{accountID}/transfer": {
		ID:           "TransferAccountOwnership",
		Description:  "Transfer account ownership to another user",
		ResponseType: &types.Account{},
		InputType:    &types.AccountOwnershipTransferInput{},
		OAuth2Scopes: []string{accountAdmin},
	},
	...
	"GET /api/v1/settings/configurations/account": {
		ID:           "GetServiceSettingConfigurationsForAccount",
		Description:  "Fetches a ServiceSettingConfigurationsForAccount",
		ListRoute:    true,
		ResponseType: &types.ServiceSettingConfiguration{},
		OAuth2Scopes: []string{accountMember},
	},
