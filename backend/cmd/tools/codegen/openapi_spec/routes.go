...
var routeInfoMap = map[string]routeDetails{
	...
	"GET /api/v1/audit_log_entries/for_account": {
		...
		Description:  "Retrieves audit log entries for an account",
	...
	"POST /api/v1/accounts/instruments/": {
		...
		Description:  "Creates an account instrument ownership",
	...
	"GET /api/v1/accounts/instruments/": {
		...
		Description:  "creates an account instrument",
		ResponseType: &types.AccountInstrumentOwnership{},
		OAuth2Scopes: []string{accountMember},
		ListRoute:    true,
	},
	"GET /api/v1/accounts/instruments/{accountInstrumentOwnershipID}/": {
		...
		Description:  "Fetches an account instrument ownership",
		ResponseType: &types.AccountInstrumentOwnership{},
		OAuth2Scopes: []string{accountMember},
	},
	"PUT /api/v1/accounts/instruments/{accountInstrumentOwnershipID}/": {
		ID:           "UpdateAccountInstrumentOwnership",
		Description:  "Updates an account instrument ownership",
		ResponseType: &types.AccountInstrumentOwnership{},
	...
	"DELETE /api/v1/accounts/instruments/{accountInstrumentOwnershipID}/": {
		...
		Description:  "Archives an account instrument ownership",
		ResponseType: &types.AccountInstrumentOwnership{},
		OAuth2Scopes: []string{accountAdmin},
	},
	...
	"GET /api/v1/accounts/{accountID}/invitations/{accountInvitationID}/": {
		...
		Description:  "Fetches an account invitation by its ID",
		ResponseType: &types.AccountInvitation{},
		OAuth2Scopes: []string{accountMember},
	},
	...
	"POST /api/v1/accounts/{accountID}/invite": {
		...
		Description:  "Create an account invitation",
		ResponseType: &types.AccountInvitation{},
	...
	"DELETE /api/v1/accounts/{accountID}/members/{userID}": {
		...
		Description:  "Archive an account user membership",
	...
	"PATCH /api/v1/accounts/{accountID}/members/{userID}/permissions": {
		...
		Description:  "Update an account member's account permissions",
