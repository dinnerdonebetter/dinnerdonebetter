...
func main() {
	...
	queryOutput := map[string][]*Query{
		...
		"internal/repositories/postgres/mealplanning/sqlc_queries/meal_plan_recipe_option_selections.sql":           buildMealPlanRecipeOptionSelectionsQueries(databaseToUse),
