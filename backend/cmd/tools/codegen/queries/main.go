...
func main() {
	...
	queryOutput := map[string][]*Query{
		...
		"internal/database/postgres/sqlc_queries/accounts.sql":                                     buildAccountsQueries(databaseToUse),
		"internal/database/postgres/sqlc_queries/account_user_memberships.sql":                     buildAccountUserMembershipsQueries(databaseToUse),
		"internal/database/postgres/sqlc_queries/webhook_trigger_events.sql":                       buildWebhookTriggerEventsQueries(databaseToUse),
		"internal/database/postgres/sqlc_queries/password_reset_tokens.sql":                        buildPasswordResetTokensQueries(databaseToUse),
		...
		"internal/database/postgres/sqlc_queries/account_invitations.sql":                          buildAccountInvitationsQueries(databaseToUse),
		...
		"internal/database/postgres/sqlc_queries/audit_logs.sql":                                   buildAuditLogEntryQueries(databaseToUse),
