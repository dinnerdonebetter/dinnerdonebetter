...
func main() {
	...
	queryOutput := map[string][]*Query{
		"internal/platform/database/postgres/users/sqlc_queries/admin.sql":                          buildAdminQueries(databaseToUse),
		"internal/database/postgres/sqlc_queries/webhooks.sql":                                      buildWebhooksQueries(databaseToUse),
		"internal/platform/database/postgres/users/sqlc_queries/user_notifications.sql":             buildUserNotificationQueries(databaseToUse),
		"internal/platform/database/postgres/users/sqlc_queries/users.sql":                          buildUsersQueries(databaseToUse),
		"internal/platform/database/postgres/users/sqlc_queries/accounts.sql":                       buildAccountsQueries(databaseToUse),
		"internal/platform/database/postgres/users/sqlc_queries/account_user_memberships.sql":       buildAccountUserMembershipsQueries(databaseToUse),
		"internal/database/postgres/sqlc_queries/webhook_trigger_events.sql":                        buildWebhookTriggerEventsQueries(databaseToUse),
		"internal/platform/database/postgres/users/sqlc_queries/password_reset_tokens.sql":          buildPasswordResetTokensQueries(databaseToUse),
		...
		"internal/platform/database/postgres/users/sqlc_queries/service_settings.sql":               buildServiceSettingQueries(databaseToUse),
		"internal/platform/database/postgres/users/sqlc_queries/service_setting_configurations.sql": buildServiceSettingConfigurationQueries(databaseToUse),
		"internal/platform/database/postgres/users/sqlc_queries/account_invitations.sql":            buildAccountInvitationsQueries(databaseToUse),
		...
		"internal/platform/database/postgres/users/sqlc_queries/audit_logs.sql":                     buildAuditLogEntryQueries(databaseToUse),
