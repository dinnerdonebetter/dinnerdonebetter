...
var (
	...
	nonWebhookEventTypes = []string{
		...
		types.UserChangedActiveAccountServiceEventType,
		types.UserEmailAddressVerifiedEventType,
		types.UserEmailAddressVerificationEmailRequestedEventType,
		types.AccountMemberRemovedServiceEventType,
		types.AccountMembershipPermissionsUpdatedServiceEventType,
		types.AccountOwnershipTransferredServiceEventType,
