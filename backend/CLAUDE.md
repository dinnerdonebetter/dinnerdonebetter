...
The platform framework (database, cache, observability, messaging, uploads, search, encoding, etc.) is an external dependency at `github.com/verygoodsoftwarenotvirus/platform/v5`. Application code lives under `internal/`:
