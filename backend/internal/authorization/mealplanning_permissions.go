...
var (
	// MealPlanningServiceAdminPermissions contains meal-planning permissions for the service admin role.
	// Pass to RegisterServiceAdminPermissions in the domain registration module.
	MealPlanningServiceAdminPermissions = []Permission{
		UpdateRecipesStatusPermission,
		CreateMealPlanTasksPermission,
		CreateMealPlanGroceryListItemsPermission,
	}

	// MealPlanningServiceDataAdminPermissions contains meal-planning permissions for the service data admin role.
	// Pass to RegisterServiceDataAdminPermissions in the domain registration module.
	MealPlanningServiceDataAdminPermissions = []Permission{
	...
	// MealPlanningAccountAdminPermissions contains meal-planning permissions for the account admin role.
	// Pass to RegisterAccountAdminPermissions in the domain registration module.
	MealPlanningAccountAdminPermissions = []Permission{
	...
	// MealPlanningAccountMemberPermissions contains meal-planning permissions for the account member role.
	// Pass to RegisterAccountMemberPermissions in the domain registration module.
	MealPlanningAccountMemberPermissions = []Permission{
