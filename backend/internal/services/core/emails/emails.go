...
func BuildInviteMemberEmail(recipient *types.User, householdInvitation *types.HouseholdInvitation, envCfg *email.EnvironmentConfig) (*email.OutboundEmailMessage, error) {
	if envCfg == nil {
