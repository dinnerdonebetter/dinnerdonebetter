...
var _ oauth.OAuth2ClientDataService = (*service)(nil)
...
func (s *service) CreateOAuth2ClientHandler(res http.ResponseWriter, req *http.Request) {
	...
	input := new(oauth.OAuth2ClientCreationRequestInput)
	...
	resObj := &oauth.OAuth2ClientCreationResponse{
		ID:           client.ID,
		ClientID:     client.ClientID,
		ClientSecret: client.ClientSecret,
	}

	responseValue := &types.APIResponse[*oauth.OAuth2ClientCreationResponse]{
...
func (s *service) ReadOAuth2ClientHandler(res http.ResponseWriter, req *http.Request) {
	...
	responseValue := &types.APIResponse[*oauth.OAuth2Client]{
		Details: responseDetails,
		Data:    x,
	}
...
func (s *service) ListOAuth2ClientsHandler(res http.ResponseWriter, req *http.Request) {
	...
	if errors.Is(err, sql.ErrNoRows) {
		...
		oauth2Clients = &filtering.QueryFilteredResult[oauth.OAuth2Client]{
			Data: []*oauth.OAuth2Client{},
		}
	} else if err != nil {
