...
type validVesselsServiceHTTPRoutesTestHelper struct {
	...
	exampleUpdateInput   *types.ValidVesselUpdateRequestInput
}
...
func buildTestHelper(t *testing.T) *validVesselsServiceHTTPRoutesTestHelper {
	...
	helper.exampleCreationInput = converters.ConvertValidVesselToValidVesselCreationRequestInput(helper.exampleValidVessel)
	helper.exampleUpdateInput = converters.ConvertValidVesselToValidVesselUpdateRequestInput(helper.exampleValidVessel)
