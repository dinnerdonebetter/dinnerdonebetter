...
func (s *service) CreateRecipeStepVesselHandler(res http.ResponseWriter, req *http.Request) {
	...
	recipeStepVessel, err := s.recipeManagementDataManager.CreateRecipeStepVessel(ctx, input)
	if err != nil {
...
func (s *service) ReadRecipeStepVesselHandler(res http.ResponseWriter, req *http.Request) {
	...
	x, err := s.recipeManagementDataManager.GetRecipeStepVessel(ctx, recipeID, recipeStepID, recipeStepVesselID)
...
func (s *service) UpdateRecipeStepVesselHandler(res http.ResponseWriter, req *http.Request) {
	...
	// fetch recipe step vessel from database.
	readTimer := timing.NewMetric("database").WithDesc("fetch").Start()
	recipeStepVessel, err := s.recipeManagementDataManager.GetRecipeStepVessel(ctx, recipeID, recipeStepID, recipeStepVesselID)
	if errors.Is(err, sql.ErrNoRows) {
		errRes := types.NewAPIErrorResponse("not found", types.ErrDataNotFound, responseDetails)
		s.encoderDecoder.EncodeResponseWithStatus(ctx, res, errRes, http.StatusNotFound)
		return
	...
	if err = s.recipeManagementDataManager.UpdateRecipeStepVessel(ctx, recipeStepVessel); err != nil {
...
func (s *service) ArchiveRecipeStepVesselHandler(res http.ResponseWriter, req *http.Request) {
	...
	exists, err := s.recipeManagementDataManager.RecipeStepVesselExists(ctx, recipeID, recipeStepID, recipeStepVesselID)
	...
	if err = s.recipeManagementDataManager.ArchiveRecipeStepVessel(ctx, recipeStepID, recipeStepVesselID); err != nil {
