...
func ProvideService(
	...
	searchIndex, err := searchcfg.ProvideIndex[types.ValidMeasurementUnitSearchSubset](ctx, logger, tracerProvider, searchConfig, textsearch.IndexTypeValidMeasurementUnits)
	if err != nil {
