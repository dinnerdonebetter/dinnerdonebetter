...
import (
	...
	grpc17 "github.com/verygoodsoftwarenotvirus/platform/server/grpc"
...
func Build(ctx context.Context, cfg *config.APIServiceConfig) (*GRPCService, error) {
	...
	v4 := ProvideAnalyticsProxySources(cfg)
	multiSourceEventReporter, err := multisource.ProvideMultiSourceEventReporter(ctx, v4, logger, tracerProvider, provider)
	if err != nil {
		return nil, err
	}
