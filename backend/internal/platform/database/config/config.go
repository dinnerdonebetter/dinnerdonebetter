...
type (
	...
	Config struct {
		...
		ConnMaxLifetime              time.Duration        `env:"CONN_MAX_LIFETIME"                json:"connMaxLifetime"`
		MaxIdleConns                 uint16               `env:"MAX_IDLE_CONNS"                   json:"maxIdleConns"`
		MaxOpenConns                 uint16               `env:"MAX_OPEN_CONNS"                   json:"maxOpenConns"`
