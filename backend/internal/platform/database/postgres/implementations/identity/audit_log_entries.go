...
var (
	_ auth.AuditLogEntryDataManager = (*Querier)(nil)
)

// GetAuditLogEntry fetches an audit log entry from the database.
func (q *Querier) GetAuditLogEntry(ctx context.Context, auditLogEntryID string) (*auth.AuditLogEntry, error) {
	...
	auditLogEntry := &auth.AuditLogEntry{
...
func (q *Querier) GetAuditLogEntriesForUser(ctx context.Context, userID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[auth.AuditLogEntry], error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x := &filtering.QueryFilteredResult[auth.AuditLogEntry]{
...
func (q *Querier) GetAuditLogEntriesForUserAndResourceTypes(ctx context.Context, userID string, resourceTypes []string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[auth.AuditLogEntry], error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) GetAuditLogEntriesForAccount(ctx context.Context, accountID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[auth.AuditLogEntry], error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) GetAuditLogEntriesForAccountAndResourceTypes(ctx context.Context, accountID string, resourceTypes []string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[auth.AuditLogEntry], error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) createAuditLogEntry(ctx context.Context, querier database.SQLQueryExecutor, input *auth.AuditLogEntryDatabaseCreationInput) (*auth.AuditLogEntry, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
