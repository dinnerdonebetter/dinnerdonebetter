...
import (
	...
	"github.com/dinnerdonebetter/backend/internal/platform/database/postgres/implementations/notifications/generated"
...
func ProvideSettingsRepository(
	...
	auditLogEntryRepo auditlogentries.Repository,
	db *sql.DB) (notifications.Repository, error) {
