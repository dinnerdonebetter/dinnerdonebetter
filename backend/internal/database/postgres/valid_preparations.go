...
func (q *Querier) GetValidPreparation(ctx context.Context, validPreparationID string) (*types.ValidPreparation, error) {
	...
	validPreparation := &types.ValidPreparation{
		...
		MaximumInstrumentCount:      database.Uint16PointerFromNullInt32(result.MaximumInstrumentCount),
		ArchivedAt:                  database.TimePointerFromNullTime(result.ArchivedAt),
		MaximumIngredientCount:      database.Uint16PointerFromNullInt32(result.MaximumIngredientCount),
		LastUpdatedAt:               database.TimePointerFromNullTime(result.LastUpdatedAt),
		MaximumVesselCount:          database.Uint16PointerFromNullInt32(result.MaximumVesselCount),
		...
		Slug:                        result.Slug,
		MinimumIngredientCount:      uint16(result.MinimumIngredientCount),
		MinimumInstrumentCount:      uint16(result.MinimumInstrumentCount),
		MinimumVesselCount:          uint16(result.MinimumVesselCount),
...
func (q *Querier) CreateValidPreparation(ctx context.Context, input *types.ValidPreparationDatabaseCreationInput) (*types.ValidPreparation, error) {
	...
	if err := q.generatedQuerier.CreateValidPreparation(ctx, q.db, &generated.CreateValidPreparationParams{
		...
		MinimumIngredientCount:      int32(input.MinimumIngredientCount),
		MaximumIngredientCount:      database.NullInt32FromUint16Pointer(input.MaximumIngredientCount),
		MinimumInstrumentCount:      int32(input.MinimumInstrumentCount),
		MaximumInstrumentCount:      database.NullInt32FromUint16Pointer(input.MaximumInstrumentCount),
		...
		MinimumVesselCount:          int32(input.MinimumVesselCount),
		MaximumVesselCount:          database.NullInt32FromUint16Pointer(input.MaximumVesselCount),
...
func (q *Querier) UpdateValidPreparation(ctx context.Context, updated *types.ValidPreparation) error {
	...
	if _, err := q.generatedQuerier.UpdateValidPreparation(ctx, q.db, &generated.UpdateValidPreparationParams{
		...
		Slug:                        updated.Slug,
		MaximumIngredientCount:      database.NullInt32FromUint16Pointer(updated.MaximumIngredientCount),
		MaximumInstrumentCount:      database.NullInt32FromUint16Pointer(updated.MaximumInstrumentCount),
		MaximumVesselCount:          database.NullInt32FromUint16Pointer(updated.MaximumVesselCount),
		MinimumVesselCount:          int32(updated.MinimumVesselCount),
		MinimumIngredientCount:      int32(updated.MinimumIngredientCount),
		MinimumInstrumentCount:      int32(updated.MinimumInstrumentCount),
