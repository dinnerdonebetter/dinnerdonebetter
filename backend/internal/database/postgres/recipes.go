	...
	for _, result := range results {
		...
		x.Steps = append(x.Steps, &types.RecipeStep{
			...
			Preparation: types.ValidPreparation{
				...
				MaximumInstrumentCount:      database.Uint16PointerFromNullInt32(result.RecipeStepPreparationMaximumInstrumentCount),
				ArchivedAt:                  database.TimePointerFromNullTime(result.RecipeStepPreparationArchivedAt),
				MaximumIngredientCount:      database.Uint16PointerFromNullInt32(result.RecipeStepPreparationMaximumIngredientCount),
				LastUpdatedAt:               database.TimePointerFromNullTime(result.RecipeStepPreparationLastUpdatedAt),
				MaximumVesselCount:          database.Uint16PointerFromNullInt32(result.RecipeStepPreparationMaximumVesselCount),
				...
				MinimumIngredientCount:      uint16(result.RecipeStepPreparationMinimumIngredientCount),
				MinimumInstrumentCount:      uint16(result.RecipeStepPreparationMinimumInstrumentCount),
				MinimumVesselCount:          uint16(result.RecipeStepPreparationMinimumVesselCount),
