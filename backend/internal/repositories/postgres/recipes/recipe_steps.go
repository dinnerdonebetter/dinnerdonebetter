...
var (
	_ recipes.RecipeStepDataManager = (*Querier)(nil)
)
...
func (q *Querier) GetRecipeStep(ctx context.Context, recipeID, recipeStepID string) (*recipes.RecipeStep, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) getRecipeStepByID(ctx context.Context, querier database.SQLQueryExecutor, recipeStepID string) (*recipes.RecipeStep, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) GetRecipeSteps(ctx context.Context, recipeID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipes.RecipeStep], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x = &filtering.QueryFilteredResult[recipes.RecipeStep]{
...
func (q *Querier) createRecipeStep(ctx context.Context, db database.SQLQueryExecutor, input *recipes.RecipeStepDatabaseCreationInput) (*recipes.RecipeStep, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
// CreateRecipeStep creates a recipe step in the database.
func (q *Querier) CreateRecipeStep(ctx context.Context, input *recipes.RecipeStepDatabaseCreationInput) (*recipes.RecipeStep, error) {
	return q.createRecipeStep(ctx, q.db, input)
}

// UpdateRecipeStep updates a particular recipe step.
func (q *Querier) UpdateRecipeStep(ctx context.Context, updated *recipes.RecipeStep) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
