...
func createRecipeRatingForTest(t *testing.T, ctx context.Context, exampleRecipeRating *recipes.RecipeRating, dbc *Querier) *recipes.RecipeRating {
	t.Helper()
...
func TestQuerier_Integration_RecipeRatings(t *testing.T) {
	...
	createdRecipeRatings := []*recipes.RecipeRating{}
