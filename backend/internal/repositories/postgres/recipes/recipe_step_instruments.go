...
var (
	_ recipes.RecipeStepInstrumentDataManager = (*Querier)(nil)
)
...
func (q *Querier) GetRecipeStepInstrument(ctx context.Context, recipeID, recipeStepID, recipeStepInstrumentID string) (*recipes.RecipeStepInstrument, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	recipeStepInstrument := &recipes.RecipeStepInstrument{
...
func (q *Querier) GetRecipeStepInstruments(ctx context.Context, recipeID, recipeStepID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipes.RecipeStepInstrument], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x = &filtering.QueryFilteredResult[recipes.RecipeStepInstrument]{
...
func (q *Querier) getRecipeStepInstrumentsForRecipe(ctx context.Context, recipeID string) ([]*recipes.RecipeStepInstrument, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	recipeStepInstruments := []*recipes.RecipeStepInstrument{}
	for _, result := range results {
		recipeStepInstrument := &recipes.RecipeStepInstrument{
			CreatedAt:           result.CreatedAt,
			Instrument:          nil,
...
func (q *Querier) createRecipeStepInstrument(ctx context.Context, querier database.SQLQueryExecutor, input *recipes.RecipeStepInstrumentDatabaseCreationInput) (*recipes.RecipeStepInstrument, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x := &recipes.RecipeStepInstrument{
		ID:                  input.ID,
		Instrument:          nil,
...
// CreateRecipeStepInstrument creates a recipe step instrument in the database.
func (q *Querier) CreateRecipeStepInstrument(ctx context.Context, input *recipes.RecipeStepInstrumentDatabaseCreationInput) (*recipes.RecipeStepInstrument, error) {
	return q.createRecipeStepInstrument(ctx, q.db, input)
}

// UpdateRecipeStepInstrument updates a particular recipe step instrument.
func (q *Querier) UpdateRecipeStepInstrument(ctx context.Context, updated *recipes.RecipeStepInstrument) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
