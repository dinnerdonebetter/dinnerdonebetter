...
func TestQuerier_Integration_UserIngredientPreferences(t *testing.T) {
	...
	ingredient := recipeenums.CreateValidIngredientForTest(t, ctx, nil, dbc.recipeEnumsRepo)
	...
	// update
	ingredient2 := recipeenums.CreateValidIngredientForTest(t, ctx, nil, dbc.recipeEnumsRepo)
	...
	for i := 0; i < exampleQuantity; i++ {
		...
		ingredient3 := recipeenums.CreateValidIngredientForTest(t, ctx, nil, dbc.recipeEnumsRepo)
