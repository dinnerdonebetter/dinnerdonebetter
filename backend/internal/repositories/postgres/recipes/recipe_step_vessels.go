...
var (
	_ recipes.RecipeStepVesselDataManager = (*Querier)(nil)
)
...
func (q *Querier) GetRecipeStepVessel(ctx context.Context, recipeID, recipeStepID, recipeStepVesselID string) (*recipes.RecipeStepVessel, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	recipeStepVessel := &recipes.RecipeStepVessel{
...
func (q *Querier) GetRecipeStepVessels(ctx context.Context, recipeID, recipeStepID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipes.RecipeStepVessel], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x = &filtering.QueryFilteredResult[recipes.RecipeStepVessel]{
...
func (q *Querier) getRecipeStepVesselsForRecipe(ctx context.Context, recipeID string) ([]*recipes.RecipeStepVessel, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	recipeStepVessels := []*recipes.RecipeStepVessel{}
	for _, result := range results {
		recipeStepVessel := &recipes.RecipeStepVessel{
			CreatedAt: result.CreatedAt,
			Quantity: types.Uint16RangeWithOptionalMax{
...
func (q *Querier) createRecipeStepVessel(ctx context.Context, querier database.SQLQueryExecutor, input *recipes.RecipeStepVesselDatabaseCreationInput) (*recipes.RecipeStepVessel, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
// CreateRecipeStepVessel creates a recipe step vessel in the database.
func (q *Querier) CreateRecipeStepVessel(ctx context.Context, input *recipes.RecipeStepVesselDatabaseCreationInput) (*recipes.RecipeStepVessel, error) {
	return q.createRecipeStepVessel(ctx, q.db, input)
}

// UpdateRecipeStepVessel updates a particular recipe step vessel.
func (q *Querier) UpdateRecipeStepVessel(ctx context.Context, updated *recipes.RecipeStepVessel) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
