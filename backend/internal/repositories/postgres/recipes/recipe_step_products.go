...
var (
	_ recipes.RecipeStepProductDataManager = (*Querier)(nil)
)
...
func (q *Querier) RecipeStepProductExists(ctx context.Context, recipeID, recipeStepID, recipeStepProductID string) (exists bool, err error) {
	...
	result, err := q.generatedQuerier.CheckRecipeStepProductExistence(ctx, q.db, &generated2.CheckRecipeStepProductExistenceParams{
...
func (q *Querier) GetRecipeStepProduct(ctx context.Context, recipeID, recipeStepID, recipeStepProductID string) (*recipes.RecipeStepProduct, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	result, err := q.generatedQuerier.GetRecipeStepProduct(ctx, q.db, &generated2.GetRecipeStepProductParams{
		RecipeStepID:        recipeStepID,
		RecipeStepProductID: recipeStepProductID,
		RecipeID:            recipeID,
	})
	...
	recipeStepProduct := &recipes.RecipeStepProduct{
...
func (q *Querier) getRecipeStepProductsForRecipe(ctx context.Context, recipeID string) ([]*recipes.RecipeStepProduct, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	recipeStepProducts := []*recipes.RecipeStepProduct{}
...
func (q *Querier) GetRecipeStepProducts(ctx context.Context, recipeID, recipeStepID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipes.RecipeStepProduct], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x = &filtering.QueryFilteredResult[recipes.RecipeStepProduct]{
		Pagination: filter.ToPagination(),
	}

	results, err := q.generatedQuerier.GetRecipeStepProducts(ctx, q.db, &generated2.GetRecipeStepProductsParams{
		RecipeStepID:    recipeStepID,
		RecipeID:        recipeID,
...
func (q *Querier) createRecipeStepProduct(ctx context.Context, db database.SQLQueryExecutor, input *recipes.RecipeStepProductDatabaseCreationInput) (*recipes.RecipeStepProduct, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	if err := q.generatedQuerier.CreateRecipeStepProduct(ctx, db, &generated2.CreateRecipeStepProductParams{
		QuantityNotes:                      input.QuantityNotes,
		Name:                               input.Name,
		Type:                               generated2.RecipeStepProductType(input.Type),
...
// CreateRecipeStepProduct creates a recipe step product in the database.
func (q *Querier) CreateRecipeStepProduct(ctx context.Context, input *recipes.RecipeStepProductDatabaseCreationInput) (*recipes.RecipeStepProduct, error) {
	return q.createRecipeStepProduct(ctx, q.db, input)
}

// UpdateRecipeStepProduct updates a particular recipe step product.
func (q *Querier) UpdateRecipeStepProduct(ctx context.Context, updated *recipes.RecipeStepProduct) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	if _, err := q.generatedQuerier.UpdateRecipeStepProduct(ctx, q.db, &generated2.UpdateRecipeStepProductParams{
		Name:                               updated.Name,
		Type:                               generated2.RecipeStepProductType(updated.Type),
...
func (q *Querier) ArchiveRecipeStepProduct(ctx context.Context, recipeStepID, recipeStepProductID string) error {
	...
	if _, err := q.generatedQuerier.ArchiveRecipeStepProduct(ctx, q.db, &generated2.ArchiveRecipeStepProductParams{
