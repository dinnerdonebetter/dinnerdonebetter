...
var (
	_ recipeenums.ValidMeasurementUnitConversionDataManager = (*Querier)(nil)
)
...
func (q *Querier) GetValidMeasurementUnitConversion(ctx context.Context, validMeasurementUnitConversionID string) (*recipeenums.ValidMeasurementUnitConversion, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	validMeasurementUnitConversion := &recipeenums.ValidMeasurementUnitConversion{
		...
		From: recipeenums.ValidMeasurementUnit{
		...
		To: recipeenums.ValidMeasurementUnit{
	...
	if result.ValidIngredientID.Valid && result.ValidIngredientID.String != "" {
		validMeasurementUnitConversion.OnlyForIngredient = &recipeenums.ValidIngredient{
...
func (q *Querier) GetValidMeasurementUnitConversionsFromUnit(ctx context.Context, validMeasurementUnitID string) ([]*recipeenums.ValidMeasurementUnitConversion, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	validMeasurementUnitConversions := make([]*recipeenums.ValidMeasurementUnitConversion, len(results))
	for i, result := range results {
		r := result
		validMeasurementUnitConversions[i] = &recipeenums.ValidMeasurementUnitConversion{
			...
			OnlyForIngredient: &recipeenums.ValidIngredient{
...
func (q *Querier) GetValidMeasurementUnitConversionsToUnit(ctx context.Context, validMeasurementUnitID string) ([]*recipeenums.ValidMeasurementUnitConversion, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) CreateValidMeasurementUnitConversion(ctx context.Context, input *recipeenums.ValidMeasurementUnitConversionDatabaseCreationInput) (*recipeenums.ValidMeasurementUnitConversion, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x := &recipeenums.ValidMeasurementUnitConversion{
		ID:        input.ID,
		From:      recipeenums.ValidMeasurementUnit{ID: input.From},
		To:        recipeenums.ValidMeasurementUnit{ID: input.To},
...
func (q *Querier) UpdateValidMeasurementUnitConversion(ctx context.Context, updated *recipeenums.ValidMeasurementUnitConversion) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
