...
var (
	_ recipeenums.ValidPreparationDataManager = (*Querier)(nil)
)
...
func (q *Querier) GetValidPreparation(ctx context.Context, validPreparationID string) (*recipeenums.ValidPreparation, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	validPreparation := &recipeenums.ValidPreparation{
...
func (q *Querier) GetRandomValidPreparation(ctx context.Context) (*recipeenums.ValidPreparation, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) SearchForValidPreparations(ctx context.Context, query string) ([]*recipeenums.ValidPreparation, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x := []*recipeenums.ValidPreparation{}
	for _, result := range results {
		x = append(x, &recipeenums.ValidPreparation{
			CreatedAt:     result.CreatedAt,
			ArchivedAt:    database.TimePointerFromNullTime(result.ArchivedAt),
			LastUpdatedAt: database.TimePointerFromNullTime(result.LastUpdatedAt),
			IconPath:      result.IconPath,
...
func (q *Querier) GetValidPreparations(ctx context.Context, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidPreparation], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x = &filtering.QueryFilteredResult[recipeenums.ValidPreparation]{
	...
	for _, result := range results {
		...
		x.Data = append(x.Data, &recipeenums.ValidPreparation{
			CreatedAt: result.CreatedAt,
			IngredientCount: types.Uint16RangeWithOptionalMax{
				Max: database.Uint16PointerFromNullInt32(result.MaximumIngredientCount),
				Min: uint16(result.MinimumIngredientCount),
...
func (q *Querier) GetValidPreparationsWithIDs(ctx context.Context, ids []string) ([]*recipeenums.ValidPreparation, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	preparations := []*recipeenums.ValidPreparation{}
	for _, result := range results {
		preparations = append(preparations, &recipeenums.ValidPreparation{
			CreatedAt: result.CreatedAt,
			IngredientCount: types.Uint16RangeWithOptionalMax{
				Max: database.Uint16PointerFromNullInt32(result.MaximumIngredientCount),
				Min: uint16(result.MinimumIngredientCount),
...
func (q *Querier) CreateValidPreparation(ctx context.Context, input *recipeenums.ValidPreparationDatabaseCreationInput) (*recipeenums.ValidPreparation, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) UpdateValidPreparation(ctx context.Context, updated *recipeenums.ValidPreparation) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
