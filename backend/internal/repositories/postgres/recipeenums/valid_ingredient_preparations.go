...
var (
	_ recipeenums.ValidIngredientPreparationDataManager = (*Querier)(nil)
)
...
func (q *Querier) GetValidIngredientPreparation(ctx context.Context, validIngredientPreparationID string) (*recipeenums.ValidIngredientPreparation, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	validIngredientPreparation := &recipeenums.ValidIngredientPreparation{
...
func (q *Querier) GetValidIngredientPreparations(ctx context.Context, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidIngredientPreparation], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x = &filtering.QueryFilteredResult[recipeenums.ValidIngredientPreparation]{
	...
	for _, result := range results {
		x.Data = append(x.Data, &recipeenums.ValidIngredientPreparation{
			CreatedAt:     result.ValidIngredientPreparationCreatedAt,
			LastUpdatedAt: database.TimePointerFromNullTime(result.ValidIngredientPreparationLastUpdatedAt),
			ArchivedAt:    database.TimePointerFromNullTime(result.ValidIngredientPreparationArchivedAt),
			Notes:         result.ValidIngredientPreparationNotes,
...
func (q *Querier) GetValidIngredientPreparationsForPreparation(ctx context.Context, preparationID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidIngredientPreparation], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) GetValidIngredientPreparationsForIngredient(ctx context.Context, ingredientID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidIngredientPreparation], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) CreateValidIngredientPreparation(ctx context.Context, input *recipeenums.ValidIngredientPreparationDatabaseCreationInput) (*recipeenums.ValidIngredientPreparation, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x := &recipeenums.ValidIngredientPreparation{
		ID:          input.ID,
		Notes:       input.Notes,
		Preparation: recipeenums.ValidPreparation{ID: input.ValidPreparationID},
...
func (q *Querier) UpdateValidIngredientPreparation(ctx context.Context, updated *recipeenums.ValidIngredientPreparation) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
