...
var (
	_ recipeenums.ValidIngredientStateIngredientDataManager = (*Querier)(nil)
)
...
func (q *Querier) GetValidIngredientStateIngredient(ctx context.Context, validIngredientStateIngredientID string) (*recipeenums.ValidIngredientStateIngredient, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	validIngredientStateIngredient := &recipeenums.ValidIngredientStateIngredient{
...
func (q *Querier) GetValidIngredientStateIngredients(ctx context.Context, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidIngredientStateIngredient], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x = &filtering.QueryFilteredResult[recipeenums.ValidIngredientStateIngredient]{
...
func (q *Querier) GetValidIngredientStateIngredientsForIngredientState(ctx context.Context, ingredientStateID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidIngredientStateIngredient], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) GetValidIngredientStateIngredientsForIngredient(ctx context.Context, ingredientID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidIngredientStateIngredient], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) CreateValidIngredientStateIngredient(ctx context.Context, input *recipeenums.ValidIngredientStateIngredientDatabaseCreationInput) (*recipeenums.ValidIngredientStateIngredient, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x := &recipeenums.ValidIngredientStateIngredient{
		ID:              input.ID,
		Notes:           input.Notes,
		IngredientState: recipeenums.ValidIngredientState{ID: input.ValidIngredientStateID},
...
func (q *Querier) UpdateValidIngredientStateIngredient(ctx context.Context, updated *recipeenums.ValidIngredientStateIngredient) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
