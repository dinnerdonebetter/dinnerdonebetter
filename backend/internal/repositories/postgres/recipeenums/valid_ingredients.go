...
var (
	_ recipeenums.ValidIngredientDataManager = (*Querier)(nil)
)
...
func (q *Querier) GetValidIngredient(ctx context.Context, validIngredientID string) (*recipeenums.ValidIngredient, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) GetRandomValidIngredient(ctx context.Context) (*recipeenums.ValidIngredient, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) SearchForValidIngredients(ctx context.Context, query string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipeenums.ValidIngredient], error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x := &filtering.QueryFilteredResult[recipeenums.ValidIngredient]{
...
func (q *Querier) SearchForValidIngredientsForPreparation(ctx context.Context, preparationID, query string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidIngredient], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) GetValidIngredients(ctx context.Context, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidIngredient], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) GetValidIngredientsWithIDs(ctx context.Context, ids []string) ([]*recipeenums.ValidIngredient, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	var ingredients []*recipeenums.ValidIngredient
	for _, result := range results {
		validIngredient := &recipeenums.ValidIngredient{
			CreatedAt:     result.CreatedAt,
			LastUpdatedAt: database.TimePointerFromNullTime(result.LastUpdatedAt),
...
func (q *Querier) CreateValidIngredient(ctx context.Context, input *recipeenums.ValidIngredientDatabaseCreationInput) (*recipeenums.ValidIngredient, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) UpdateValidIngredient(ctx context.Context, updated *recipeenums.ValidIngredient) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
