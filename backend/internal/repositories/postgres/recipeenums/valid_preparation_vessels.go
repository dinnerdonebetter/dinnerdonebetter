...
var (
	_ recipeenums.ValidPreparationVesselDataManager = (*Querier)(nil)
)
...
func (q *Querier) GetValidPreparationVessel(ctx context.Context, validPreparationVesselID string) (*recipeenums.ValidPreparationVessel, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	validPreparationVessel := &recipeenums.ValidPreparationVessel{
		...
		Vessel: recipeenums.ValidVessel{
			...
			CapacityUnit: &recipeenums.ValidMeasurementUnit{
...
func (q *Querier) GetValidPreparationVessels(ctx context.Context, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidPreparationVessel], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x = &filtering.QueryFilteredResult[recipeenums.ValidPreparationVessel]{
...
func (q *Querier) GetValidPreparationVesselsForPreparation(ctx context.Context, preparationID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidPreparationVessel], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) GetValidPreparationVesselsForVessel(ctx context.Context, vesselID string, filter *filtering.QueryFilter) (x *filtering.QueryFilteredResult[recipeenums.ValidPreparationVessel], err error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
...
func (q *Querier) CreateValidPreparationVessel(ctx context.Context, input *recipeenums.ValidPreparationVesselDatabaseCreationInput) (*recipeenums.ValidPreparationVessel, error) {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
	...
	x := &recipeenums.ValidPreparationVessel{
		ID:          input.ID,
		Notes:       input.Notes,
		Preparation: recipeenums.ValidPreparation{ID: input.ValidPreparationID},
		Vessel:      recipeenums.ValidVessel{ID: input.ValidVesselID},
...
func (q *Querier) UpdateValidPreparationVessel(ctx context.Context, updated *recipeenums.ValidPreparationVessel) error {
	ctx, span := q.tracer.StartSpan(ctx)
	defer span.End()
