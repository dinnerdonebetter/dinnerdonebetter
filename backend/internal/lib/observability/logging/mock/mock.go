...
// SetRequestIDFunc implements the Logger interface.
...
// WithSpan implements the Logger interface.
...
func (l *Logger) WithContext(ctx context.Context) logging.Logger {
	return l.Called(ctx).Get(0).(logging.Logger)
}
