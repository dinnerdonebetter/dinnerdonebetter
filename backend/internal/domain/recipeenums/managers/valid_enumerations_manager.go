...
import (
	...
	recipeenums "github.com/dinnerdonebetter/backend/internal/domain/recipeenums"
...
type (
	ValidEnumerationsManager interface {
		SearchValidIngredientGroups(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientGroup, error)
		ListValidIngredientGroups(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientGroup, string, error)
		CreateValidIngredientGroup(ctx context.Context, input *recipeenums.ValidIngredientGroupCreationRequestInput) (*recipeenums.ValidIngredientGroup, error)
		ReadValidIngredientGroup(ctx context.Context, validIngredientGroupID string) (*recipeenums.ValidIngredientGroup, error)
		UpdateValidIngredientGroup(ctx context.Context, validIngredientGroupID string, input *recipeenums.ValidIngredientGroupUpdateRequestInput) (*recipeenums.ValidIngredientGroup, error)
		ArchiveValidIngredientGroup(ctx context.Context, validIngredientGroupID string) error

		ListValidIngredientMeasurementUnits(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientMeasurementUnit, string, error)
		CreateValidIngredientMeasurementUnit(ctx context.Context, input *recipeenums.ValidIngredientMeasurementUnitCreationRequestInput) (*recipeenums.ValidIngredientMeasurementUnit, error)
		ReadValidIngredientMeasurementUnit(ctx context.Context, validIngredientMeasurementUnitID string) (*recipeenums.ValidIngredientMeasurementUnit, error)
		UpdateValidIngredientMeasurementUnit(ctx context.Context, validIngredientMeasurementUnitID string, input *recipeenums.ValidIngredientMeasurementUnitUpdateRequestInput) (*recipeenums.ValidIngredientMeasurementUnit, error)
		ArchiveValidIngredientMeasurementUnit(ctx context.Context, validIngredientMeasurementUnitID string) error
		SearchValidIngredientMeasurementUnitsByIngredient(ctx context.Context, validIngredientID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientMeasurementUnit, error)
		SearchValidIngredientMeasurementUnitsByMeasurementUnit(ctx context.Context, validMeasurementUnitID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientMeasurementUnit, error)

		ListValidIngredientPreparations(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientPreparation, string, error)
		CreateValidIngredientPreparation(ctx context.Context, input *recipeenums.ValidIngredientPreparationCreationRequestInput) (*recipeenums.ValidIngredientPreparation, error)
		ReadValidIngredientPreparation(ctx context.Context, validIngredientPreparationID string) (*recipeenums.ValidIngredientPreparation, error)
		UpdateValidIngredientPreparation(ctx context.Context, validIngredientPreparationID string, input *recipeenums.ValidIngredientPreparationUpdateRequestInput) (*recipeenums.ValidIngredientPreparation, error)
		ArchiveValidIngredientPreparation(ctx context.Context, validIngredientPreparationID string) error
		SearchValidIngredientPreparationsByIngredient(ctx context.Context, ingredientID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientPreparation, error)
		SearchValidIngredientPreparationsByPreparation(ctx context.Context, preparationID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientPreparation, error)

		SearchValidIngredients(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredient, error)
		ListValidIngredients(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredient, string, error)
		CreateValidIngredient(ctx context.Context, input *recipeenums.ValidIngredientCreationRequestInput) (*recipeenums.ValidIngredient, error)
		ReadValidIngredient(ctx context.Context, validIngredientID string) (*recipeenums.ValidIngredient, error)
		RandomValidIngredient(ctx context.Context) (*recipeenums.ValidIngredient, error)
		UpdateValidIngredient(ctx context.Context, validIngredientID string, input *recipeenums.ValidIngredientUpdateRequestInput) (*recipeenums.ValidIngredient, error)
		ArchiveValidIngredient(ctx context.Context, validIngredientID string) error
		SearchValidIngredientsByPreparationAndIngredientName(ctx context.Context, preparationID, query string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredient, error)

		ListValidIngredientStateIngredients(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientStateIngredient, string, error)
		CreateValidIngredientStateIngredient(ctx context.Context, input *recipeenums.ValidIngredientStateIngredientCreationRequestInput) (*recipeenums.ValidIngredientStateIngredient, error)
		ReadValidIngredientStateIngredient(ctx context.Context, validIngredientStateIngredientID string) (*recipeenums.ValidIngredientStateIngredient, error)
		UpdateValidIngredientStateIngredient(ctx context.Context, validIngredientStateIngredientID string, input *recipeenums.ValidIngredientStateIngredientUpdateRequestInput) (*recipeenums.ValidIngredientStateIngredient, error)
		ArchiveValidIngredientStateIngredient(ctx context.Context, validIngredientStateIngredientID string) error
		SearchValidIngredientStateIngredientsByIngredient(ctx context.Context, validIngredientID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientStateIngredient, error)
		SearchValidIngredientStateIngredientsByIngredientState(ctx context.Context, validIngredientStateID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientStateIngredient, error)

		SearchValidIngredientStates(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientState, error)
		ListValidIngredientStates(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientState, string, error)
		CreateValidIngredientState(ctx context.Context, input *recipeenums.ValidIngredientStateCreationRequestInput) (*recipeenums.ValidIngredientState, error)
		ReadValidIngredientState(ctx context.Context, validIngredientStateID string) (*recipeenums.ValidIngredientState, error)
		UpdateValidIngredientState(ctx context.Context, validIngredientStateID string, input *recipeenums.ValidIngredientStateUpdateRequestInput) (*recipeenums.ValidIngredientState, error)
		ArchiveValidIngredientState(ctx context.Context, validIngredientStateID string) error

		SearchValidMeasurementUnits(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidMeasurementUnit, error)
		SearchValidMeasurementUnitsByIngredientID(ctx context.Context, validIngredientID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidMeasurementUnit, error)
		ListValidMeasurementUnits(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidMeasurementUnit, string, error)
		CreateValidMeasurementUnit(ctx context.Context, input *recipeenums.ValidMeasurementUnitCreationRequestInput) (*recipeenums.ValidMeasurementUnit, error)
		ReadValidMeasurementUnit(ctx context.Context, validMeasurementUnitID string) (*recipeenums.ValidMeasurementUnit, error)
		UpdateValidMeasurementUnit(ctx context.Context, validMeasurementUnitID string, input *recipeenums.ValidMeasurementUnitUpdateRequestInput) (*recipeenums.ValidMeasurementUnit, error)
		ArchiveValidMeasurementUnit(ctx context.Context, validMeasurementUnitID string) error

		SearchValidInstruments(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidInstrument, error)
		ListValidInstruments(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidInstrument, string, error)
		CreateValidInstrument(ctx context.Context, input *recipeenums.ValidInstrumentCreationRequestInput) (*recipeenums.ValidInstrument, error)
		ReadValidInstrument(ctx context.Context, validInstrumentID string) (*recipeenums.ValidInstrument, error)
		RandomValidInstrument(ctx context.Context) (*recipeenums.ValidInstrument, error)
		UpdateValidInstrument(ctx context.Context, validInstrumentID string, input *recipeenums.ValidInstrumentUpdateRequestInput) (*recipeenums.ValidInstrument, error)
		ArchiveValidInstrument(ctx context.Context, validInstrumentID string) error

		ValidMeasurementUnitConversionsFromMeasurementUnit(ctx context.Context, validMeasurementUnitID string) ([]*recipeenums.ValidMeasurementUnitConversion, error)
		ValidMeasurementUnitConversionsToMeasurementUnit(ctx context.Context, validMeasurementUnitID string) ([]*recipeenums.ValidMeasurementUnitConversion, error)
		CreateValidMeasurementUnitConversion(ctx context.Context, input *recipeenums.ValidMeasurementUnitConversionCreationRequestInput) (*recipeenums.ValidMeasurementUnitConversion, error)
		ReadValidMeasurementUnitConversion(ctx context.Context, validMeasurementUnitConversionID string) (*recipeenums.ValidMeasurementUnitConversion, error)
		UpdateValidMeasurementUnitConversion(ctx context.Context, validMeasurementUnitConversionID string, input *recipeenums.ValidMeasurementUnitConversionUpdateRequestInput) (*recipeenums.ValidMeasurementUnitConversion, error)
		ArchiveValidMeasurementUnitConversion(ctx context.Context, validMeasurementUnitConversionID string) error

		ListValidPreparationInstruments(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationInstrument, string, error)
		CreateValidPreparationInstrument(ctx context.Context, input *recipeenums.ValidPreparationInstrumentCreationRequestInput) (*recipeenums.ValidPreparationInstrument, error)
		ReadValidPreparationInstrument(ctx context.Context, validPreparationInstrumentID string) (*recipeenums.ValidPreparationInstrument, error)
		UpdateValidPreparationInstrument(ctx context.Context, validPreparationInstrumentID string, input *recipeenums.ValidPreparationInstrumentUpdateRequestInput) (*recipeenums.ValidPreparationInstrument, error)
		ArchiveValidPreparationInstrument(ctx context.Context, validPreparationInstrumentID string) error
		SearchValidPreparationInstrumentsByPreparation(ctx context.Context, validPreparationID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationInstrument, error)
		SearchValidPreparationInstrumentsByInstrument(ctx context.Context, validInstrumentID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationInstrument, error)

		SearchValidPreparations(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparation, error)
		ListValidPreparations(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparation, string, error)
		CreateValidPreparation(ctx context.Context, input *recipeenums.ValidPreparationCreationRequestInput) (*recipeenums.ValidPreparation, error)
		ReadValidPreparation(ctx context.Context, validPreparationID string) (*recipeenums.ValidPreparation, error)
		RandomValidPreparation(ctx context.Context) (*recipeenums.ValidPreparation, error)
		UpdateValidPreparation(ctx context.Context, validPreparationID string, input *recipeenums.ValidPreparationUpdateRequestInput) (*recipeenums.ValidPreparation, error)
		ArchiveValidPreparation(ctx context.Context, validPreparationID string) error

		ListValidPreparationVessels(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationVessel, string, error)
		CreateValidPreparationVessel(ctx context.Context, input *recipeenums.ValidPreparationVesselCreationRequestInput) (*recipeenums.ValidPreparationVessel, error)
		ReadValidPreparationVessel(ctx context.Context, validPreparationVesselID string) (*recipeenums.ValidPreparationVessel, error)
		UpdateValidPreparationVessel(ctx context.Context, validPreparationVesselID string, input *recipeenums.ValidPreparationVesselUpdateRequestInput) (*recipeenums.ValidPreparationVessel, error)
		ArchiveValidPreparationVessel(ctx context.Context, validPreparationVesselID string) error
		SearchValidPreparationVesselsByPreparation(ctx context.Context, validPreparationID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationVessel, error)
		SearchValidPreparationVesselsByVessel(ctx context.Context, validVesselID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationVessel, error)

		SearchValidVessels(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidVessel, error)
		ListValidVessels(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidVessel, string, error)
		CreateValidVessel(ctx context.Context, input *recipeenums.ValidVesselCreationRequestInput) (*recipeenums.ValidVessel, error)
		ReadValidVessel(ctx context.Context, validVesselID string) (*recipeenums.ValidVessel, error)
		RandomValidVessel(ctx context.Context) (*recipeenums.ValidVessel, error)
		UpdateValidVessel(ctx context.Context, validVesselID string, input *recipeenums.ValidVesselUpdateRequestInput) (*recipeenums.ValidVessel, error)
	...
	validEnumerationManager struct {
		...
		db                               recipeenums.ValidEnumerationDataManager
...
func (m *validEnumerationManager) SearchValidIngredientGroups(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientGroup, error) {
...
func (m *validEnumerationManager) ListValidIngredientGroups(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientGroup, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidIngredientGroup(ctx context.Context, input *recipeenums.ValidIngredientGroupCreationRequestInput) (*recipeenums.ValidIngredientGroup, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientGroupCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidIngredientGroup(ctx context.Context, validIngredientGroupID string) (*recipeenums.ValidIngredientGroup, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidIngredientGroup(ctx context.Context, validIngredientGroupID string, input *recipeenums.ValidIngredientGroupUpdateRequestInput) (*recipeenums.ValidIngredientGroup, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientGroupUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidIngredientGroup(ctx context.Context, validIngredientGroupID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientGroupArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ListValidIngredientMeasurementUnits(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientMeasurementUnit, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidIngredientMeasurementUnit(ctx context.Context, input *recipeenums.ValidIngredientMeasurementUnitCreationRequestInput) (*recipeenums.ValidIngredientMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientMeasurementUnitCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidIngredientMeasurementUnit(ctx context.Context, validIngredientMeasurementUnitID string) (*recipeenums.ValidIngredientMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidIngredientMeasurementUnit(ctx context.Context, validIngredientMeasurementUnitID string, input *recipeenums.ValidIngredientMeasurementUnitUpdateRequestInput) (*recipeenums.ValidIngredientMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientMeasurementUnitUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidIngredientMeasurementUnit(ctx context.Context, validIngredientMeasurementUnitID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientMeasurementUnitArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) SearchValidIngredientMeasurementUnitsByIngredient(ctx context.Context, validIngredientID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) SearchValidIngredientMeasurementUnitsByMeasurementUnit(ctx context.Context, validMeasurementUnitID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) ListValidIngredientPreparations(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientPreparation, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidIngredientPreparation(ctx context.Context, input *recipeenums.ValidIngredientPreparationCreationRequestInput) (*recipeenums.ValidIngredientPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientPreparationCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidIngredientPreparation(ctx context.Context, validIngredientPreparationID string) (*recipeenums.ValidIngredientPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidIngredientPreparation(ctx context.Context, validIngredientPreparationID string, input *recipeenums.ValidIngredientPreparationUpdateRequestInput) (*recipeenums.ValidIngredientPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientPreparationUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidIngredientPreparation(ctx context.Context, validIngredientPreparationID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientPreparationArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) SearchValidIngredientPreparationsByIngredient(ctx context.Context, ingredientID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) SearchValidIngredientPreparationsByPreparation(ctx context.Context, validPreparationID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) SearchValidIngredients(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	var (
		results []*recipeenums.ValidIngredient
	)
	if useDatabase {
...
func (m *validEnumerationManager) ListValidIngredients(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredient, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidIngredient(ctx context.Context, input *recipeenums.ValidIngredientCreationRequestInput) (*recipeenums.ValidIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidIngredient(ctx context.Context, validIngredientID string) (*recipeenums.ValidIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) RandomValidIngredient(ctx context.Context) (*recipeenums.ValidIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidIngredient(ctx context.Context, validIngredientID string, input *recipeenums.ValidIngredientUpdateRequestInput) (*recipeenums.ValidIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidIngredient(ctx context.Context, validIngredientID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) SearchValidIngredientsByPreparationAndIngredientName(ctx context.Context, validPreparationID, query string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) ListValidIngredientStateIngredients(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientStateIngredient, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidIngredientStateIngredient(ctx context.Context, input *recipeenums.ValidIngredientStateIngredientCreationRequestInput) (*recipeenums.ValidIngredientStateIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientStateIngredientCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidIngredientStateIngredient(ctx context.Context, validIngredientStateIngredientID string) (*recipeenums.ValidIngredientStateIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidIngredientStateIngredient(ctx context.Context, validIngredientStateIngredientID string, input *recipeenums.ValidIngredientStateIngredientUpdateRequestInput) (*recipeenums.ValidIngredientStateIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientStateIngredientUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidIngredientStateIngredient(ctx context.Context, validIngredientStateIngredientID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientStateIngredientArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) SearchValidIngredientStateIngredientsByIngredient(ctx context.Context, validIngredientID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientStateIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) SearchValidIngredientStateIngredientsByIngredientState(ctx context.Context, validIngredientStateID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientStateIngredient, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) SearchValidIngredientStates(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientState, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	var (
		results []*recipeenums.ValidIngredientState
		err     error
	)
	if useDatabase {
...
func (m *validEnumerationManager) ListValidIngredientStates(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidIngredientState, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidIngredientState(ctx context.Context, input *recipeenums.ValidIngredientStateCreationRequestInput) (*recipeenums.ValidIngredientState, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientStateCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidIngredientState(ctx context.Context, validIngredientStateID string) (*recipeenums.ValidIngredientState, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidIngredientState(ctx context.Context, validIngredientStateID string, input *recipeenums.ValidIngredientStateUpdateRequestInput) (*recipeenums.ValidIngredientState, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientStateUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidIngredientState(ctx context.Context, validIngredientStateID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidIngredientStateArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) SearchValidMeasurementUnits(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	var (
		results []*recipeenums.ValidMeasurementUnit
		err     error
	)
	if useDatabase {
...
func (m *validEnumerationManager) SearchValidMeasurementUnitsByIngredientID(ctx context.Context, validIngredientID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) ListValidMeasurementUnits(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidMeasurementUnit, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidMeasurementUnit(ctx context.Context, input *recipeenums.ValidMeasurementUnitCreationRequestInput) (*recipeenums.ValidMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidMeasurementUnitCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidMeasurementUnit(ctx context.Context, validMeasurementUnitID string) (*recipeenums.ValidMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidMeasurementUnit(ctx context.Context, validMeasurementUnitID string, input *recipeenums.ValidMeasurementUnitUpdateRequestInput) (*recipeenums.ValidMeasurementUnit, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidMeasurementUnitUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidMeasurementUnit(ctx context.Context, validMeasurementUnitID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidMeasurementUnitArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) SearchValidInstruments(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	var (
		results []*recipeenums.ValidInstrument
		err     error
	)
	if useDatabase {
...
func (m *validEnumerationManager) ListValidInstruments(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidInstrument, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidInstrument(ctx context.Context, input *recipeenums.ValidInstrumentCreationRequestInput) (*recipeenums.ValidInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidInstrumentCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidInstrument(ctx context.Context, validInstrumentID string) (*recipeenums.ValidInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) RandomValidInstrument(ctx context.Context) (*recipeenums.ValidInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidInstrument(ctx context.Context, validInstrumentID string, input *recipeenums.ValidInstrumentUpdateRequestInput) (*recipeenums.ValidInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidInstrumentUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidInstrument(ctx context.Context, validInstrumentID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidInstrumentArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ValidMeasurementUnitConversionsFromMeasurementUnit(ctx context.Context, validMeasurementUnitID string) ([]*recipeenums.ValidMeasurementUnitConversion, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) ValidMeasurementUnitConversionsToMeasurementUnit(ctx context.Context, validMeasurementUnitID string) ([]*recipeenums.ValidMeasurementUnitConversion, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidMeasurementUnitConversion(ctx context.Context, input *recipeenums.ValidMeasurementUnitConversionCreationRequestInput) (*recipeenums.ValidMeasurementUnitConversion, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidMeasurementUnitConversionCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidMeasurementUnitConversion(ctx context.Context, validMeasurementUnitConversionID string) (*recipeenums.ValidMeasurementUnitConversion, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidMeasurementUnitConversion(ctx context.Context, validMeasurementUnitConversionID string, input *recipeenums.ValidMeasurementUnitConversionUpdateRequestInput) (*recipeenums.ValidMeasurementUnitConversion, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidMeasurementUnitConversionUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidMeasurementUnitConversion(ctx context.Context, validMeasurementUnitConversionID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidMeasurementUnitConversionArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ListValidPreparationInstruments(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationInstrument, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidPreparationInstrument(ctx context.Context, input *recipeenums.ValidPreparationInstrumentCreationRequestInput) (*recipeenums.ValidPreparationInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidPreparationInstrumentCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidPreparationInstrument(ctx context.Context, validPreparationInstrumentID string) (*recipeenums.ValidPreparationInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidPreparationInstrument(ctx context.Context, validPreparationInstrumentID string, input *recipeenums.ValidPreparationInstrumentUpdateRequestInput) (*recipeenums.ValidPreparationInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidPreparationInstrumentUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidPreparationInstrument(ctx context.Context, validPreparationInstrumentID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidPreparationInstrumentArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) SearchValidPreparationInstrumentsByPreparation(ctx context.Context, validPreparationID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) SearchValidPreparationInstrumentsByInstrument(ctx context.Context, validInstrumentID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationInstrument, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) SearchValidPreparations(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	var (
		results []*recipeenums.ValidPreparation
		err     error
	)
	if useDatabase {
...
func (m *validEnumerationManager) ListValidPreparations(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparation, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidPreparation(ctx context.Context, input *recipeenums.ValidPreparationCreationRequestInput) (*recipeenums.ValidPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidPreparationCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidPreparation(ctx context.Context, validPreparationID string) (*recipeenums.ValidPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) RandomValidPreparation(ctx context.Context) (*recipeenums.ValidPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidPreparation(ctx context.Context, validPreparationID string, input *recipeenums.ValidPreparationUpdateRequestInput) (*recipeenums.ValidPreparation, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidPreparationUpdatedServiceEventType, map[string]any{keys.ValidPreparationIDKey: existingValidPreparation.ID}))
...
func (m *validEnumerationManager) ArchiveValidPreparation(ctx context.Context, validPreparationID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidPreparationArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ListValidPreparationVessels(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationVessel, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidPreparationVessel(ctx context.Context, input *recipeenums.ValidPreparationVesselCreationRequestInput) (*recipeenums.ValidPreparationVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidPreparationVesselCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidPreparationVessel(ctx context.Context, validPreparationVesselID string) (*recipeenums.ValidPreparationVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidPreparationVessel(ctx context.Context, validPreparationVesselID string, input *recipeenums.ValidPreparationVesselUpdateRequestInput) (*recipeenums.ValidPreparationVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidPreparationVesselUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidPreparationVessel(ctx context.Context, validPreparationVesselID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidPreparationVesselArchivedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) SearchValidPreparationVesselsByPreparation(ctx context.Context, validPreparationID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) SearchValidPreparationVesselsByVessel(ctx context.Context, validVesselID string, filter *filtering.QueryFilter) ([]*recipeenums.ValidPreparationVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) SearchValidVessels(ctx context.Context, query string, useDatabase bool, filter *filtering.QueryFilter) ([]*recipeenums.ValidVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	var (
		validVessels []*recipeenums.ValidVessel
		err          error
	)
	if useDatabase {
...
func (m *validEnumerationManager) ListValidVessels(ctx context.Context, filter *filtering.QueryFilter) ([]*recipeenums.ValidVessel, string, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) CreateValidVessel(ctx context.Context, input *recipeenums.ValidVesselCreationRequestInput) (*recipeenums.ValidVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidVesselCreatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ReadValidVessel(ctx context.Context, validVesselID string) (*recipeenums.ValidVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) RandomValidVessel(ctx context.Context) (*recipeenums.ValidVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
...
func (m *validEnumerationManager) UpdateValidVessel(ctx context.Context, validVesselID string, input *recipeenums.ValidVesselUpdateRequestInput) (*recipeenums.ValidVessel, error) {
	ctx, span := m.tracer.StartSpan(ctx)
	defer span.End()
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidVesselUpdatedServiceEventType, map[string]any{
...
func (m *validEnumerationManager) ArchiveValidVessel(ctx context.Context, validVesselID string) error {
	...
	m.dataChangesPublisher.PublishAsync(ctx, audit.BuildDataChangeMessageFromContext(ctx, logger, recipeenums.ValidVesselArchivedServiceEventType, map[string]any{
