...
func ConvertValidPreparationToValidPreparationUpdateRequestInput(input *recipeenums.ValidPreparation) *recipeenums.ValidPreparationUpdateRequestInput {
	x := &recipeenums.ValidPreparationUpdateRequestInput{
		Name:                  &input.Name,
...
func ConvertValidPreparationCreationRequestInputToValidPreparationDatabaseCreationInput(input *recipeenums.ValidPreparationCreationRequestInput) *recipeenums.ValidPreparationDatabaseCreationInput {
	x := &recipeenums.ValidPreparationDatabaseCreationInput{
		ID:                    identifiers.New(),
		Name:                  input.Name,
		Description:           input.Description,
		IconPath:              input.IconPath,
...
func ConvertValidPreparationToValidPreparationCreationRequestInput(validPreparation *recipeenums.ValidPreparation) *recipeenums.ValidPreparationCreationRequestInput {
	return &recipeenums.ValidPreparationCreationRequestInput{
...
func ConvertValidPreparationToValidPreparationDatabaseCreationInput(validPreparation *recipeenums.ValidPreparation) *recipeenums.ValidPreparationDatabaseCreationInput {
	return &recipeenums.ValidPreparationDatabaseCreationInput{
