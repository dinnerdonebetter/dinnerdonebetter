...
var _ recipes.Repository = (*Repository)(nil)
...
func (m *Repository) GetRecipe(ctx context.Context, recipeID string) (*recipes.Recipe, error) {
	returnValues := m.Called(ctx, recipeID)
	return returnValues.Get(0).(*recipes.Recipe), returnValues.Error(1)
}

// SearchForRecipes is a mock function.
func (m *Repository) SearchForRecipes(ctx context.Context, query string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.Recipe], error) {
	returnValues := m.Called(ctx, query, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.Recipe]), returnValues.Error(1)
}

// GetRecipes is a mock function.
func (m *Repository) GetRecipes(ctx context.Context, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.Recipe], error) {
	returnValues := m.Called(ctx, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.Recipe]), returnValues.Error(1)
}

// GetRecipesCreatedByUser is a mock function.
func (m *Repository) GetRecipesCreatedByUser(ctx context.Context, userID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.Recipe], error) {
	returnValues := m.Called(ctx, userID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.Recipe]), returnValues.Error(1)
}

// CreateRecipe is a mock function.
func (m *Repository) CreateRecipe(ctx context.Context, input *recipes.RecipeDatabaseCreationInput) (*recipes.Recipe, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.Recipe), returnValues.Error(1)
}

// UpdateRecipe is a mock function.
func (m *Repository) UpdateRecipe(ctx context.Context, updated *recipes.Recipe) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetRecipesWithIDs(ctx context.Context, ids []string) ([]*recipes.Recipe, error) {
	returnValues := m.Called(ctx, ids)
	return returnValues.Get(0).([]*recipes.Recipe), returnValues.Error(1)
}
...
func (m *Repository) GetRecipeStep(ctx context.Context, recipeID, recipeStepID string) (*recipes.RecipeStep, error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID)
	return returnValues.Get(0).(*recipes.RecipeStep), returnValues.Error(1)
}

// GetRecipeSteps is a mock function.
func (m *Repository) GetRecipeSteps(ctx context.Context, recipeID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.RecipeStep], error) {
	returnValues := m.Called(ctx, recipeID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.RecipeStep]), returnValues.Error(1)
}

// CreateRecipeStep is a mock function.
func (m *Repository) CreateRecipeStep(ctx context.Context, input *recipes.RecipeStepDatabaseCreationInput) (*recipes.RecipeStep, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.RecipeStep), returnValues.Error(1)
}

// UpdateRecipeStep is a mock function.
func (m *Repository) UpdateRecipeStep(ctx context.Context, updated *recipes.RecipeStep) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetRecipeStepProduct(ctx context.Context, recipeID, recipeStepID, recipeStepProductID string) (*recipes.RecipeStepProduct, error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, recipeStepProductID)
	return returnValues.Get(0).(*recipes.RecipeStepProduct), returnValues.Error(1)
}

// GetRecipeStepProducts is a mock function.
func (m *Repository) GetRecipeStepProducts(ctx context.Context, recipeID, recipeStepID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.RecipeStepProduct], error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.RecipeStepProduct]), returnValues.Error(1)
}

// CreateRecipeStepProduct is a mock function.
func (m *Repository) CreateRecipeStepProduct(ctx context.Context, input *recipes.RecipeStepProductDatabaseCreationInput) (*recipes.RecipeStepProduct, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.RecipeStepProduct), returnValues.Error(1)
}

// UpdateRecipeStepProduct is a mock function.
func (m *Repository) UpdateRecipeStepProduct(ctx context.Context, updated *recipes.RecipeStepProduct) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetRecipeStepInstrument(ctx context.Context, recipeID, recipeStepID, recipeStepInstrumentID string) (*recipes.RecipeStepInstrument, error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, recipeStepInstrumentID)
	return returnValues.Get(0).(*recipes.RecipeStepInstrument), returnValues.Error(1)
}

// GetRecipeStepInstruments is a mock function.
func (m *Repository) GetRecipeStepInstruments(ctx context.Context, recipeID, recipeStepID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.RecipeStepInstrument], error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.RecipeStepInstrument]), returnValues.Error(1)
}

// CreateRecipeStepInstrument is a mock function.
func (m *Repository) CreateRecipeStepInstrument(ctx context.Context, input *recipes.RecipeStepInstrumentDatabaseCreationInput) (*recipes.RecipeStepInstrument, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.RecipeStepInstrument), returnValues.Error(1)
}

// UpdateRecipeStepInstrument is a mock function.
func (m *Repository) UpdateRecipeStepInstrument(ctx context.Context, updated *recipes.RecipeStepInstrument) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetRecipeStepIngredient(ctx context.Context, recipeID, recipeStepID, recipeStepIngredientID string) (*recipes.RecipeStepIngredient, error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, recipeStepIngredientID)
	return returnValues.Get(0).(*recipes.RecipeStepIngredient), returnValues.Error(1)
}

// GetRecipeStepIngredients is a mock function.
func (m *Repository) GetRecipeStepIngredients(ctx context.Context, recipeID, recipeStepID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.RecipeStepIngredient], error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.RecipeStepIngredient]), returnValues.Error(1)
}

// CreateRecipeStepIngredient is a mock function.
func (m *Repository) CreateRecipeStepIngredient(ctx context.Context, input *recipes.RecipeStepIngredientDatabaseCreationInput) (*recipes.RecipeStepIngredient, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.RecipeStepIngredient), returnValues.Error(1)
}

// UpdateRecipeStepIngredient is a mock function.
func (m *Repository) UpdateRecipeStepIngredient(ctx context.Context, updated *recipes.RecipeStepIngredient) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetRecipePrepTask(ctx context.Context, recipeID, recipePrepTaskID string) (*recipes.RecipePrepTask, error) {
	returnValues := m.Called(ctx, recipeID, recipePrepTaskID)

	return returnValues.Get(0).(*recipes.RecipePrepTask), returnValues.Error(1)
}

// GetRecipePrepTasksForRecipe implements the requisite interface.
func (m *Repository) GetRecipePrepTasksForRecipe(ctx context.Context, recipeID string) ([]*recipes.RecipePrepTask, error) {
	returnValues := m.Called(ctx, recipeID)
...
func (m *Repository) CreateRecipePrepTask(ctx context.Context, input *recipes.RecipePrepTaskDatabaseCreationInput) (*recipes.RecipePrepTask, error) {
	returnValues := m.Called(ctx, input)
...
func (m *Repository) UpdateRecipePrepTask(ctx context.Context, updated *recipes.RecipePrepTask) error {
...
func (m *Repository) GetRecipeMedia(ctx context.Context, recipeMediaID string) (*recipes.RecipeMedia, error) {
	returnValues := m.Called(ctx, recipeMediaID)
	return returnValues.Get(0).(*recipes.RecipeMedia), returnValues.Error(1)
}

// CreateRecipeMedia is a mock function.
func (m *Repository) CreateRecipeMedia(ctx context.Context, input *recipes.RecipeMediaDatabaseCreationInput) (*recipes.RecipeMedia, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.RecipeMedia), returnValues.Error(1)
}

// UpdateRecipeMedia is a mock function.
func (m *Repository) UpdateRecipeMedia(ctx context.Context, updated *recipes.RecipeMedia) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetRecipeStepCompletionCondition(ctx context.Context, recipeID, recipeStepID, recipeStepIngredientID string) (*recipes.RecipeStepCompletionCondition, error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, recipeStepIngredientID)
	return returnValues.Get(0).(*recipes.RecipeStepCompletionCondition), returnValues.Error(1)
}

// GetRecipeStepCompletionConditions is a mock function.
func (m *Repository) GetRecipeStepCompletionConditions(ctx context.Context, recipeID, recipeStepID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.RecipeStepCompletionCondition], error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.RecipeStepCompletionCondition]), returnValues.Error(1)
}

// CreateRecipeStepCompletionCondition is a mock function.
func (m *Repository) CreateRecipeStepCompletionCondition(ctx context.Context, input *recipes.RecipeStepCompletionConditionDatabaseCreationInput) (*recipes.RecipeStepCompletionCondition, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.RecipeStepCompletionCondition), returnValues.Error(1)
}

// UpdateRecipeStepCompletionCondition is a mock function.
func (m *Repository) UpdateRecipeStepCompletionCondition(ctx context.Context, updated *recipes.RecipeStepCompletionCondition) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetRecipeStepVessel(ctx context.Context, recipeID, recipeStepID, recipeStepVesselID string) (*recipes.RecipeStepVessel, error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, recipeStepVesselID)
	return returnValues.Get(0).(*recipes.RecipeStepVessel), returnValues.Error(1)
}

// GetRecipeStepVessels is a mock function.
func (m *Repository) GetRecipeStepVessels(ctx context.Context, recipeID, recipeStepID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.RecipeStepVessel], error) {
	returnValues := m.Called(ctx, recipeID, recipeStepID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.RecipeStepVessel]), returnValues.Error(1)
}

// CreateRecipeStepVessel is a mock function.
func (m *Repository) CreateRecipeStepVessel(ctx context.Context, input *recipes.RecipeStepVesselDatabaseCreationInput) (*recipes.RecipeStepVessel, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.RecipeStepVessel), returnValues.Error(1)
}

// UpdateRecipeStepVessel is a mock function.
func (m *Repository) UpdateRecipeStepVessel(ctx context.Context, updated *recipes.RecipeStepVessel) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetUserIngredientPreference(ctx context.Context, userUserIngredientPreferenceID, userID string) (*recipes.UserIngredientPreference, error) {
	returnValues := m.Called(ctx, userUserIngredientPreferenceID, userID)
	return returnValues.Get(0).(*recipes.UserIngredientPreference), returnValues.Error(1)
}

// GetUserIngredientPreferences is a mock function.
func (m *Repository) GetUserIngredientPreferences(ctx context.Context, userID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.UserIngredientPreference], error) {
	returnValues := m.Called(ctx, userID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.UserIngredientPreference]), returnValues.Error(1)
}

// CreateUserIngredientPreference is a mock function.
func (m *Repository) CreateUserIngredientPreference(ctx context.Context, input *recipes.UserIngredientPreferenceDatabaseCreationInput) ([]*recipes.UserIngredientPreference, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).([]*recipes.UserIngredientPreference), returnValues.Error(1)
}

// UpdateUserIngredientPreference is a mock function.
func (m *Repository) UpdateUserIngredientPreference(ctx context.Context, updated *recipes.UserIngredientPreference) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetAccountInstrumentOwnership(ctx context.Context, accountInstrumentOwnershipID, accountID string) (*recipes.AccountInstrumentOwnership, error) {
	returnValues := m.Called(ctx, accountInstrumentOwnershipID, accountID)
	return returnValues.Get(0).(*recipes.AccountInstrumentOwnership), returnValues.Error(1)
}

// GetAccountInstrumentOwnerships is a mock function.
func (m *Repository) GetAccountInstrumentOwnerships(ctx context.Context, accountID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.AccountInstrumentOwnership], error) {
	returnValues := m.Called(ctx, accountID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.AccountInstrumentOwnership]), returnValues.Error(1)
}

// CreateAccountInstrumentOwnership is a mock function.
func (m *Repository) CreateAccountInstrumentOwnership(ctx context.Context, input *recipes.AccountInstrumentOwnershipDatabaseCreationInput) (*recipes.AccountInstrumentOwnership, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.AccountInstrumentOwnership), returnValues.Error(1)
}

// UpdateAccountInstrumentOwnership is a mock function.
func (m *Repository) UpdateAccountInstrumentOwnership(ctx context.Context, updated *recipes.AccountInstrumentOwnership) error {
	return m.Called(ctx, updated).Error(0)
}
...
func (m *Repository) GetRecipeRating(ctx context.Context, recipeID, recipeRatingID string) (*recipes.RecipeRating, error) {
	returnValues := m.Called(ctx, recipeID, recipeRatingID)
	return returnValues.Get(0).(*recipes.RecipeRating), returnValues.Error(1)
}

// GetRecipeRatingsForRecipe is a mock function.
func (m *Repository) GetRecipeRatingsForRecipe(ctx context.Context, recipeID string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.RecipeRating], error) {
	returnValues := m.Called(ctx, recipeID, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.RecipeRating]), returnValues.Error(1)
}

// GetRecipeRatingsForUser is a mock function.
func (m *Repository) GetRecipeRatingsForUser(ctx context.Context, user string, filter *filtering.QueryFilter) (*filtering.QueryFilteredResult[recipes.RecipeRating], error) {
	returnValues := m.Called(ctx, user, filter)
	return returnValues.Get(0).(*filtering.QueryFilteredResult[recipes.RecipeRating]), returnValues.Error(1)
}

// CreateRecipeRating is a mock function.
func (m *Repository) CreateRecipeRating(ctx context.Context, input *recipes.RecipeRatingDatabaseCreationInput) (*recipes.RecipeRating, error) {
	returnValues := m.Called(ctx, input)
	return returnValues.Get(0).(*recipes.RecipeRating), returnValues.Error(1)
}

// UpdateRecipeRating is a mock function.
func (m *Repository) UpdateRecipeRating(ctx context.Context, updated *recipes.RecipeRating) error {
	return m.Called(ctx, updated).Error(0)
}
