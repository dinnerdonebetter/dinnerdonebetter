...
func ConvertRecipeToRecipeUpdateRequestInput(input *recipes.Recipe) *recipes.RecipeUpdateRequestInput {
	x := &recipes.RecipeUpdateRequestInput{
		Name:                &input.Name,
		Slug:                &input.Slug,
		Source:              &input.Source,
...
func ConvertRecipeCreationRequestInputToRecipeDatabaseCreationInput(input *recipes.RecipeCreationRequestInput) (*recipes.RecipeDatabaseCreationInput, error) {
	x := &recipes.RecipeDatabaseCreationInput{
		ID:                 identifiers.New(),
...
func ConvertRecipeToRecipeCreationRequestInput(input *recipes.Recipe) *recipes.RecipeCreationRequestInput {
	steps := []*recipes.RecipeStepCreationRequestInput{}
	for _, step := range input.Steps {
		steps = append(steps, ConvertRecipeStepToRecipeStepCreationRequestInput(step))
	}

	prepTasks := []*recipes.RecipePrepTaskWithinRecipeCreationRequestInput{}
	...
	return &recipes.RecipeCreationRequestInput{
		Name:               input.Name,
		Slug:               input.Slug,
		Source:             input.Source,
		Description:        input.Description,
