...
func ConvertValidIngredientToDatabaseCreationInput(v *mealplanning.ValidIngredient) *mealplanning.ValidIngredientDatabaseCreationInput {
	return &mealplanning.ValidIngredientDatabaseCreationInput{
		...
		MinStorageTemperatureInCelsius: v.MinStorageTemperatureInCelsius,
		MaxStorageTemperatureInCelsius: v.MaxStorageTemperatureInCelsius,
...
func ConvertValidPreparationToDatabaseCreationInput(v *mealplanning.ValidPreparation) *mealplanning.ValidPreparationDatabaseCreationInput {
	return &mealplanning.ValidPreparationDatabaseCreationInput{
		...
		Slug:                        v.Slug,
		MinInstrumentCount:          v.MinInstrumentCount,
		MaxInstrumentCount:          v.MaxInstrumentCount,
		MinIngredientCount:          v.MinIngredientCount,
		MaxIngredientCount:          v.MaxIngredientCount,
		MinVesselCount:              v.MinVesselCount,
		MaxVesselCount:              v.MaxVesselCount,
...
func ConvertValidIngredientMeasurementUnitToDatabaseCreationInput(v *mealplanning.ValidIngredientMeasurementUnit) *mealplanning.ValidIngredientMeasurementUnitDatabaseCreationInput {
	return &mealplanning.ValidIngredientMeasurementUnitDatabaseCreationInput{
		ID:                     v.ID,
		Notes:                  v.Notes,
		MinAllowableQuantity:   v.MinAllowableQuantity,
		MaxAllowableQuantity:   v.MaxAllowableQuantity,
...
func ConvertRecipeToDatabaseCreationInput(r *mealplanning.Recipe) *mealplanning.RecipeDatabaseCreationInput {
	...
	return &mealplanning.RecipeDatabaseCreationInput{
		...
		MinEstimatedPortions: r.MinEstimatedPortions,
		MaxEstimatedPortions: r.MaxEstimatedPortions,
...
func ConvertRecipeStepToDatabaseCreationInput(s *mealplanning.RecipeStep) *mealplanning.RecipeStepDatabaseCreationInput {
	...
	return &mealplanning.RecipeStepDatabaseCreationInput{
		...
		MinTemperatureInCelsius:   s.MinTemperatureInCelsius,
		MaxTemperatureInCelsius:   s.MaxTemperatureInCelsius,
		Index:                     s.Index,
		Optional:                  s.Optional,
...
func ConvertRecipeStepProductToDatabaseCreationInput(p *mealplanning.RecipeStepProduct) *mealplanning.RecipeStepProductDatabaseCreationInput {
	...
	return &mealplanning.RecipeStepProductDatabaseCreationInput{
		...
		MinStorageTemperatureInCelsius: p.MinStorageTemperatureInCelsius,
		MaxStorageTemperatureInCelsius: p.MaxStorageTemperatureInCelsius,
		MinStorageDurationInSeconds:    p.MinStorageDurationInSeconds,
		MaxStorageDurationInSeconds:    p.MaxStorageDurationInSeconds,
		MinMeasurementQuantity:         p.MinMeasurementQuantity,
		MaxMeasurementQuantity:         p.MaxMeasurementQuantity,
		MinItemQuantity:                p.MinItemQuantity,
		MaxItemQuantity:                p.MaxItemQuantity,
		Index:                          p.Index,
...
func ConvertRecipePrepTaskToDatabaseCreationInput(pt *mealplanning.RecipePrepTask) *mealplanning.RecipePrepTaskDatabaseCreationInput {
	...
	return &mealplanning.RecipePrepTaskDatabaseCreationInput{
		...
		MinStorageTemperatureInCelsius:     pt.MinStorageTemperatureInCelsius,
		MaxStorageTemperatureInCelsius:     pt.MaxStorageTemperatureInCelsius,
		MinTimeBufferBeforeRecipeInSeconds: pt.MinTimeBufferBeforeRecipeInSeconds,
		MaxTimeBufferBeforeRecipeInSeconds: pt.MaxTimeBufferBeforeRecipeInSeconds,
		TaskSteps:                          taskSteps,
...
func ConvertMealToDatabaseCreationInput(m *mealplanning.Meal) *mealplanning.MealDatabaseCreationInput {
	...
	return &mealplanning.MealDatabaseCreationInput{
		...
		MinEstimatedPortions: m.MinEstimatedPortions,
		MaxEstimatedPortions: m.MaxEstimatedPortions,
