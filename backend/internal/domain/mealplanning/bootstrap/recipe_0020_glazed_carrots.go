...
func GlazedCarrotsWithBrownButterAndSageRecipe(enums *Enumerations) []*mealplanning.RecipeCreationRequestInput {
	...
	// Step 5: Add carrots and liquids
	...
	// Step 8: Uncover and reduce to glaze
	...
	// Step 12: Stir in vinegar and season to taste
		...
		Products: []*mealplanning.RecipeStepProductCreationRequestInput{
			{
				...
				MinMeasurementQuantity: new(float32(1)),
				MaxMeasurementQuantity: new(float32(2)),
			},
		},
	}

	// Step 14: Sprinkle with herbs and serve
