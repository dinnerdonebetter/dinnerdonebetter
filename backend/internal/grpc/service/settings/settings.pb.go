...
var file_settings_proto_rawDesc = string([]byte{
	...
	0x6d, 0x69, 0x6e, 0x73, 0x4f, 0x6e, 0x6c, 0x79, 0x32, 0xa7, 0x0b, 0x0a, 0x15, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_settings_proto_depIdxs = []int32{
	...
	12, // 23: settings.ServiceSettingService.GetServiceSettingConfigurationsForAccount:input_type -> settings.GetServiceSettingConfigurationsForAccountRequest
	14, // 24: settings.ServiceSettingService.GetServiceSettingConfigurationsForUser:input_type -> settings.GetServiceSettingConfigurationsForUserRequest
	18, // 25: settings.ServiceSettingService.SearchForServiceSettings:input_type -> settings.SearchForServiceSettingsRequest
	4,  // 26: settings.ServiceSettingService.ArchiveServiceSetting:input_type -> settings.ArchiveServiceSettingRequest
	6,  // 27: settings.ServiceSettingService.ArchiveServiceSettingConfiguration:input_type -> settings.ArchiveServiceSettingConfigurationRequest
	0,  // 28: settings.ServiceSettingService.CreateServiceSetting:input_type -> settings.CreateServiceSettingRequest
	2,  // 29: settings.ServiceSettingService.CreateServiceSettingConfiguration:input_type -> settings.CreateServiceSettingConfigurationRequest
	8,  // 30: settings.ServiceSettingService.GetServiceSetting:input_type -> settings.GetServiceSettingRequest
	10, // 31: settings.ServiceSettingService.GetServiceSettingConfigurationByName:input_type -> settings.GetServiceSettingConfigurationByNameRequest
	16, // 32: settings.ServiceSettingService.GetServiceSettings:input_type -> settings.GetServiceSettingsRequest
	20, // 33: settings.ServiceSettingService.UpdateServiceSettingConfiguration:input_type -> settings.UpdateServiceSettingConfigurationRequest
	13, // 34: settings.ServiceSettingService.GetServiceSettingConfigurationsForAccount:output_type -> settings.GetServiceSettingConfigurationsForAccountResponse
	15, // 35: settings.ServiceSettingService.GetServiceSettingConfigurationsForUser:output_type -> settings.GetServiceSettingConfigurationsForUserResponse
	19, // 36: settings.ServiceSettingService.SearchForServiceSettings:output_type -> settings.SearchForServiceSettingsResponse
	5,  // 37: settings.ServiceSettingService.ArchiveServiceSetting:output_type -> settings.ArchiveServiceSettingResponse
	7,  // 38: settings.ServiceSettingService.ArchiveServiceSettingConfiguration:output_type -> settings.ArchiveServiceSettingConfigurationResponse
	1,  // 39: settings.ServiceSettingService.CreateServiceSetting:output_type -> settings.CreateServiceSettingResponse
	3,  // 40: settings.ServiceSettingService.CreateServiceSettingConfiguration:output_type -> settings.CreateServiceSettingConfigurationResponse
	9,  // 41: settings.ServiceSettingService.GetServiceSetting:output_type -> settings.GetServiceSettingResponse
	11, // 42: settings.ServiceSettingService.GetServiceSettingConfigurationByName:output_type -> settings.GetServiceSettingConfigurationByNameResponse
	17, // 43: settings.ServiceSettingService.GetServiceSettings:output_type -> settings.GetServiceSettingsResponse
	21, // 44: settings.ServiceSettingService.UpdateServiceSettingConfiguration:output_type -> settings.UpdateServiceSettingConfigurationResponse
