...
RUN --mount=type=cache,target=/root/.cache/go-build go build -trimpath -o /dinnerdonebetter github.com/dinnerdonebetter/backend/backend/cmd/services/api/http
