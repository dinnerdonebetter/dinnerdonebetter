...
- **Test utilities**: Shared helpers in `github.com/primandproper/platform/testutils`
...
The platform framework (database, cache, observability, messaging, etc.) is an external dependency at `github.com/primandproper/platform`.
...
The codebase follows a clean architecture approach. The platform framework (`github.com/primandproper/platform`) is an external dependency providing infrastructure (database, cache, observability, messaging, etc.).
...
The platform framework lives in a separate repo at `github.com/primandproper/platform`. It provides domain-agnostic infrastructure:
