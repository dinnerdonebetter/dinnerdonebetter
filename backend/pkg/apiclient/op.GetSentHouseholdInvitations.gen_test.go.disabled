...
func TestClient_GetSentAccountInvitations(T *testing.T) {
	T.Parallel()

	const expectedPathFormat = "/api/v1/account_invitations/sent"
	...
	T.Run("standard", func(t *testing.T) {
		...
		actual, err := c.GetSentAccountInvitations(ctx, nil)
