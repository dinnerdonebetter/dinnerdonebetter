...
func TestClient_GetValidIngredientStateIngredients(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		list := fake.BuildFakeForTest[[]*ValidIngredientStateIngredient](t)
		...
		actual, err := c.GetValidIngredientStateIngredients(ctx, nil)
