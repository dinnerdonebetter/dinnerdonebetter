...
func TestClient_GetValidIngredientPreparationsByIngredient(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		list := fake.BuildFakeForTest[[]*ValidIngredientPreparation](t)
		...
		actual, err := c.GetValidIngredientPreparationsByIngredient(ctx, validIngredientID, nil)
	...
	T.Run("with empty validIngredient ID", func(t *testing.T) {
		...
		actual, err := c.GetValidIngredientPreparationsByIngredient(ctx, "", nil)
