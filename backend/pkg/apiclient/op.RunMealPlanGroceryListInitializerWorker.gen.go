...
func (c *Client) RunMealPlanGroceryListInitializerWorker(
...
) (*InitializeMealPlanGroceryListResponse, error) {
	...
	u := c.BuildURL(ctx, nil, "/api/v1/workers/meal_plan_grocery_list_init")
	...
	var apiResponse *APIResponse[*InitializeMealPlanGroceryListResponse]
