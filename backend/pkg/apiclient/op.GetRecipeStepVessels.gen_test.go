...
func TestClient_GetRecipeStepVessels(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		list := []*RecipeStepVessel{}
		exampleResponse := &APIResponse[[]*RecipeStepVessel]{
			Pagination: fake.BuildFakeForTest[*Pagination](t),
			Data:       list,
		}
		expected := &QueryFilteredResult[RecipeStepVessel]{
		...
		actual, err := c.GetRecipeStepVessels(ctx, recipeID, recipeStepID, nil)
	...
	T.Run("with empty recipe ID", func(t *testing.T) {
		...
		actual, err := c.GetRecipeStepVessels(ctx, "", recipeStepID, nil)
	...
	T.Run("with empty recipeStep ID", func(t *testing.T) {
		...
		ctx := t.Context()
		c, _ := buildSimpleTestClient(t)
		actual, err := c.GetRecipeStepVessels(ctx, recipeID, "", nil)
