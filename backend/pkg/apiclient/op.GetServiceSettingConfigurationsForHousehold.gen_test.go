...
func TestClient_GetServiceSettingConfigurationsForHousehold(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		list := fake.BuildFakeForTest[[]*ServiceSettingConfiguration](t)
		...
		actual, err := c.GetServiceSettingConfigurationsForHousehold(ctx, nil)
