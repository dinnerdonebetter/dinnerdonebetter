...
func TestClient_SearchForValidMeasurementUnits(T *testing.T) {
	T.Parallel()

	const expectedPathFormat = "/api/v1/valid_measurement_units/search"
	...
	T.Run("standard", func(t *testing.T) {
		...
		actual, err := c.SearchForValidMeasurementUnits(ctx, q, nil)
