...
func TestClient_GetValidPreparationInstruments(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		list := fake.BuildFakeForTest[[]*ValidPreparationInstrument](t)
		...
		actual, err := c.GetValidPreparationInstruments(ctx, nil)
