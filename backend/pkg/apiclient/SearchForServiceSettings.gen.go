...
func (c *Client) SearchForServiceSettings(
...
) (*filtering.QueryFilteredResult[types.ServiceSetting], error) {
	...
	u := c.BuildURL(ctx, values, "/api/v1/settings/search")
	...
	result := &filtering.QueryFilteredResult[types.ServiceSetting]{
