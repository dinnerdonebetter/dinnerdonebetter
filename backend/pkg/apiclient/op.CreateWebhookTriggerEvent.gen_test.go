...
func TestClient_CreateWebhookTriggerEvent(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		data := fake.BuildFakeForTest[*WebhookTriggerEvent](t)

		expected := &APIResponse[*WebhookTriggerEvent]{
			Data: data,
		}

		exampleInput := fake.BuildFakeForTest[*WebhookTriggerEventCreationRequestInput](t)
