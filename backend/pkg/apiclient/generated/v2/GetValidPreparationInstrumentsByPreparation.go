...
func (c *Client) GetValidPreparationInstrumentsByPreparation(
	ctx context.Context,
	...
	u := c.BuildURL(ctx, filter.ToValues(), fmt.Sprintf("/api/v1/valid_preparation_instruments/by_preparation/%s" , validPreparationID ))
