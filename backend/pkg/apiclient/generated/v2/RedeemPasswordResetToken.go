...
func (c *Client) RedeemPasswordResetToken(
	ctx context.Context,
input *types.PasswordResetTokenRedemptionRequestInput,
) (*types.User, error) {
	...
	u := c.BuildURL(ctx, nil, fmt.Sprintf("/users/password/reset/redeem" ))
