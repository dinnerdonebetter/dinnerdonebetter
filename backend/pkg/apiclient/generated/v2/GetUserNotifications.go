...
func (c *Client) GetUserNotifications(
...
) (*types.QueryFilteredResult[types.UserNotification], error) {
	...
	u := c.BuildURL(ctx, filter.ToValues(), fmt.Sprintf("/api/v1/user_notifications" ))
	...
	result := &types.QueryFilteredResult[types.UserNotification]{
