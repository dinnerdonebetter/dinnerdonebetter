...
func (c *Client) GetValidIngredients(
...
) (*QueryFilteredResult[ValidIngredient], error) {
	...
	u := c.BuildURL(ctx, values, "/api/v1/valid_ingredients")
	...
	var apiResponse *APIResponse[[]*ValidIngredient]
	...
	result := &QueryFilteredResult[ValidIngredient]{
