...
func newDefaultRoundTripper(timeout time.Duration, impersonatedUserID, impersonatedAccountID string) http.RoundTripper {
...
func (t *defaultRoundTripper) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	if t.impersonatedAccountID != "" {
		req.Header.Set(zuckModeAccountHeader, t.impersonatedAccountID)
	}
