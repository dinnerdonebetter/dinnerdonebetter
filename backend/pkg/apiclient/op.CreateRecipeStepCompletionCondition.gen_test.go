...
func TestClient_CreateRecipeStepCompletionCondition(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		data := fake.BuildFakeForTest[*RecipeStepCompletionCondition](t)

		expected := &APIResponse[*RecipeStepCompletionCondition]{
			Data: data,
		}

		exampleInput := fake.BuildFakeForTest[*RecipeStepCompletionConditionForExistingRecipeCreationRequestInput](t)
